...
class AWS::SDK::Service::MarketplaceEntitlement does AWS::SDK::Service {
    ...
    subset GetEntitlementFilterName of Str where $_ eq any('CUSTOMER_IDENTIFIER', 'DIMENSION');
    ...
    class GetEntitlementsRequest does AWS::SDK::Shape {
        ...
        has FilterValueList %.filter{GetEntitlementFilterName} is shape-member('Filter');
