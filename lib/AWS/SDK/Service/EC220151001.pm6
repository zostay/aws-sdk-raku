...
class AWS::SDK::Service::EC2:ver<2015-10-01.0> does AWS::SDK::Service {
    ...
    class ModifyReservedInstancesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class CancelledSpotInstanceRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.spot-instance-request-id is required is aws-parameter('SpotInstanceRequestId');
        has Str $.state is required is aws-parameter('State');
    }

    class InstanceBlockDeviceMappingSpecification:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class Snapshot:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class SecurityGroupReference:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class TagDescription:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class AssociateRouteTableRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class CreateNetworkAclResult:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class MoveAddressToVpcRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.public-ip is required is aws-parameter('PublicIp');
        has Bool $.dry-run is aws-parameter('DryRun');
    }

    class EnableVolumeIORequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.volume-id is required is aws-parameter('VolumeId');
    }

    class DescribeImportImageTasksResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has ImportImageTaskList $.import-image-tasks is required is aws-parameter('ImportImageTasks');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class DescribeAvailabilityZonesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class PriceScheduleSpecification:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Num $.price is required is aws-parameter('Price');
        has Int $.term is required is aws-parameter('Term');
        has Str $.currency-code is required is aws-parameter('CurrencyCode');
    }

    class EbsBlockDevice:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.volume-size is required is aws-parameter('VolumeSize');
        has Str $.snapshot-id is required is aws-parameter('SnapshotId');
    ...
    class DisableVgwRoutePropagationRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.route-table-id is required is aws-parameter('RouteTableId');
        has Str $.gateway-id is required is aws-parameter('GatewayId');
    }

    class AvailabilityZoneMessage:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class ModifySnapshotAttributeRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class BlobAttributeValue:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Blob $.value is required is aws-parameter('Value');
    }

    subset VpcAttachmentList of List[VpcAttachment];

    class DescribeSpotFleetInstancesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class CreateVolumePermission:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.group is required is aws-parameter('Group');
        has Str $.user-id is required is aws-parameter('UserId');
    }

    class VpcPeeringConnectionVpcInfo:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeSnapshotAttributeRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.snapshot-id is required is aws-parameter('SnapshotId');
        has Bool $.dry-run is aws-parameter('DryRun');
    ...
    class ResetImageAttributeRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
    ...
    class TerminateInstancesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has InstanceIdStringList $.instance-ids is required is aws-parameter('InstanceIds');
    }

    class SpotPrice:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class SlotStartTimeRangeRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class ImportInstanceLaunchSpecification:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeStaleSecurityGroupsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DeleteKeyPairRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.key-name is required is aws-parameter('KeyName');
    }

    class DescribeVpcsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class AttachClassicLinkVpcRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
    ...
    class SnapshotDiskContainer:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.description is required is aws-parameter('Description');
    ...
    class ImportImageTask:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeVpcEndpointServicesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class ClassicLinkDnsSupport:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.classic-link-dns-supported is required is aws-parameter('ClassicLinkDnsSupported');
    }

    class AuthorizeSecurityGroupIngressRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class ScheduledInstancesEbs:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.volume-size is required is aws-parameter('VolumeSize');
        has Str $.snapshot-id is required is aws-parameter('SnapshotId');
        has Str $.volume-type is required is aws-parameter('VolumeType');
        has Int $.iops is required is aws-parameter('Iops');
    ...
    class DescribeExportTasksRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class VpnGateway:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class EnableVpcClassicLinkDnsSupportResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.return is required is aws-parameter('Return');
    }

    class DescribeVolumesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class LaunchPermission:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.group is required is aws-parameter('Group');
        has Str $.user-id is required is aws-parameter('UserId');
    }

    class VpcPeeringConnectionStateReason:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.code is required is aws-parameter('Code');
        has Str $.message is required is aws-parameter('Message');
    }

    class RecurringCharge:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Num $.amount is required is aws-parameter('Amount');
        has Str $.frequency is required is aws-parameter('Frequency');
    }

    class VpnStaticRoute:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class UserBucketDetails:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.s3-key is required is aws-parameter('S3Key');
        has Str $.s3-bucket is required is aws-parameter('S3Bucket');
    }

    class DescribeInstanceAttributeRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.attribute is required is aws-parameter('Attribute');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class AttachVolumeRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class PropagatingVgw:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.gateway-id is required is aws-parameter('GatewayId');
    }

    class ReplaceNetworkAclAssociationResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.new-association-id is required is aws-parameter('NewAssociationId');
    }

    class DescribeSpotFleetInstancesResponse:ver<2015-10-01.0> does AWS::SDK::Shape {
        has ActiveInstanceSet $.active-instances is required is aws-parameter('ActiveInstances');
        has Str $.next-token is aws-parameter('NextToken');
        has Str $.spot-fleet-request-id is required is aws-parameter('SpotFleetRequestId');
    }

    class DescribeKeyPairsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has KeyNameStringList $.key-names is required is aws-parameter('KeyNames');
    }

    class StartInstancesResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has InstanceStateChangeList $.starting-instances is required is aws-parameter('StartingInstances');
    }

    class VpcPeeringConnection:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeVpcClassicLinkRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has VpcClassicLinkIdList $.vpc-ids is required is aws-parameter('VpcIds');
    }

    class ImportVolumeRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class PurchaseScheduledInstancesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeNetworkInterfaceAttributeRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.network-interface-id is required is aws-parameter('NetworkInterfaceId');
        has Str $.attribute is aws-parameter('Attribute');
    }

    class ModifyVolumeAttributeRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has AttributeBooleanValue $.auto-enable-io is aws-parameter('AutoEnableIO');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.volume-id is required is aws-parameter('VolumeId');
    }

    class CreateRouteTableResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has RouteTable $.route-table is required is aws-parameter('RouteTable');
    }

    class ModifyVpcEndpointRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class PlacementGroup:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.strategy is required is aws-parameter('Strategy');
        has Str $.state is required is aws-parameter('State');
        has Str $.group-name is required is aws-parameter('GroupName');
    }

    class PurchaseRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class ExportToS3TaskSpecification:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeCustomerGatewaysResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has CustomerGatewayList $.customer-gateways is required is aws-parameter('CustomerGateways');
    }

    class ModifyVpcPeeringConnectionOptionsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeSpotFleetRequestsResponse:ver<2015-10-01.0> does AWS::SDK::Shape {
        has SpotFleetRequestConfigSet $.spot-fleet-request-configs is required is aws-parameter('SpotFleetRequestConfigs');
        has Str $.next-token is aws-parameter('NextToken');
    }

    class MovingAddressStatus:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.public-ip is required is aws-parameter('PublicIp');
        has Str $.move-status is required is aws-parameter('MoveStatus');
    }

    class CreateInstanceExportTaskRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.description is aws-parameter('Description');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    ...
    class RunScheduledInstancesResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has InstanceIdSet $.instance-id-set is required is aws-parameter('InstanceIdSet');
    }

    class DescribeSnapshotAttributeResult:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class CreatePlacementGroupRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.strategy is required is aws-parameter('Strategy');
        has Str $.group-name is required is aws-parameter('GroupName');
    }

    class ImportSnapshotRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class DescribeNatGatewaysResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has NatGatewayList $.nat-gateways is required is aws-parameter('NatGateways');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class CreateVolumePermissionModifications:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DeleteNatGatewayResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.nat-gateway-id is required is aws-parameter('NatGatewayId');
    }

    class InstanceStatusDetails:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class CancelImportTaskRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.cancel-reason is required is aws-parameter('CancelReason');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has Str $.import-task-id is required is aws-parameter('ImportTaskId');
    }

    class CreateNetworkAclRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
    }
    ...
    class CancelSpotFleetRequestsResponse:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class ScheduledInstancesBlockDeviceMapping:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DetachVolumeRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeNetworkInterfacesResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has NetworkInterfaceList $.network-interfaces is required is aws-parameter('NetworkInterfaces');
    }

    class BundleTaskError:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.code is required is aws-parameter('Code');
        has Str $.message is required is aws-parameter('Message');
    }

    class SnapshotDetail:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.device-name is required is aws-parameter('DeviceName');
    ...
    class DiskImageVolumeDescription:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.id is required is aws-parameter('Id');
        has Int $.size is aws-parameter('Size');
    }

    class VolumeStatusInfo:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.status is required is aws-parameter('Status');
        has VolumeStatusDetailsList $.details is required is aws-parameter('Details');
    }

    class DescribeReservedInstancesOfferingsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has ReservedInstancesOfferingList $.reserved-instances-offerings is required is aws-parameter('ReservedInstancesOfferings');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class ImportSnapshotResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.description is required is aws-parameter('Description');
        has Str $.import-task-id is required is aws-parameter('ImportTaskId');
        has SnapshotTaskDetail $.snapshot-task-detail is required is aws-parameter('SnapshotTaskDetail');
    }

    class DescribeVolumesResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has VolumeList $.volumes is required is aws-parameter('Volumes');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class IpRange:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.cidr-ip is required is aws-parameter('CidrIp');
    }

    class VpcClassicLink:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has TagList $.tags is required is aws-parameter('Tags');
    ...
    class ModifyVpcEndpointResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.return is required is aws-parameter('Return');
    }

    class DescribeTagsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has Str $.next-token is required is aws-parameter('NextToken');
    ...
    class DescribeVpnGatewaysResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has VpnGatewayList $.vpn-gateways is required is aws-parameter('VpnGateways');
    }

    class DescribeImageAttributeRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.image-id is required is aws-parameter('ImageId');
        has Str $.attribute is required is aws-parameter('Attribute');
    }

    class DeleteNetworkInterfaceRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.network-interface-id is required is aws-parameter('NetworkInterfaceId');
    }

    class VolumeDetail:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.size is required is aws-parameter('Size');
    }

    subset BlockDeviceMappingList of List[BlockDeviceMapping];

    class CreateVpnGatewayResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has VpnGateway $.vpn-gateway is required is aws-parameter('VpnGateway');
    }

    class ReservedInstancesId:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.reserved-instances-id is required is aws-parameter('ReservedInstancesId');
    }

    class CreateVpnGatewayRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.availability-zone is aws-parameter('AvailabilityZone');
        has Str $.type is required is aws-parameter('Type');
    }

    class AttachInternetGatewayRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
    ...
    class ReportInstanceStatusRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeKeyPairsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has KeyPairList $.key-pairs is required is aws-parameter('KeyPairs');
    }

    class CreateNatGatewayRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.subnet-id is required is aws-parameter('SubnetId');
        has Str $.client-token is aws-parameter('ClientToken');
        has Str $.allocation-id is required is aws-parameter('AllocationId');
    }

    class CreateSubnetResult:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class ModifyInstancePlacementRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class ImageDiskContainer:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.device-name is required is aws-parameter('DeviceName');
        has Str $.snapshot-id is required is aws-parameter('SnapshotId');
        has Str $.description is required is aws-parameter('Description');
        has Str $.url is required is aws-parameter('Url');
    ...
    class DescribePrefixListsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has FilterList $.filters is required is aws-parameter('Filters');
    ...
    class CancelBundleTaskResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has BundleTask $.bundle-task is required is aws-parameter('BundleTask');
    }

    class AttachVpnGatewayRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.vpn-gateway-id is required is aws-parameter('VpnGatewayId');
    }

    class ScheduledInstanceAvailability:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DeleteVpcPeeringConnectionResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.return is required is aws-parameter('Return');
    }

    class SpotFleetMonitoring:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.enabled is required is aws-parameter('Enabled');
    }

    class DescribeClassicLinkInstancesResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has ClassicLinkInstanceList $.instances is required is aws-parameter('Instances');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class StartInstancesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
    ...
    class DescribeExportTasksResult:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class UnassignPrivateIpAddressesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has PrivateIpAddressStringList $.private-ip-addresses is required is aws-parameter('PrivateIpAddresses');
        has Str $.network-interface-id is required is aws-parameter('NetworkInterfaceId');
    }

    class ScheduledInstance:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class BlockDeviceMapping:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class KeyPairInfo:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.key-fingerprint is required is aws-parameter('KeyFingerprint');
        has Str $.key-name is required is aws-parameter('KeyName');
    }

    class EbsInstanceBlockDevice:ver<2015-10-01.0> does AWS::SDK::Shape {
        has DateTime $.attach-time is required is aws-parameter('AttachTime');
        has Str $.status is required is aws-parameter('Status');
        has Str $.volume-id is required is aws-parameter('VolumeId');
        has Bool $.delete-on-termination is required is aws-parameter('DeleteOnTermination');
    ...
    class ImportVolumeTaskDetails:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class S3Storage:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class UnmonitorInstancesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has InstanceIdStringList $.instance-ids is required is aws-parameter('InstanceIds');
    }

    class DescribeVpnConnectionsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has VpnConnectionIdStringList $.vpn-connection-ids is required is aws-parameter('VpnConnectionIds');
    }

    class CreateInstanceExportTaskResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has ExportTask $.export-task is required is aws-parameter('ExportTask');
    }

    class CreateRouteResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.return is required is aws-parameter('Return');
    }

    subset ImportSnapshotTaskList of List[ImportSnapshotTask];

    class VolumeStatusItem:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class NetworkAclAssociation:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.subnet-id is required is aws-parameter('SubnetId');
    ...
    class VgwTelemetry:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class IcmpTypeCode:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class SpotDatafeedSubscription:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.bucket is required is aws-parameter('Bucket');
        has Str $.owner-id is required is aws-parameter('OwnerId');
    ...
    class VpcPeeringConnectionOptionsDescription:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeVpcClassicLinkResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has VpcClassicLinkList $.vpcs is required is aws-parameter('Vpcs');
    }

    class CreateVpnConnectionResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has VpnConnection $.vpn-connection is required is aws-parameter('VpnConnection');
    }

    class Tag:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.value is required is aws-parameter('Value');
        has Str $.key is required is aws-parameter('Key');
    }

    class CreateFlowLogsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class NetworkInterface:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DetachNetworkInterfaceRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Bool $.force is aws-parameter('Force');
        has Str $.attachment-id is required is aws-parameter('AttachmentId');
    }

    class DescribePlacementGroupsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class ImportSnapshotTask:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.description is required is aws-parameter('Description');
        has Str $.import-task-id is required is aws-parameter('ImportTaskId');
        has SnapshotTaskDetail $.snapshot-task-detail is required is aws-parameter('SnapshotTaskDetail');
    }
    ...
    class EventInformation:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DeleteVpcEndpointsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has UnsuccessfulItemSet $.unsuccessful is required is aws-parameter('Unsuccessful');
    }

    subset LaunchPermissionList of List[LaunchPermission];

    class Volume:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.kms-key-id is required is aws-parameter('KmsKeyId');
        has Str $.snapshot-id is required is aws-parameter('SnapshotId');
        has Str $.volume-type is required is aws-parameter('VolumeType');
        has TagList $.tags is required is aws-parameter('Tags');
    ...
    class DescribeSpotInstanceRequestsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class ReplaceNetworkAclAssociationRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.network-acl-id is required is aws-parameter('NetworkAclId');
        has Bool $.dry-run is aws-parameter('DryRun');
    ...
    class VpnConnection:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DisableVpcClassicLinkRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
    }

    class DescribeVolumeAttributeRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.attribute is aws-parameter('Attribute');
        has Str $.volume-id is required is aws-parameter('VolumeId');
    }

    class CreateImageRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class GetConsoleScreenshotResult:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeRegionsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has RegionList $.regions is required is aws-parameter('Regions');
    }

    class AllocateAddressRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.domain is required is aws-parameter('Domain');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    }

    class AssociateAddressResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.association-id is required is aws-parameter('AssociationId');
    }

    class EnableVpcClassicLinkDnsSupportRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
    }

    subset DhcpConfigurationList of List[DhcpConfiguration];

    class DescribeInternetGatewaysResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has InternetGatewayList $.internet-gateways is required is aws-parameter('InternetGateways');
    }

    class DeleteVpnConnectionRouteRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.destination-cidr-block is required is aws-parameter('DestinationCidrBlock');
        has Str $.vpn-connection-id is required is aws-parameter('VpnConnectionId');
    }
    ...
    class StaleSecurityGroup:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeSpotPriceHistoryResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
        has SpotPriceHistoryList $.spot-price-history is required is aws-parameter('SpotPriceHistory');
    }

    class SpotPlacement:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.availability-zone is required is aws-parameter('AvailabilityZone');
        has Str $.group-name is required is aws-parameter('GroupName');
    }

    class DescribeNetworkAclsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has NetworkAclList $.network-acls is required is aws-parameter('NetworkAcls');
    }

    subset ProductCodeStringList of List[Str];

    class SpotInstanceStateFault:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.code is required is aws-parameter('Code');
        has Str $.message is required is aws-parameter('Message');
    }
    ...
    class ScheduledInstanceRecurrenceRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class StopInstancesResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has InstanceStateChangeList $.stopping-instances is required is aws-parameter('StoppingInstances');
    }

    class AllocateAddressResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.domain is required is aws-parameter('Domain');
        has Str $.public-ip is required is aws-parameter('PublicIp');
        has Str $.allocation-id is required is aws-parameter('AllocationId');
    }

    class ReleaseAddressRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.public-ip is required is aws-parameter('PublicIp');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has Str $.allocation-id is required is aws-parameter('AllocationId');
    }
    ...
    class DescribeVpcEndpointServicesResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
        has ValueStringList $.service-names is required is aws-parameter('ServiceNames');
    }

    class CopyImageRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DeleteTagsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class Storage:ver<2015-10-01.0> does AWS::SDK::Shape {
        has S3Storage $.s3 is required is aws-parameter('S3');
    }

    subset SpotInstanceRequestList of List[SpotInstanceRequest];

    class VpnConnectionOptions:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class SpotFleetRequestConfigData:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DeleteVpnConnectionRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.vpn-connection-id is required is aws-parameter('VpnConnectionId');
    }

    class CancelSpotInstanceRequestsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has SpotInstanceRequestIdList $.spot-instance-request-ids is required is aws-parameter('SpotInstanceRequestIds');
    }
    ...
    class UnsuccessfulItemError:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.code is required is aws-parameter('Code');
        has Str $.message is required is aws-parameter('Message');
    }

    class DescribeSpotDatafeedSubscriptionRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is required is aws-parameter('DryRun');
    }

    class CreateNetworkInterfaceResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has NetworkInterface $.network-interface is required is aws-parameter('NetworkInterface');
    }

    subset TagList of List[Tag];

    class DescribeVpcPeeringConnectionsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class DescribeSpotFleetRequestHistoryRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is aws-parameter('MaxResults');
        has Bool $.dry-run is aws-parameter('DryRun');
        has DateTime $.start-time is required is aws-parameter('StartTime');
        has Str $.next-token is aws-parameter('NextToken');
    ...
    class CreateDhcpOptionsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class CreateNetworkAclEntryRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.cidr-block is required is aws-parameter('CidrBlock');
    ...
    class DescribeFlowLogsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has ValueStringList $.flow-log-ids is required is aws-parameter('FlowLogIds');
    ...
    class PeeringConnectionOptions:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.allow-egress-from-local-vpc-to-remote-classic-link is required is aws-parameter('AllowEgressFromLocalVpcToRemoteClassicLink');
        has Bool $.allow-egress-from-local-classic-link-to-remote-vpc is required is aws-parameter('AllowEgressFromLocalClassicLinkToRemoteVpc');
    }

    class ReplaceRouteRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.route-table-id is required is aws-parameter('RouteTableId');
        has Bool $.dry-run is aws-parameter('DryRun');
    ...
    class ReservedInstancesOffering:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class AllocateHostsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.client-token is aws-parameter('ClientToken');
    ...
    class Subnet:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class CreateVpnConnectionRouteRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.destination-cidr-block is required is aws-parameter('DestinationCidrBlock');
        has Str $.vpn-connection-id is required is aws-parameter('VpnConnectionId');
    }

    class ImportVolumeResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has ConversionTask $.conversion-task is required is aws-parameter('ConversionTask');
    }

    class ModifyVpcPeeringConnectionOptionsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeVolumeAttributeResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has AttributeBooleanValue $.auto-enable-io is required is aws-parameter('AutoEnableIO');
        has Str $.volume-id is required is aws-parameter('VolumeId');
        has ProductCodeList $.product-codes is required is aws-parameter('ProductCodes');
    }

    class CreateSpotDatafeedSubscriptionResult:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeConversionTasksRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has ConversionIdStringList $.conversion-task-ids is required is aws-parameter('ConversionTaskIds');
    }

    class InstanceStatusSummary:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.status is required is aws-parameter('Status');
        has InstanceStatusDetailsList $.details is required is aws-parameter('Details');
    }

    class AuthorizeSecurityGroupEgressRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class InstanceCapacity:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class SlotDateTimeRangeRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has DateTime $.latest-time is required is aws-parameter('LatestTime');
        has DateTime $.earliest-time is required is aws-parameter('EarliestTime');
    }

    class DescribeRegionsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has RegionNameStringList $.region-names is required is aws-parameter('RegionNames');
    }

    class ModifySpotFleetRequestResponse:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.return is required is aws-parameter('Return');
    }
    ...
    class DeleteNetworkAclRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.network-acl-id is required is aws-parameter('NetworkAclId');
        has Bool $.dry-run is aws-parameter('DryRun');
    }
    ...
    class RegisterImageRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has BlockDeviceMappingRequestList $.block-device-mappings is aws-parameter('BlockDeviceMappings');
        has Bool $.dry-run is aws-parameter('DryRun');
    ...
    class SecurityGroup:ver<2015-10-01.0> does AWS::SDK::Shape {
        has IpPermissionList $.ip-permissions is required is aws-parameter('IpPermissions');
        has Str $.group-id is required is aws-parameter('GroupId');
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Str $.owner-id is required is aws-parameter('OwnerId');
    ...
    class VolumeStatusDetails:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.name is required is aws-parameter('Name');
        has Str $.status is required is aws-parameter('Status');
    }

    class DescribeAccountAttributesResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has AccountAttributeList $.account-attributes is required is aws-parameter('AccountAttributes');
    }

    class DescribeAccountAttributesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class Address:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.domain is required is aws-parameter('Domain');
    ...
    class PrefixListId:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.prefix-list-id is required is aws-parameter('PrefixListId');
    }

    class RestoreAddressToClassicRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.public-ip is required is aws-parameter('PublicIp');
        has Bool $.dry-run is aws-parameter('DryRun');
    }

    class DescribeVpcPeeringConnectionsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has VpcPeeringConnectionList $.vpc-peering-connections is required is aws-parameter('VpcPeeringConnections');
    }

    class CreateImageResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.image-id is required is aws-parameter('ImageId');
    }

    class CancelSpotFleetRequestsSuccessItem:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class InstanceExportDetails:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.instance-id is required is aws-parameter('InstanceId');
    ...
    class RebootInstancesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has InstanceIdStringList $.instance-ids is required is aws-parameter('InstanceIds');
    }

    class ReplaceNetworkAclEntryRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.cidr-block is required is aws-parameter('CidrBlock');
        has Bool $.egress is required is aws-parameter('Egress');
        has Str $.network-acl-id is required is aws-parameter('NetworkAclId');
        has Bool $.dry-run is aws-parameter('DryRun');
    ...
    class ImportInstanceRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeInstancesResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
        has ReservationList $.reservations is required is aws-parameter('Reservations');
    }

    class AssignPrivateIpAddressesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class BundleTask:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeClassicLinkInstancesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has Str $.next-token is required is aws-parameter('NextToken');
    ...
    class DeletePlacementGroupRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.group-name is required is aws-parameter('GroupName');
    }

    class DeleteVolumeRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.volume-id is required is aws-parameter('VolumeId');
    }

    class VpnConnectionOptionsSpecification:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.static-routes-only is required is aws-parameter('StaticRoutesOnly');
    }
    ...
    class AvailableCapacity:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class ScheduledInstanceRecurrence:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.occurrence-relative-to-end is required is aws-parameter('OccurrenceRelativeToEnd');
        has Int $.interval is required is aws-parameter('Interval');
    ...
    class IdFormat:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class ReleaseHostsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class VolumeStatusEvent:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class CreateNatGatewayResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.client-token is required is aws-parameter('ClientToken');
    ...
    class ImportImageRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.license-type is required is aws-parameter('LicenseType');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has Str $.client-token is required is aws-parameter('ClientToken');
        has Str $.platform is required is aws-parameter('Platform');
    ...
    class DescribeNetworkInterfaceAttributeResult:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class IamInstanceProfileSpecification:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.arn is required is aws-parameter('Arn');
        has Str $.name is required is aws-parameter('Name');
    }

    class DescribeNatGatewaysRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has FilterList $.filter is required is aws-parameter('Filter');
    ...
    class InstanceNetworkInterface:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class PriceSchedule:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Num $.price is required is aws-parameter('Price');
    ...
    class DescribeImportImageTasksRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class CreateVolumeRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.kms-key-id is aws-parameter('KmsKeyId');
    ...
    class Monitoring:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.state is required is aws-parameter('State');
    }

    class RouteTableAssociation:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.route-table-id is required is aws-parameter('RouteTableId');
        has Str $.subnet-id is required is aws-parameter('SubnetId');
    ...
    class CancelBundleTaskRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.bundle-id is required is aws-parameter('BundleId');
    }
    ...
    class DeleteVpnGatewayRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.vpn-gateway-id is required is aws-parameter('VpnGatewayId');
    }
    ...
    class CreateTagsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has ResourceIdList $.resources is required is aws-parameter('Resources');
        has Bool $.dry-run is aws-parameter('DryRun');
        has TagList $.tags is required is aws-parameter('Tags');
    }

    class ModifyInstanceAttributeRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class Placement:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class HostInstance:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.instance-type is required is aws-parameter('InstanceType');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class DeleteSpotDatafeedSubscriptionRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is required is aws-parameter('DryRun');
    }

    class NetworkInterfaceAssociation:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.public-ip is required is aws-parameter('PublicIp');
        has Str $.association-id is required is aws-parameter('AssociationId');
    ...
    class PricingDetail:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Num $.price is required is aws-parameter('Price');
        has Int $.count is required is aws-parameter('Count');
    }

    class DescribeBundleTasksResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has BundleTaskList $.bundle-tasks is required is aws-parameter('BundleTasks');
    }

    class DeleteFlowLogsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has ValueStringList $.flow-log-ids is required is aws-parameter('FlowLogIds');
    }

    class RequestSpotInstancesResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has SpotInstanceRequestList $.spot-instance-requests is required is aws-parameter('SpotInstanceRequests');
    }

    class HistoryRecord:ver<2015-10-01.0> does AWS::SDK::Shape {
        has EventInformation $.event-information is required is aws-parameter('EventInformation');
        has DateTime $.timestamp is required is aws-parameter('Timestamp');
        has Str $.event-type is required is aws-parameter('EventType');
    }

    class DetachVpnGatewayRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.vpn-gateway-id is required is aws-parameter('VpnGatewayId');
    }

    class DescribeAddressesResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has AddressList $.addresses is required is aws-parameter('Addresses');
    }

    class DetachClassicLinkVpcResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.return is required is aws-parameter('Return');
    }

    class DescribeSnapshotsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
    ...
    class MonitorInstancesResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has InstanceMonitoringList $.instance-monitorings is required is aws-parameter('InstanceMonitorings');
    }

    class RejectVpcPeeringConnectionResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.return is required is aws-parameter('Return');
    }

    class DescribeReservedInstancesModificationsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
    ...
    class DeleteNetworkAclEntryRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.egress is required is aws-parameter('Egress');
        has Str $.network-acl-id is required is aws-parameter('NetworkAclId');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Int $.rule-number is required is aws-parameter('RuleNumber');
    ...
    class EbsInstanceBlockDeviceSpecification:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.volume-id is required is aws-parameter('VolumeId');
        has Bool $.delete-on-termination is required is aws-parameter('DeleteOnTermination');
    }

    class CancelExportTaskRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.export-task-id is required is aws-parameter('ExportTaskId');
    }

    class PrefixList:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class CreateCustomerGatewayRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.public-ip is required is aws-parameter('PublicIp');
        has Bool $.dry-run is aws-parameter('DryRun');
    ...
    class InstanceNetworkInterfaceSpecification:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DeleteNatGatewayRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.nat-gateway-id is required is aws-parameter('NatGatewayId');
    }

    class ProductCode:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class RunInstancesMonitoringEnabled:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.enabled is required is aws-parameter('Enabled');
    }

    class DescribeImportSnapshotTasksResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
        has ImportSnapshotTaskList $.import-snapshot-tasks is required is aws-parameter('ImportSnapshotTasks');
    }

    class DescribeIdFormatResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has IdFormatList $.statuses is required is aws-parameter('Statuses');
    }

    class AcceptVpcPeeringConnectionRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has Str $.vpc-peering-connection-id is required is aws-parameter('VpcPeeringConnectionId');
    }

    class InstanceMonitoring:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class PrivateIpAddressSpecification:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class ModifySubnetAttributeRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.subnet-id is required is aws-parameter('SubnetId');
    ...
    class InstancePrivateIpAddress:ver<2015-10-01.0> does AWS::SDK::Shape {
        has InstanceNetworkInterfaceAssociation $.association is required is aws-parameter('Association');
    ...
    class DescribeSpotFleetRequestHistoryResponse:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeRouteTablesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has ValueStringList $.route-table-ids is required is aws-parameter('RouteTableIds');
    }

    class DescribeAvailabilityZonesResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has AvailabilityZoneList $.availability-zones is required is aws-parameter('AvailabilityZones');
    }

    class Instance:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Placement $.placement is required is aws-parameter('Placement');
        has Str $.spot-instance-request-id is required is aws-parameter('SpotInstanceRequestId');
    ...
    class DescribeImagesResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has ImageList $.images is required is aws-parameter('Images');
    }

    subset UserIdGroupPairList of List[UserIdGroupPair];

    class ImportKeyPairResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.key-fingerprint is required is aws-parameter('KeyFingerprint');
        has Str $.key-name is required is aws-parameter('KeyName');
    }

    class RouteTable:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.route-table-id is required is aws-parameter('RouteTableId');
        has Str $.vpc-id is required is aws-parameter('VpcId');
    ...
    class CopySnapshotRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.kms-key-id is aws-parameter('KmsKeyId');
    ...
    class AssociateRouteTableResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.association-id is required is aws-parameter('AssociationId');
    }

    class CreateVpcPeeringConnectionRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class ModifyIdFormatRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.use-long-ids is required is aws-parameter('UseLongIds');
        has Str $.resource is required is aws-parameter('Resource');
    }

    class CancelReservedInstancesListingResult:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class InstanceStatusEvent:ver<2015-10-01.0> does AWS::SDK::Shape {
        has DateTime $.not-after is required is aws-parameter('NotAfter');
        has Str $.description is required is aws-parameter('Description');
        has DateTime $.not-before is required is aws-parameter('NotBefore');
        has Str $.code is required is aws-parameter('Code');
    ...
    class NetworkAclEntry:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.cidr-block is required is aws-parameter('CidrBlock');
        has Bool $.egress is required is aws-parameter('Egress');
    ...
    class ReservedInstancesModification:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class ResetInstanceAttributeRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.attribute is required is aws-parameter('Attribute');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class DescribeInstanceStatusRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has Str $.next-token is required is aws-parameter('NextToken');
    ...
    class DescribeVpnConnectionsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has VpnConnectionList $.vpn-connections is required is aws-parameter('VpnConnections');
    }

    class DeleteVpcPeeringConnectionRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.vpc-peering-connection-id is required is aws-parameter('VpcPeeringConnectionId');
    }

    class CreateRouteRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.route-table-id is required is aws-parameter('RouteTableId');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.gateway-id is aws-parameter('GatewayId');
        has Str $.network-interface-id is aws-parameter('NetworkInterfaceId');
    ...
    class DescribeNetworkAclsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class RestoreAddressToClassicResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.public-ip is required is aws-parameter('PublicIp');
        has Str $.status is required is aws-parameter('Status');
    }

    class HostProperties:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class ModifyReservedInstancesResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.reserved-instances-modification-id is required is aws-parameter('ReservedInstancesModificationId');
    }

    class EnableVpcClassicLinkResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.return is required is aws-parameter('Return');
    }

    class DeregisterImageRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.image-id is required is aws-parameter('ImageId');
    }

    class BundleInstanceResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has BundleTask $.bundle-task is required is aws-parameter('BundleTask');
    }

    subset SubnetList of List[Subnet];

    class DescribeSubnetsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has SubnetList $.subnets is required is aws-parameter('Subnets');
    }

    class DescribeMovingAddressesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has Str $.next-token is required is aws-parameter('NextToken');
    ...
    class CustomerGateway:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.customer-gateway-id is required is aws-parameter('CustomerGatewayId');
    ...
    class ModifyInstancePlacementResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.return is required is aws-parameter('Return');
    }

    class Host:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class ImportKeyPairRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
    ...
    class CopyImageResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.image-id is required is aws-parameter('ImageId');
    }

    class NewDhcpConfiguration:ver<2015-10-01.0> does AWS::SDK::Shape {
        has ValueStringList $.values is required is aws-parameter('Values');
        has Str $.key is required is aws-parameter('Key');
    }
    ...
    class UserIdGroupPair:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.group-id is required is aws-parameter('GroupId');
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Str $.user-id is required is aws-parameter('UserId');
        has Str $.vpc-peering-connection-id is required is aws-parameter('VpcPeeringConnectionId');
    ...
    class DescribeSnapshotsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
        has SnapshotList $.snapshots is required is aws-parameter('Snapshots');
    }

    class CreateSecurityGroupResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.group-id is required is aws-parameter('GroupId');
    }

    subset ScheduledInstancesNetworkInterfaceSet of List[ScheduledInstancesNetworkInterface];

    class RegisterImageResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.image-id is required is aws-parameter('ImageId');
    }
    ...
    class DescribeSecurityGroupsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has SecurityGroupList $.security-groups is required is aws-parameter('SecurityGroups');
    }

    class Route:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class CreateSubnetRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.cidr-block is required is aws-parameter('CidrBlock');
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.availability-zone is aws-parameter('AvailabilityZone');
    ...
    class NetworkInterfaceAttachment:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.instance-owner-id is required is aws-parameter('InstanceOwnerId');
        has Int $.device-index is required is aws-parameter('DeviceIndex');
        has DateTime $.attach-time is required is aws-parameter('AttachTime');
        has Str $.status is required is aws-parameter('Status');
    ...
    class GetConsoleOutputRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class AllocateHostsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has ResponseHostIdList $.host-ids is required is aws-parameter('HostIds');
    }

    class AttachNetworkInterfaceRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.device-index is required is aws-parameter('DeviceIndex');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.network-interface-id is required is aws-parameter('NetworkInterfaceId');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    ...
    class DescribeVpcEndpointsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
        has VpcEndpointSet $.vpc-endpoints is required is aws-parameter('VpcEndpoints');
    }

    class AttachVpnGatewayResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has VpcAttachment $.vpc-attachment is required is aws-parameter('VpcAttachment');
    }

    class ClientData:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class InstanceBlockDeviceMapping:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class NetworkAcl:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DisableVpcClassicLinkDnsSupportRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
    }

    class DescribeReservedInstancesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.offering-type is required is aws-parameter('OfferingType');
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has ReservedInstancesIdStringList $.reserved-instances-ids is required is aws-parameter('ReservedInstancesIds');
    ...
    class ProvisionedBandwidth:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class ReservedInstancesModificationResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has ReservedInstancesConfiguration $.target-configuration is required is aws-parameter('TargetConfiguration');
        has Str $.reserved-instances-id is required is aws-parameter('ReservedInstancesId');
    }

    class DescribeVpcAttributeResult:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeAddressesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class InstanceStateChange:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class ImportInstanceTaskDetails:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.description is aws-parameter('Description');
    ...
    class ImportImageResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.license-type is required is aws-parameter('LicenseType');
        has Str $.image-id is required is aws-parameter('ImageId');
        has Str $.description is required is aws-parameter('Description');
        has Str $.hypervisor is required is aws-parameter('Hypervisor');
    ...
    class DescribeScheduledInstanceAvailabilityRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is aws-parameter('MaxResults');
    ...
    class DeleteCustomerGatewayRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.customer-gateway-id is required is aws-parameter('CustomerGatewayId');
    }

    class DeleteRouteTableRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.route-table-id is required is aws-parameter('RouteTableId');
        has Bool $.dry-run is aws-parameter('DryRun');
    }

    class NetworkInterfacePrivateIpAddress:ver<2015-10-01.0> does AWS::SDK::Shape {
        has NetworkInterfaceAssociation $.association is required is aws-parameter('Association');
        has Bool $.primary is required is aws-parameter('Primary');
        has Str $.private-ip-address is required is aws-parameter('PrivateIpAddress');
        has Str $.private-dns-name is required is aws-parameter('PrivateDnsName');
    ...
    class RequestSpotInstancesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has DateTime $.valid-until is aws-parameter('ValidUntil');
    ...
    class VpcAttachment:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Str $.state is required is aws-parameter('State');
    }

    class DiskImage:ver<2015-10-01.0> does AWS::SDK::Shape {
        has DiskImageDetail $.image is required is aws-parameter('Image');
        has VolumeDetail $.volume is required is aws-parameter('Volume');
        has Str $.description is required is aws-parameter('Description');
    }

    class DescribeInternetGatewaysRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class AccountAttributeValue:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.attribute-value is required is aws-parameter('AttributeValue');
    }

    class DeleteDhcpOptionsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.dhcp-options-id is required is aws-parameter('DhcpOptionsId');
        has Bool $.dry-run is aws-parameter('DryRun');
    }

    class DeleteRouteRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.route-table-id is required is aws-parameter('RouteTableId');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.destination-cidr-block is required is aws-parameter('DestinationCidrBlock');
    }

    class ModifyHostsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has ResponseHostIdList $.successful is required is aws-parameter('Successful');
        has UnsuccessfulItemList $.unsuccessful is required is aws-parameter('Unsuccessful');
    }
    ...
    class Reservation:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.owner-id is required is aws-parameter('OwnerId');
    ...
    class GetPasswordDataResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has DateTime $.timestamp is required is aws-parameter('Timestamp');
        has Str $.password-data is required is aws-parameter('PasswordData');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class DescribeDhcpOptionsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class RevokeSecurityGroupIngressRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has IpPermissionList $.ip-permissions is required is aws-parameter('IpPermissions');
        has Str $.cidr-ip is required is aws-parameter('CidrIp');
        has Str $.source-security-group-owner-id is required is aws-parameter('SourceSecurityGroupOwnerId');
        has Str $.group-id is required is aws-parameter('GroupId');
    ...
    class DescribeSubnetsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has SubnetIdStringList $.subnet-ids is required is aws-parameter('SubnetIds');
    }

    class DescribeRouteTablesResult:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeReservedInstancesOfferingsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has Str $.offering-type is required is aws-parameter('OfferingType');
        has Str $.product-description is required is aws-parameter('ProductDescription');
        has Str $.instance-tenancy is required is aws-parameter('InstanceTenancy');
    ...
    class StopInstancesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Bool $.force is aws-parameter('Force');
        has InstanceIdStringList $.instance-ids is required is aws-parameter('InstanceIds');
    }

    class DescribePlacementGroupsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class InstanceAttribute:ver<2015-10-01.0> does AWS::SDK::Shape {
        has InstanceBlockDeviceMappingList $.block-device-mappings is required is aws-parameter('BlockDeviceMappings');
        has AttributeBooleanValue $.source-dest-check is required is aws-parameter('SourceDestCheck');
    ...
    class CreateDhcpOptionsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has NewDhcpConfigurationList $.dhcp-configurations is required is aws-parameter('DhcpConfigurations');
        has Bool $.dry-run is aws-parameter('DryRun');
    }

    class CancelSpotFleetRequestsErrorItem:ver<2015-10-01.0> does AWS::SDK::Shape {
        has CancelSpotFleetRequestsError $.error is required is aws-parameter('Error');
        has Str $.spot-fleet-request-id is required is aws-parameter('SpotFleetRequestId');
    }

    class RequestSpotFleetRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has SpotFleetRequestConfigData $.spot-fleet-request-config is required is aws-parameter('SpotFleetRequestConfig');
    }

    class RevokeSecurityGroupEgressRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has IpPermissionList $.ip-permissions is aws-parameter('IpPermissions');
        has Str $.cidr-ip is aws-parameter('CidrIp');
        has Str $.source-security-group-owner-id is aws-parameter('SourceSecurityGroupOwnerId');
        has Str $.group-id is required is aws-parameter('GroupId');
    ...
    class InternetGatewayAttachment:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Str $.state is required is aws-parameter('State');
    }

    class IpPermission:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class CreateVpcResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Vpc $.vpc is required is aws-parameter('Vpc');
    }

    class RejectVpcPeeringConnectionRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.vpc-peering-connection-id is required is aws-parameter('VpcPeeringConnectionId');
    }

    class EnableVgwRoutePropagationRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.route-table-id is required is aws-parameter('RouteTableId');
        has Str $.gateway-id is required is aws-parameter('GatewayId');
    }

    class DisassociateRouteTableRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.association-id is required is aws-parameter('AssociationId');
    }

    class ImportInstanceVolumeDetailItem:ver<2015-10-01.0> does AWS::SDK::Shape {
        has DiskImageDescription $.image is required is aws-parameter('Image');
        has Str $.description is aws-parameter('Description');
        has DiskImageVolumeDescription $.volume is required is aws-parameter('Volume');
        has Int $.bytes-converted is required is aws-parameter('BytesConverted');
    ...
    class ReservedInstances:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.offering-type is required is aws-parameter('OfferingType');
        has Str $.product-description is required is aws-parameter('ProductDescription');
        has Int $.duration is required is aws-parameter('Duration');
    ...
    class DescribeScheduledInstancesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class ConfirmProductInstanceResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.return is required is aws-parameter('Return');
        has Str $.owner-id is required is aws-parameter('OwnerId');
    }

    class CreateVpcEndpointResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.client-token is required is aws-parameter('ClientToken');
        has VpcEndpoint $.vpc-endpoint is required is aws-parameter('VpcEndpoint');
    }

    class RunInstancesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has BlockDeviceMappingRequestList $.block-device-mappings is aws-parameter('BlockDeviceMappings');
    ...
    class ScheduledInstancesPlacement:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.availability-zone is required is aws-parameter('AvailabilityZone');
        has Str $.group-name is required is aws-parameter('GroupName');
    }
    ...
    class CreateVpcRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.cidr-block is required is aws-parameter('CidrBlock');
        has Str $.instance-tenancy is aws-parameter('InstanceTenancy');
        has Bool $.dry-run is aws-parameter('DryRun');
    }

    class ScheduledInstancesNetworkInterface:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class StateReason:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.code is required is aws-parameter('Code');
        has Str $.message is required is aws-parameter('Message');
    }

    class CreateSnapshotRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.description is aws-parameter('Description');
        has Str $.volume-id is required is aws-parameter('VolumeId');
    }

    class ReservedInstancesConfiguration:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.platform is required is aws-parameter('Platform');
        has Str $.instance-type is required is aws-parameter('InstanceType');
        has Str $.availability-zone is required is aws-parameter('AvailabilityZone');
        has Int $.instance-count is required is aws-parameter('InstanceCount');
    ...
    class ModifyNetworkInterfaceAttributeRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has AttributeBooleanValue $.source-dest-check is aws-parameter('SourceDestCheck');
    ...
    class DescribeImagesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class CancelConversionRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class AttachNetworkInterfaceResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.attachment-id is required is aws-parameter('AttachmentId');
    }

    class InternetGateway:ver<2015-10-01.0> does AWS::SDK::Shape {
        has TagList $.tags is required is aws-parameter('Tags');
        has InternetGatewayAttachmentList $.attachments is required is aws-parameter('Attachments');
        has Str $.internet-gateway-id is required is aws-parameter('InternetGatewayId');
    }

    class NatGateway:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class ScheduledInstancesLaunchSpecification:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class RequestSpotFleetResponse:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.spot-fleet-request-id is required is aws-parameter('SpotFleetRequestId');
    }

    class ScheduledInstancesPrivateIpAddressConfig:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.primary is required is aws-parameter('Primary');
        has Str $.private-ip-address is required is aws-parameter('PrivateIpAddress');
    }

    class ResetSnapshotAttributeRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.snapshot-id is required is aws-parameter('SnapshotId');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.attribute is required is aws-parameter('Attribute');
    }
    ...
    class DescribeInstanceStatusResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has InstanceStatusList $.instance-statuses is required is aws-parameter('InstanceStatuses');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class DeleteVpcRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
    }
    ...
    class ImportInstanceResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has ConversionTask $.conversion-task is required is aws-parameter('ConversionTask');
    }

    class InstanceCount:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.state is required is aws-parameter('State');
        has Int $.instance-count is required is aws-parameter('InstanceCount');
    }

    class NatGatewayAddress:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.public-ip is required is aws-parameter('PublicIp');
    ...
    class CreateFlowLogsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.client-token is aws-parameter('ClientToken');
        has Str $.log-group-name is required is aws-parameter('LogGroupName');
        has Str $.traffic-type is required is aws-parameter('TrafficType');
        has Str $.resource-type is required is aws-parameter('ResourceType');
    ...
    class ActiveInstance:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.spot-instance-request-id is required is aws-parameter('SpotInstanceRequestId');
        has Str $.instance-type is required is aws-parameter('InstanceType');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class DescribeImportSnapshotTasksRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has ImportTaskIdList $.import-task-ids is required is aws-parameter('ImportTaskIds');
    ...
    class DeleteSnapshotRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.snapshot-id is required is aws-parameter('SnapshotId');
        has Bool $.dry-run is aws-parameter('DryRun');
    }

    class ScheduledInstancesIamInstanceProfile:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.arn is required is aws-parameter('Arn');
        has Str $.name is required is aws-parameter('Name');
    }

    class DiskImageDescription:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeVpcEndpointsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class DetachInternetGatewayRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.internet-gateway-id is required is aws-parameter('InternetGatewayId');
    }

    class DescribeTagsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class ImageAttribute:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class CancelSpotFleetRequestsError:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.code is required is aws-parameter('Code');
        has Str $.message is required is aws-parameter('Message');
    }

    class ModifyImageAttributeRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has UserIdStringList $.user-ids is aws-parameter('UserIds');
        has Bool $.dry-run is aws-parameter('DryRun');
        has AttributeValue $.description is aws-parameter('Description');
    ...
    class RequestSpotLaunchSpecification:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeBundleTasksRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has BundleIdStringList $.bundle-ids is required is aws-parameter('BundleIds');
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    }

    class ClassicLinkInstance:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has TagList $.tags is required is aws-parameter('Tags');
        has GroupIdentifierList $.groups is required is aws-parameter('Groups');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    ...
    class CreateReservedInstancesListingResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has ReservedInstancesListingList $.reserved-instances-listings is required is aws-parameter('ReservedInstancesListings');
    }

    class DeleteSubnetRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.subnet-id is required is aws-parameter('SubnetId');
        has Bool $.dry-run is aws-parameter('DryRun');
    }
    ...
    class ResetNetworkInterfaceAttributeRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
    ...
    class DescribeVolumeStatusResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has VolumeStatusList $.volume-statuses is required is aws-parameter('VolumeStatuses');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class DescribeSpotInstanceRequestsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has SpotInstanceRequestList $.spot-instance-requests is required is aws-parameter('SpotInstanceRequests');
    }

    class DescribeNetworkInterfacesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has NetworkInterfaceIdList $.network-interface-ids is required is aws-parameter('NetworkInterfaceIds');
    }

    class DescribeFlowLogsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
        has FlowLogSet $.flow-logs is required is aws-parameter('FlowLogs');
    }

    class CopySnapshotResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.snapshot-id is required is aws-parameter('SnapshotId');
    }

    subset PurchasedScheduledInstanceSet of List[ScheduledInstance];

    class TerminateInstancesResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has InstanceStateChangeList $.terminating-instances is required is aws-parameter('TerminatingInstances');
    }

    class AssociateAddressRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.public-ip is required is aws-parameter('PublicIp');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has Str $.network-interface-id is required is aws-parameter('NetworkInterfaceId');
    ...
    class CreateVpcEndpointRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class PurchaseReservedInstancesOfferingRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
    ...
    class AcceptVpcPeeringConnectionResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has VpcPeeringConnection $.vpc-peering-connection is required is aws-parameter('VpcPeeringConnection');
    }

    class CreateVpnConnectionRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.vpn-gateway-id is required is aws-parameter('VpnGatewayId');
        has Str $.customer-gateway-id is required is aws-parameter('CustomerGatewayId');
    ...
    class DeleteSecurityGroupRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.group-id is required is aws-parameter('GroupId');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has Str $.group-name is required is aws-parameter('GroupName');
    }

    class DeleteVpcEndpointsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has ValueStringList $.vpc-endpoint-ids is required is aws-parameter('VpcEndpointIds');
    }

    class MonitorInstancesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has InstanceIdStringList $.instance-ids is required is aws-parameter('InstanceIds');
    }

    class RunScheduledInstancesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class Vpc:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.dhcp-options-id is required is aws-parameter('DhcpOptionsId');
        has Str $.cidr-block is required is aws-parameter('CidrBlock');
        has Bool $.is-default is required is aws-parameter('IsDefault');
        has Str $.instance-tenancy is required is aws-parameter('InstanceTenancy');
    ...
    class DisassociateAddressRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.public-ip is required is aws-parameter('PublicIp');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has Str $.association-id is required is aws-parameter('AssociationId');
    }

    class DescribeInstancesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has Str $.next-token is required is aws-parameter('NextToken');
    ...
    class CancelSpotInstanceRequestsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class ExportToS3Task:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.container-format is required is aws-parameter('ContainerFormat');
        has Str $.s3-key is required is aws-parameter('S3Key');
        has Str $.s3-bucket is required is aws-parameter('S3Bucket');
        has Str $.disk-image-format is required is aws-parameter('DiskImageFormat');
    ...
    class DisableVpcClassicLinkDnsSupportResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.return is required is aws-parameter('Return');
    }

    class ConversionTask:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.conversion-task-id is required is aws-parameter('ConversionTaskId');
        has TagList $.tags is aws-parameter('Tags');
        has Str $.state is required is aws-parameter('State');
    ...
    class PeeringConnectionOptionsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.allow-egress-from-local-vpc-to-remote-classic-link is required is aws-parameter('AllowEgressFromLocalVpcToRemoteClassicLink');
        has Bool $.allow-egress-from-local-classic-link-to-remote-vpc is required is aws-parameter('AllowEgressFromLocalClassicLinkToRemoteVpc');
    }
    ...
    class DiskImageDetail:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.import-manifest-url is required is aws-parameter('ImportManifestUrl');
        has Str $.format is required is aws-parameter('Format');
        has Int $.bytes is required is aws-parameter('Bytes');
    }

    class DescribeVolumeStatusRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has VolumeIdStringList $.volume-ids is required is aws-parameter('VolumeIds');
    ...
    class InstanceState:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.name is required is aws-parameter('Name');
        has Int $.code is required is aws-parameter('Code');
    }

    class DescribeIdFormatRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.resource is required is aws-parameter('Resource');
    }

    class AttributeValue:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.value is required is aws-parameter('Value');
    }

    class CreateVpcPeeringConnectionResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has VpcPeeringConnection $.vpc-peering-connection is required is aws-parameter('VpcPeeringConnection');
    }

    subset InstanceCountList of List[InstanceCount];

    class ScheduledInstancesMonitoring:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.enabled is required is aws-parameter('Enabled');
    }

    class DescribeReservedInstancesResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has ReservedInstancesList $.reserved-instances is required is aws-parameter('ReservedInstances');
    }

    class AccountAttribute:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeSecurityGroupsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class MoveAddressToVpcResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.status is required is aws-parameter('Status');
        has Str $.allocation-id is required is aws-parameter('AllocationId');
    }

    class DisableVpcClassicLinkResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.return is required is aws-parameter('Return');
    }

    class CreateSecurityGroupRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.description is required is aws-parameter('Description');
        has Str $.group-name is required is aws-parameter('GroupName');
    ...
    class EnableVpcClassicLinkRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
    }

    class CreateInternetGatewayRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is required is aws-parameter('DryRun');
    }

    subset ReservedInstancesListingList of List[ReservedInstancesListing];

    class DescribeSpotPriceHistoryRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has FilterList $.filters is required is aws-parameter('Filters');
    ...
    class CreateReservedInstancesListingRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.client-token is required is aws-parameter('ClientToken');
        has Str $.reserved-instances-id is required is aws-parameter('ReservedInstancesId');
    ...
    class LaunchSpecification:ver<2015-10-01.0> does AWS::SDK::Shape {
        has BlockDeviceMappingList $.block-device-mappings is required is aws-parameter('BlockDeviceMappings');
        has SpotPlacement $.placement is required is aws-parameter('Placement');
        has Str $.subnet-id is required is aws-parameter('SubnetId');
        has Str $.ramdisk-id is required is aws-parameter('RamdiskId');
    ...
    class CreateInternetGatewayResult:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class PurchaseReservedInstancesOfferingResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.reserved-instances-id is required is aws-parameter('ReservedInstancesId');
    }

    class ReplaceRouteTableAssociationResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.new-association-id is required is aws-parameter('NewAssociationId');
    }

    subset BundleIdStringList of List[Str];

    class DescribeSecurityGroupReferencesResult:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class BundleInstanceRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Storage $.storage is required is aws-parameter('Storage');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class VolumeAttachment:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.device is required is aws-parameter('Device');
        has DateTime $.attach-time is required is aws-parameter('AttachTime');
        has Str $.state is required is aws-parameter('State');
        has Str $.volume-id is required is aws-parameter('VolumeId');
    ...
    class UserBucket:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.s3-key is required is aws-parameter('S3Key');
        has Str $.s3-bucket is required is aws-parameter('S3Bucket');
    }

    class GetConsoleScreenshotRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.instance-id is required is aws-parameter('InstanceId');
        has Bool $.wake-up is aws-parameter('WakeUp');
    }

    class DescribeHostsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class InstanceNetworkInterfaceAssociation:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.public-ip is required is aws-parameter('PublicIp');
        has Str $.ip-owner-id is required is aws-parameter('IpOwnerId');
        has Str $.public-dns-name is required is aws-parameter('PublicDnsName');
    }

    class GetPasswordDataRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class DescribeMovingAddressesResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has MovingAddressStatusSet $.moving-address-statuses is required is aws-parameter('MovingAddressStatuses');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class CreateCustomerGatewayResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has CustomerGateway $.customer-gateway is required is aws-parameter('CustomerGateway');
    }

    class StaleIpPermission:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeSpotDatafeedSubscriptionResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has SpotDatafeedSubscription $.spot-datafeed-subscription is required is aws-parameter('SpotDatafeedSubscription');
    }

    class LaunchPermissionModifications:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class SpotInstanceRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.product-description is required is aws-parameter('ProductDescription');
    ...
    class DescribeSecurityGroupReferencesRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has GroupIds $.group-id is required is aws-parameter('GroupId');
        has Bool $.dry-run is aws-parameter('DryRun');
    }

    class DescribeReservedInstancesModificationsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Str $.next-token is required is aws-parameter('NextToken');
    ...
    class DescribePrefixListsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has PrefixListSet $.prefix-lists is required is aws-parameter('PrefixLists');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class ConfirmProductInstanceRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeVpcClassicLinkDnsSupportRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has Str $.next-token is required is aws-parameter('NextToken');
        has VpcClassicLinkIdList $.vpc-ids is required is aws-parameter('VpcIds');
    }

    class InstanceStatus:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class IamInstanceProfile:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.arn is required is aws-parameter('Arn');
        has Str $.id is required is aws-parameter('Id');
    }

    class DescribeHostsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has RequestHostIdList $.host-ids is required is aws-parameter('HostIds');
        has FilterList $.filter is required is aws-parameter('Filter');
        has Str $.next-token is required is aws-parameter('NextToken');
    ...
    class SnapshotTaskDetail:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Num $.disk-image-size is required is aws-parameter('DiskImageSize');
        has Str $.snapshot-id is required is aws-parameter('SnapshotId');
        has Str $.description is required is aws-parameter('Description');
        has Str $.status is required is aws-parameter('Status');
    ...
    class ModifySpotFleetRequestRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.excess-capacity-termination-policy is aws-parameter('ExcessCapacityTerminationPolicy');
        has Int $.target-capacity is aws-parameter('TargetCapacity');
        has Str $.spot-fleet-request-id is required is aws-parameter('SpotFleetRequestId');
    }

    class AssociateDhcpOptionsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.dhcp-options-id is required is aws-parameter('DhcpOptionsId');
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
    }

    class CreateRouteTableRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
    }
    ...
    class DescribeDhcpOptionsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has DhcpOptionsIdStringList $.dhcp-options-ids is required is aws-parameter('DhcpOptionsIds');
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    }

    class CancelImportTaskResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.previous-state is required is aws-parameter('PreviousState');
        has Str $.import-task-id is required is aws-parameter('ImportTaskId');
        has Str $.state is required is aws-parameter('State');
    }

    class CreateSpotDatafeedSubscriptionRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.bucket is required is aws-parameter('Bucket');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.prefix is aws-parameter('Prefix');
    }

    class ReservedInstancesListing:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.client-token is required is aws-parameter('ClientToken');
    ...
    class PurchaseScheduledInstancesResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has PurchasedScheduledInstanceSet $.scheduled-instance-set is required is aws-parameter('ScheduledInstanceSet');
    }

    class VpcEndpoint:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.service-name is required is aws-parameter('ServiceName');
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Str $.vpc-endpoint-id is required is aws-parameter('VpcEndpointId');
        has Str $.state is required is aws-parameter('State');
    ...
    class AvailabilityZone:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class ModifyHostsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has RequestHostIdList $.host-ids is required is aws-parameter('HostIds');
        has Str $.auto-placement is required is aws-parameter('AutoPlacement');
    }
    ...
    class ExportTask:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeCustomerGatewaysRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has CustomerGatewayIdStringList $.customer-gateway-ids is required is aws-parameter('CustomerGatewayIds');
    }

    class CancelSpotFleetRequestsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class Image:ver<2015-10-01.0> does AWS::SDK::Shape {
        has BlockDeviceMappingList $.block-device-mappings is required is aws-parameter('BlockDeviceMappings');
        has Str $.root-device-type is required is aws-parameter('RootDeviceType');
    ...
    class DescribeStaleSecurityGroupsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is aws-parameter('MaxResults');
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.next-token is aws-parameter('NextToken');
    ...
    class KeyPair:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.key-material is required is aws-parameter('KeyMaterial');
        has Str $.key-fingerprint is required is aws-parameter('KeyFingerprint');
        has Str $.key-name is required is aws-parameter('KeyName');
    }

    class SpotInstanceStatus:ver<2015-10-01.0> does AWS::SDK::Shape {
        has DateTime $.update-time is required is aws-parameter('UpdateTime');
        has Str $.code is required is aws-parameter('Code');
        has Str $.message is required is aws-parameter('Message');
    }

    class DescribeVpcClassicLinkDnsSupportResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
    ...
    class GetConsoleOutputResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.output is required is aws-parameter('Output');
        has DateTime $.timestamp is required is aws-parameter('Timestamp');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class SpotFleetRequestConfig:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class GroupIdentifier:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.group-id is required is aws-parameter('GroupId');
        has Str $.group-name is required is aws-parameter('GroupName');
    }

    class DescribeVpcsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has VpcList $.vpcs is required is aws-parameter('Vpcs');
    }

    class DescribeSpotFleetRequestsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has ValueStringList $.spot-fleet-request-ids is required is aws-parameter('SpotFleetRequestIds');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has Str $.next-token is required is aws-parameter('NextToken');
    ...
    class DeleteFlowLogsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has UnsuccessfulItemSet $.unsuccessful is required is aws-parameter('Unsuccessful');
    }

    class DetachClassicLinkVpcRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class DescribeReservedInstancesListingsResult:ver<2015-10-01.0> does AWS::SDK::Shape {
        has ReservedInstancesListingList $.reserved-instances-listings is required is aws-parameter('ReservedInstancesListings');
    }

    class AttributeBooleanValue:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeReservedInstancesListingsRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Str $.reserved-instances-listing-id is required is aws-parameter('ReservedInstancesListingId');
        has Str $.reserved-instances-id is required is aws-parameter('ReservedInstancesId');
    }
    ...
    class ReplaceRouteTableAssociationRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Str $.route-table-id is required is aws-parameter('RouteTableId');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.association-id is required is aws-parameter('AssociationId');
    }

    class ModifyVpcAttributeRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
    ...
    class SpotFleetLaunchSpecification:ver<2015-10-01.0> does AWS::SDK::Shape {
        has BlockDeviceMappingList $.block-device-mappings is required is aws-parameter('BlockDeviceMappings');
        has SpotPlacement $.placement is required is aws-parameter('Placement');
        has Str $.subnet-id is required is aws-parameter('SubnetId');
        has Str $.ramdisk-id is required is aws-parameter('RamdiskId');
    ...
    class CreateKeyPairRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.key-name is required is aws-parameter('KeyName');
    }

    class DeleteInternetGatewayRequest:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.internet-gateway-id is required is aws-parameter('InternetGatewayId');
    }

    class NetworkInterfaceAttachmentChanges:ver<2015-10-01.0> does AWS::SDK::Shape {
        has Bool $.delete-on-termination is required is aws-parameter('DeleteOnTermination');
        has Str $.attachment-id is required is aws-parameter('AttachmentId');
    }
