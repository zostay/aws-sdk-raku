...
class AWS::SDK::Service::SSM:ver<2014-11-06.0> does AWS::SDK::Service {
    ...
    class GetMaintenanceWindowExecutionTaskRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class ResourceDataSyncAlreadyExistsException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.sync-name is required is aws-parameter('SyncName');
    }

    subset Parameters of Map[Str, ParameterValueList];

    class DeletePatchBaselineRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.baseline-id is required is aws-parameter('BaselineId');
    }

    class MaintenanceWindowExecutionTaskIdentity:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class InventoryItemAttribute:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.data-type is required is aws-parameter('DataType');
        has Str $.name is required is aws-parameter('Name');
    }

    class GetDocumentResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class AutomationDefinitionVersionNotFoundException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class DescribeInstancePatchStatesForPatchGroupResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has InstancePatchStatesList $.instance-patch-states is required is aws-parameter('InstancePatchStates');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class ParameterAlreadyExists:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('message');
    }

    class UnsupportedPlatformType:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class TooManyUpdates:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class DescribePatchGroupStateRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.patch-group is required is aws-parameter('PatchGroup');
    }

    class InvalidResourceType:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    class DescribeInstanceAssociationsStatusResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class UpdateMaintenanceWindowTargetRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class UnsupportedOperatingSystem:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidAutomationSignalException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class MaintenanceWindowTaskInvocationParameters:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class CancelCommandResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    class CreateActivationResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class RegisterTaskWithMaintenanceWindowResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.window-task-id is required is aws-parameter('WindowTaskId');
    }

    class DescribeParametersResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has ParameterMetadataList $.parameters is required is aws-parameter('Parameters');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class InstanceAssociationOutputUrl:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class DeleteDocumentResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    class CommandPlugin:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class MaxDocumentSizeExceeded:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class DescribeAssociationRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class PutComplianceItemsResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    class GetMaintenanceWindowTaskRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.window-task-id is required is aws-parameter('WindowTaskId');
        has Str $.window-id is required is aws-parameter('WindowId');
    }

    class AssociationAlreadyExists:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    subset ComplianceStringFilterValueList of List[Str] where 1 <= *.elems <= 20;

    class AssociationOverview:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class CreateAssociationBatchRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has CreateAssociationBatchRequestEntries $.entries is required is aws-parameter('Entries');
    }

    class MaintenanceWindowIdentity:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class UpdateAssociationResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has AssociationDescription $.association-description is required is aws-parameter('AssociationDescription');
    }

    class AssociationVersionLimitExceeded:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    subset CommandPluginList of List[CommandPlugin];

    class ParameterLimitExceeded:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('message');
    }

    class ResourceDataSyncInvalidConfigurationException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class GetMaintenanceWindowRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.window-id is required is aws-parameter('WindowId');
    }

    class DeleteMaintenanceWindowResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.window-id is required is aws-parameter('WindowId');
    }

    class InvalidInventoryItemContextException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }
    ...
    class SendCommandResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class InvocationDoesNotExist:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    subset InstancePatchStatesList of List[InstancePatchState] where 1 <= *.elems <= 5;

    class InstancePatchStateFilter:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class UpdatePatchBaselineRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class DescribeInstancePatchStatesForPatchGroupRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class GetCommandInvocationResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class DuplicateDocumentContent:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    subset AssociationFilterList of List[AssociationFilter] where 1 <= *.elems;

    class InstanceAggregatedAssociationOverview:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.detailed-status is required is aws-parameter('DetailedStatus');
    ...
    class GetParametersByPathResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class InvalidResultAttributeException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    subset DocumentFilterList of List[DocumentFilter] where 1 <= *.elems;

    class DeleteDocumentRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.name is required is aws-parameter('Name');
    }

    class InvalidInstanceId:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class StepExecution:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class GetInventoryRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class DocumentIdentifier:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class DescribeDocumentPermissionResponse:ver<2014-11-06.0> does AWS::SDK::Shape {
        has AccountIdList $.account-ids is required is aws-parameter('AccountIds');
    }

    class UpdateAssociationRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class GetMaintenanceWindowExecutionTaskInvocationResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.task-type is required is aws-parameter('TaskType');
        has Str $.window-execution-id is required is aws-parameter('WindowExecutionId');
        has Str $.window-target-id is required is aws-parameter('WindowTargetId');
        has DateTime $.end-time is required is aws-parameter('EndTime');
    ...
    class DescribeMaintenanceWindowTasksResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
        has MaintenanceWindowTaskList $.tasks is required is aws-parameter('Tasks');
    }

    class GetPatchBaselineForPatchGroupResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.baseline-id is required is aws-parameter('BaselineId');
        has Str $.operating-system is required is aws-parameter('OperatingSystem');
        has Str $.patch-group is required is aws-parameter('PatchGroup');
    }

    class GetMaintenanceWindowExecutionResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.window-execution-id is required is aws-parameter('WindowExecutionId');
        has DateTime $.end-time is required is aws-parameter('EndTime');
        has Str $.status-details is required is aws-parameter('StatusDetails');
    ...
    class DescribeAutomationExecutionsResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
    ...
    class DescribeMaintenanceWindowsResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has MaintenanceWindowIdentityList $.window-identities is required is aws-parameter('WindowIdentities');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class AutomationExecutionMetadata:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class DescribeMaintenanceWindowTargetsResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
    ...
    class SeveritySummary:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class ListAssociationVersionsResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
        has AssociationVersionList $.association-versions is required is aws-parameter('AssociationVersions');
    }

    class PatchFilter:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class InventoryItem:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class PutComplianceItemsRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class DescribeAssociationResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has AssociationDescription $.association-description is required is aws-parameter('AssociationDescription');
    }

    class ListDocumentVersionsResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has DocumentVersionList $.document-versions is required is aws-parameter('DocumentVersions');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class ComplianceExecutionSummary:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class ListAssociationsResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
    ...
    class InvalidDocumentOperation:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class AssociatedInstances:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    class DeregisterTargetFromMaintenanceWindowResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.window-target-id is required is aws-parameter('WindowTargetId');
        has Str $.window-id is required is aws-parameter('WindowId');
    }

    class S3OutputLocation:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.output-s3-bucket-name is required is aws-parameter('OutputS3BucketName');
        has Str $.output-s3-key-prefix is required is aws-parameter('OutputS3KeyPrefix');
        has Str $.output-s3-region is required is aws-parameter('OutputS3Region');
    }
    ...
    class MaintenanceWindowStepFunctionsParameters:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class InvalidPermissionType:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class UpdateMaintenanceWindowRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class GetParametersResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has ParameterList $.parameters is required is aws-parameter('Parameters');
        has ParameterNameList $.invalid-parameters is required is aws-parameter('InvalidParameters');
    }

    class DescribeEffectivePatchesForPatchBaselineResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has EffectivePatchList $.effective-patches is required is aws-parameter('EffectivePatches');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class UpdatePatchBaselineResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class UpdateMaintenanceWindowTargetResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.window-target-id is required is aws-parameter('WindowTargetId');
        has Str $.description is required is aws-parameter('Description');
        has Str $.name is required is aws-parameter('Name');
        has Str $.owner-information is required is aws-parameter('OwnerInformation');
    ...
    class InvalidAssociationVersion:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    subset ComplianceResourceTypeList of List[Str] where 1 <= *.elems;

    class PatchFilterGroup:ver<2014-11-06.0> does AWS::SDK::Shape {
        has PatchFilterList $.patch-filters is required is aws-parameter('PatchFilters');
    }

    class InvalidActivation:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class GetDefaultPatchBaselineResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.baseline-id is required is aws-parameter('BaselineId');
        has Str $.operating-system is required is aws-parameter('OperatingSystem');
    }

    class DeleteResourceDataSyncRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.sync-name is required is aws-parameter('SyncName');
    }

    class ParameterStringFilter:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class DeregisterTargetFromMaintenanceWindowRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.window-target-id is required is aws-parameter('WindowTargetId');
    ...
    class StatusUnchanged:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    class Tag:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.value is required is aws-parameter('Value');
        has Str $.key is required is aws-parameter('Key');
    }

    class DocumentVersionLimitExceeded:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    subset InventoryItemList of List[InventoryItem] where 1 <= *.elems <= 30;

    class ListCommandsRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
    ...
    class HierarchyLevelLimitExceededException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('message');
    }

    class DeleteParametersResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class DescribePatchGroupsRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has PatchOrchestratorFilterList $.filters is required is aws-parameter('Filters');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class UpdateManagedInstanceRoleRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.iam-role is required is aws-parameter('IamRole');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class InstanceInformationFilter:ver<2014-11-06.0> does AWS::SDK::Shape {
        has InstanceInformationFilterValueSet $.value-set is required is aws-parameter('valueSet');
        has Str $.key is required is aws-parameter('key');
    }

    class InvalidInstanceInformationFilterValue:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('message');
    }

    subset InventoryFilterValueList of List[Str] where 1 <= *.elems <= 20;

    class FailureDetails:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class CreateDocumentResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has DocumentDescription $.document-description is required is aws-parameter('DocumentDescription');
    }

    class Parameter:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.name is required is aws-parameter('Name');
        has Str $.value is required is aws-parameter('Value');
        has Str $.type is required is aws-parameter('Type');
    }

    class ResourceLimitExceededException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class GetMaintenanceWindowExecutionTaskResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class DescribeInstancePatchStatesRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is aws-parameter('MaxResults');
        has Str $.next-token is aws-parameter('NextToken');
        has InstanceIdList $.instance-ids is required is aws-parameter('InstanceIds');
    }

    class PatchRuleGroup:ver<2014-11-06.0> does AWS::SDK::Shape {
        has PatchRuleList $.patch-rules is required is aws-parameter('PatchRules');
    }

    class ListResourceDataSyncRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class NotificationConfig:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class IdempotentParameterMismatch:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }
    ...
    class CreateResourceDataSyncResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    class DescribeInstancePatchesRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is aws-parameter('MaxResults');
    ...
    class UpdateAssociationStatusRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has AssociationStatus $.association-status is required is aws-parameter('AssociationStatus');
        has Str $.name is required is aws-parameter('Name');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class GetInventorySchemaRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
    ...
    class DescribeDocumentPermissionRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.name is required is aws-parameter('Name');
        has Str $.permission-type is required is aws-parameter('PermissionType');
    }

    class InvalidFilterOption:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('message');
    }

    class InvalidFilterValue:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class ResultAttribute:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.type-name is required is aws-parameter('TypeName');
    }

    class CreateMaintenanceWindowRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.duration is required is aws-parameter('Duration');
    ...
    class DescribeMaintenanceWindowExecutionTasksResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class MaintenanceWindowRunCommandParameters:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class StopAutomationExecutionRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.automation-execution-id is required is aws-parameter('AutomationExecutionId');
    }

    class DescribeActivationsRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has DescribeActivationsFilterList $.filters is required is aws-parameter('Filters');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class InvalidOutputLocation:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    class ParameterMetadata:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class CreateAssociationBatchRequestEntry:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.association-name is aws-parameter('AssociationName');
        has InstanceAssociationOutputLocation $.output-location is aws-parameter('OutputLocation');
        has Str $.schedule-expression is aws-parameter('ScheduleExpression');
        has Str $.document-version is aws-parameter('DocumentVersion');
    ...
    class ListTagsForResourceResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has TagList $.tag-list is required is aws-parameter('TagList');
    }

    subset TagList of List[Tag];

    class InstanceInformationStringFilter:ver<2014-11-06.0> does AWS::SDK::Shape {
        has InstanceInformationFilterValueSet $.values is required is aws-parameter('Values');
        has Str $.key is required is aws-parameter('Key');
    }

    class ListCommandInvocationsResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
    ...
    class PatchGroupPatchBaselineMapping:ver<2014-11-06.0> does AWS::SDK::Shape {
        has PatchBaselineIdentity $.baseline-identity is required is aws-parameter('BaselineIdentity');
        has Str $.patch-group is required is aws-parameter('PatchGroup');
    }

    class RegisterDefaultPatchBaselineRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.baseline-id is required is aws-parameter('BaselineId');
    }

    subset InventoryItemContentContext of Map[Str, Str] where 0 <= *.keys.elems <= 50;

    class InventoryResultItem:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.content-hash is aws-parameter('ContentHash');
    ...
    class DeleteActivationResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    class PutInventoryResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    class CancelCommandRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.command-id is required is aws-parameter('CommandId');
        has InstanceIdList $.instance-ids is aws-parameter('InstanceIds');
    }

    class AddTagsToResourceRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has TagList $.tags is required is aws-parameter('Tags');
        has Str $.resource-id is required is aws-parameter('ResourceId');
        has Str $.resource-type is required is aws-parameter('ResourceType');
    }

    class PutInventoryRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has InventoryItemList $.items is required is aws-parameter('Items');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class GetParameterHistoryResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class AutomationExecution:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.automation-execution-status is required is aws-parameter('AutomationExecutionStatus');
        has Str $.document-version is required is aws-parameter('DocumentVersion');
        has Str $.failure-message is required is aws-parameter('FailureMessage');
        has DateTime $.execution-end-time is required is aws-parameter('ExecutionEndTime');
    ...
    class InventoryResultEntity:ver<2014-11-06.0> does AWS::SDK::Shape {
        has InventoryResultItemMap $.data is required is aws-parameter('Data');
        has Str $.id is required is aws-parameter('Id');
    }

    class ModifyDocumentPermissionRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.name is required is aws-parameter('Name');
    ...
    class InvalidDocumentSchemaVersion:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class GetPatchBaselineResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has DateTime $.modified-date is required is aws-parameter('ModifiedDate');
        has PatchIdList $.approved-patches is required is aws-parameter('ApprovedPatches');
        has Str $.baseline-id is required is aws-parameter('BaselineId');
        has PatchIdList $.rejected-patches is required is aws-parameter('RejectedPatches');
    ...
    class GetDeployablePatchSnapshotForInstanceResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class AutomationDefinitionNotFoundException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class DescribeEffectiveInstanceAssociationsRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is aws-parameter('MaxResults');
        has Str $.next-token is aws-parameter('NextToken');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class InvalidFilter:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class DeleteParameterRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.name is required is aws-parameter('Name');
    }

    class InventoryItemSchema:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class Association:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class HierarchyTypeMismatchException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('message');
    }

    class DescribePatchBaselinesRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has PatchOrchestratorFilterList $.filters is required is aws-parameter('Filters');
        has Str $.next-token is required is aws-parameter('NextToken');
    }
    ...
    class CompliantSummary:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class DescribeEffectivePatchesForPatchBaselineRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is aws-parameter('MaxResults');
        has Str $.baseline-id is required is aws-parameter('BaselineId');
        has Str $.next-token is aws-parameter('NextToken');
    }
    ...
    class RemoveTagsFromResourceResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    class DescribeMaintenanceWindowsRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
    ...
    class EffectivePatch:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class TargetInUseException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidOutputFolder:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    class CreateAssociationBatchResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class CreateResourceDataSyncRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.sync-name is required is aws-parameter('SyncName');
    ...
    class DeregisterTaskFromMaintenanceWindowRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.window-task-id is required is aws-parameter('WindowTaskId');
        has Str $.window-id is required is aws-parameter('WindowId');
    }

    class InventoryFilter:ver<2014-11-06.0> does AWS::SDK::Shape {
        has InventoryFilterValueList $.values is required is aws-parameter('Values');
        has Str $.type is aws-parameter('Type');
        has Str $.key is required is aws-parameter('Key');
    }

    class GetAutomationExecutionRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.automation-execution-id is required is aws-parameter('AutomationExecutionId');
    }

    class ListCommandsResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has CommandList $.commands is required is aws-parameter('Commands');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class GetParametersByPathRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is aws-parameter('MaxResults');
    ...
    class DescribeMaintenanceWindowTasksRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is aws-parameter('MaxResults');
    ...
    class InvalidDocumentVersion:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidNotificationConfig:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class MaintenanceWindowExecutionTaskInvocationIdentity:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.task-type is required is aws-parameter('TaskType');
        has Str $.window-execution-id is required is aws-parameter('WindowExecutionId');
        has Str $.window-target-id is required is aws-parameter('WindowTargetId');
        has DateTime $.end-time is required is aws-parameter('EndTime');
    ...
    class AddTagsToResourceResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    class DescribeMaintenanceWindowExecutionTasksRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is aws-parameter('MaxResults');
        has Str $.window-execution-id is required is aws-parameter('WindowExecutionId');
        has MaintenanceWindowFilterList $.filters is aws-parameter('Filters');
        has Str $.next-token is aws-parameter('NextToken');
    ...
    class ListResourceComplianceSummariesResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class DescribeAvailablePatchesRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has PatchOrchestratorFilterList $.filters is required is aws-parameter('Filters');
        has Str $.next-token is required is aws-parameter('NextToken');
    }
    ...
    class StopAutomationExecutionResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    class GetDeployablePatchSnapshotForInstanceRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.snapshot-id is required is aws-parameter('SnapshotId');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class DeregisterTaskFromMaintenanceWindowResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.window-task-id is required is aws-parameter('WindowTaskId');
        has Str $.window-id is required is aws-parameter('WindowId');
    }

    class DescribeMaintenanceWindowExecutionTaskInvocationsResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class Patch:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class DeleteAssociationResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    class DescribeAutomationExecutionsRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
    ...
    class ParameterNotFound:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('message');
    }

    class DescribeMaintenanceWindowExecutionTaskInvocationsRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is aws-parameter('MaxResults');
        has Str $.window-execution-id is required is aws-parameter('WindowExecutionId');
        has MaintenanceWindowFilterList $.filters is aws-parameter('Filters');
        has Str $.task-id is required is aws-parameter('TaskId');
    ...
    class InvalidRole:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class ComplianceTypeCountLimitExceededException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class AutomationExecutionFilter:ver<2014-11-06.0> does AWS::SDK::Shape {
        has AutomationExecutionFilterValueList $.values is required is aws-parameter('Values');
        has Str $.key is required is aws-parameter('Key');
    }

    class ParameterPatternMismatchException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('message');
    }

    subset AssociationDescriptionList of List[AssociationDescription];

    class CreateMaintenanceWindowResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.window-id is required is aws-parameter('WindowId');
    }

    class MaintenanceWindowExecution:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.window-execution-id is required is aws-parameter('WindowExecutionId');
        has DateTime $.end-time is required is aws-parameter('EndTime');
        has Str $.status-details is required is aws-parameter('StatusDetails');
        has DateTime $.start-time is required is aws-parameter('StartTime');
    ...
    class ResourceDataSyncNotFoundException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.sync-name is required is aws-parameter('SyncName');
    }

    class GetInventoryResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class CreateDocumentRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.content is required is aws-parameter('Content');
        has Str $.name is required is aws-parameter('Name');
        has Str $.document-type is aws-parameter('DocumentType');
    }

    class DeleteActivationRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.activation-id is required is aws-parameter('ActivationId');
    }

    class ListCommandInvocationsRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has CommandFilterList $.filters is required is aws-parameter('Filters');
        has Str $.command-id is required is aws-parameter('CommandId');
        has Str $.next-token is required is aws-parameter('NextToken');
    ...
    class Target:ver<2014-11-06.0> does AWS::SDK::Shape {
        has TargetValues $.values is required is aws-parameter('Values');
        has Str $.key is required is aws-parameter('Key');
    }

    class InstanceAssociationStatusInfo:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.association-name is required is aws-parameter('AssociationName');
    ...
    class PatchBaselineIdentity:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.baseline-id is required is aws-parameter('BaselineId');
    ...
    class SendAutomationSignalRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.signal-type is required is aws-parameter('SignalType');
        has Str $.automation-execution-id is required is aws-parameter('AutomationExecutionId');
        has AutomationParameterMap $.payload is aws-parameter('Payload');
    }

    class DocumentFilter:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.value is required is aws-parameter('value');
        has Str $.key is required is aws-parameter('key');
    }

    class ListInventoryEntriesRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is aws-parameter('MaxResults');
    ...
    class AlreadyExistsException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class UpdateManagedInstanceRoleResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    subset DocumentVersionList of List[DocumentVersionInfo] where 1 <= *.elems;

    class DocumentDescription:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.owner is required is aws-parameter('Owner');
    ...
    class ComplianceItem:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class UpdateDocumentResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has DocumentDescription $.document-description is required is aws-parameter('DocumentDescription');
    }

    class DocumentPermissionLimit:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    subset InventoryResultItemMap of Map[Str, InventoryResultItem];

    class DocumentAlreadyExists:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    subset ParameterList of List[Parameter];

    class UpdateDocumentDefaultVersionResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class DescribeMaintenanceWindowTargetsRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is aws-parameter('MaxResults');
        has MaintenanceWindowFilterList $.filters is aws-parameter('Filters');
        has Str $.next-token is aws-parameter('NextToken');
        has Str $.window-id is required is aws-parameter('WindowId');
    ...
    class InstanceInformation:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class ParameterHistory:ver<2014-11-06.0> does AWS::SDK::Shape {
        has DateTime $.last-modified-date is required is aws-parameter('LastModifiedDate');
        has Str $.description is required is aws-parameter('Description');
        has Str $.last-modified-user is required is aws-parameter('LastModifiedUser');
        has Str $.name is required is aws-parameter('Name');
    ...
    class DeleteParametersRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has ParameterNameList $.names is required is aws-parameter('Names');
    }

    class DeleteResourceDataSyncResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    class RegisterPatchBaselineForPatchGroupRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.baseline-id is required is aws-parameter('BaselineId');
        has Str $.patch-group is required is aws-parameter('PatchGroup');
    }

    class RegisterTargetWithMaintenanceWindowResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.window-target-id is required is aws-parameter('WindowTargetId');
    }

    class ResourceDataSyncCountExceededException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class UpdateDocumentDefaultVersionRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.document-version is required is aws-parameter('DocumentVersion');
        has Str $.name is required is aws-parameter('Name');
    }
    ...
    class ListComplianceSummariesRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has ComplianceStringFilterList $.filters is required is aws-parameter('Filters');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class InvalidUpdate:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class MaintenanceWindowTaskParameterValueExpression:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class PutParameterRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.description is aws-parameter('Description');
        has Str $.name is required is aws-parameter('Name');
    ...
    class FeatureNotAvailableException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class AutomationExecutionLimitExceededException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidNextToken:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class DeleteParameterResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    subset InstanceIdList of List[Str] where 0 <= *.elems <= 50;

    class GetPatchBaselineRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.baseline-id is required is aws-parameter('BaselineId');
    }

    class DescribeAvailablePatchesResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has PatchList $.patches is required is aws-parameter('Patches');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class GetInventorySchemaResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has InventoryItemSchemaResultList $.schemas is required is aws-parameter('Schemas');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class InvalidParameters:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidAutomationExecutionParametersException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class ListComplianceItemsRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has ComplianceStringFilterList $.filters is required is aws-parameter('Filters');
    ...
    class GetDocumentRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.document-version is aws-parameter('DocumentVersion');
        has Str $.name is required is aws-parameter('Name');
    }

    class DeregisterManagedInstanceRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class SendCommandRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class MaintenanceWindowLambdaParameters:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class TooManyTagsError:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    class CommandFilter:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.value is required is aws-parameter('value');
        has Str $.key is required is aws-parameter('key');
    }
    ...
    class MaintenanceWindowTarget:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.window-target-id is required is aws-parameter('WindowTargetId');
        has Str $.description is required is aws-parameter('Description');
        has Str $.name is required is aws-parameter('Name');
        has Str $.owner-information is required is aws-parameter('OwnerInformation');
    ...
    class AssociationFilter:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.value is required is aws-parameter('value');
        has Str $.key is required is aws-parameter('key');
    }
    ...
    class DescribeDocumentRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.document-version is aws-parameter('DocumentVersion');
        has Str $.name is required is aws-parameter('Name');
    }

    class DescribePatchGroupsResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
    ...
    class DescribeDocumentResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has DocumentDescription $.document is required is aws-parameter('Document');
    }

    class PatchComplianceData:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.severity is required is aws-parameter('Severity');
        has Str $.classification is required is aws-parameter('Classification');
    ...
    class GetMaintenanceWindowExecutionTaskInvocationRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.window-execution-id is required is aws-parameter('WindowExecutionId');
        has Str $.invocation-id is required is aws-parameter('InvocationId');
        has Str $.task-id is required is aws-parameter('TaskId');
    }
    ...
    class PatchRule:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class ResourceInUseException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class UpdateMaintenanceWindowResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.duration is required is aws-parameter('Duration');
        has Bool $.allow-unassociated-targets is required is aws-parameter('AllowUnassociatedTargets');
        has Str $.schedule is required is aws-parameter('Schedule');
        has Str $.description is required is aws-parameter('Description');
    ...
    class GetParametersRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Bool $.with-decryption is aws-parameter('WithDecryption');
        has ParameterNameList $.names is required is aws-parameter('Names');
    }

    class GetMaintenanceWindowTaskResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.max-concurrency is required is aws-parameter('MaxConcurrency');
        has Str $.task-type is required is aws-parameter('TaskType');
        has Str $.task-arn is required is aws-parameter('TaskArn');
        has Str $.window-task-id is required is aws-parameter('WindowTaskId');
    ...
    class GetAutomationExecutionResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has AutomationExecution $.automation-execution is required is aws-parameter('AutomationExecution');
    }

    class DeregisterManagedInstanceResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    class InvalidTarget:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class S3OutputUrl:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.output-url is required is aws-parameter('OutputUrl');
    }

    class DescribeInstanceInformationRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
    ...
    class UpdateAssociationStatusResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has AssociationDescription $.association-description is required is aws-parameter('AssociationDescription');
    }

    class DescribePatchBaselinesResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class GetPatchBaselineForPatchGroupRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.operating-system is aws-parameter('OperatingSystem');
        has Str $.patch-group is required is aws-parameter('PatchGroup');
    }

    class DocumentVersionInfo:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.document-version is required is aws-parameter('DocumentVersion');
        has Str $.name is required is aws-parameter('Name');
        has DateTime $.created-date is required is aws-parameter('CreatedDate');
    ...
    class SendAutomationSignalResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    class FailedCreateAssociation:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class ListComplianceItemsResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
        has ComplianceItemList $.compliance-items is required is aws-parameter('ComplianceItems');
    }

    class MaintenanceWindowFilter:ver<2014-11-06.0> does AWS::SDK::Shape {
        has MaintenanceWindowFilterValues $.values is required is aws-parameter('Values');
        has Str $.key is required is aws-parameter('Key');
    }

    class InvalidAllowedPatternException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('message');
    }

    class Activation:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class Command:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class DeregisterPatchBaselineForPatchGroupRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.baseline-id is required is aws-parameter('BaselineId');
        has Str $.patch-group is required is aws-parameter('PatchGroup');
    }

    class InstancePatchState:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class GetMaintenanceWindowExecutionRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.window-execution-id is required is aws-parameter('WindowExecutionId');
    }

    class DeleteMaintenanceWindowRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.window-id is required is aws-parameter('WindowId');
    }

    class DescribeInstancePatchesResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has PatchComplianceDataList $.patches is required is aws-parameter('Patches');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class ListInventoryEntriesResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.capture-time is required is aws-parameter('CaptureTime');
        has Str $.schema-version is required is aws-parameter('SchemaVersion');
        has Str $.next-token is required is aws-parameter('NextToken');
        has Str $.type-name is required is aws-parameter('TypeName');
    ...
    class RegisterPatchBaselineForPatchGroupResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.baseline-id is required is aws-parameter('BaselineId');
        has Str $.patch-group is required is aws-parameter('PatchGroup');
    }

    class RegisterTaskWithMaintenanceWindowRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.max-concurrency is required is aws-parameter('MaxConcurrency');
        has Str $.task-type is required is aws-parameter('TaskType');
        has Str $.task-arn is required is aws-parameter('TaskArn');
        has Str $.client-token is aws-parameter('ClientToken');
    ...
    class UpdateMaintenanceWindowTaskRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.max-concurrency is aws-parameter('MaxConcurrency');
    ...
    class StartAutomationExecutionRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.document-version is aws-parameter('DocumentVersion');
        has Str $.client-token is aws-parameter('ClientToken');
    ...
    class UpdateDocumentRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.document-version is aws-parameter('DocumentVersion');
        has Str $.content is required is aws-parameter('Content');
        has Str $.name is required is aws-parameter('Name');
    }

    class PatchStatus:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class DocumentDefaultVersionDescription:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.default-version is required is aws-parameter('DefaultVersion');
        has Str $.name is required is aws-parameter('Name');
    }
    ...
    class ResourceDataSyncItem:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.sync-name is required is aws-parameter('SyncName');
    ...
    class InvalidCommandId:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    class CreatePatchBaselineResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.baseline-id is required is aws-parameter('BaselineId');
    }
    ...
    class RegisterDefaultPatchBaselineResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.baseline-id is required is aws-parameter('BaselineId');
    }

    class AssociationLimitExceeded:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    class CreateAssociationResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has AssociationDescription $.association-description is required is aws-parameter('AssociationDescription');
    }

    class MaintenanceWindowTask:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.max-concurrency is required is aws-parameter('MaxConcurrency');
        has Str $.task-arn is required is aws-parameter('TaskArn');
        has Str $.window-task-id is required is aws-parameter('WindowTaskId');
        has Str $.description is required is aws-parameter('Description');
    ...
    class GetParameterResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Parameter $.parameter is required is aws-parameter('Parameter');
    }

    class DescribeActivationsResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has ActivationList $.activation-list is required is aws-parameter('ActivationList');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class DescribeInstanceAssociationsStatusRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is aws-parameter('MaxResults');
        has Str $.next-token is aws-parameter('NextToken');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class InstanceAssociation:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.content is required is aws-parameter('Content');
        has Str $.association-id is required is aws-parameter('AssociationId');
        has Str $.association-version is required is aws-parameter('AssociationVersion');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    ...
    class DeletePatchBaselineResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.baseline-id is required is aws-parameter('BaselineId');
    }

    class ItemContentMismatchException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.type-name is required is aws-parameter('TypeName');
        has Str $.message is required is aws-parameter('Message');
    }

    class GetMaintenanceWindowResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has DateTime $.modified-date is required is aws-parameter('ModifiedDate');
        has Int $.duration is required is aws-parameter('Duration');
        has Bool $.allow-unassociated-targets is required is aws-parameter('AllowUnassociatedTargets');
        has Str $.schedule is required is aws-parameter('Schedule');
    ...
    class GetCommandInvocationRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.command-id is required is aws-parameter('CommandId');
        has Str $.plugin-name is aws-parameter('PluginName');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class AutomationExecutionNotFoundException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class ListResourceDataSyncResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
        has ResourceDataSyncItemList $.resource-data-sync-items is required is aws-parameter('ResourceDataSyncItems');
    }

    class GetDefaultPatchBaselineRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.operating-system is required is aws-parameter('OperatingSystem');
    }

    class ListDocumentVersionsRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is aws-parameter('MaxResults');
        has Str $.name is required is aws-parameter('Name');
        has Str $.next-token is aws-parameter('NextToken');
    }

    class DeleteAssociationRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.association-id is required is aws-parameter('AssociationId');
        has Str $.name is required is aws-parameter('Name');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }
    ...
    class CommandInvocation:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class RegisterTargetWithMaintenanceWindowRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.client-token is aws-parameter('ClientToken');
        has Str $.description is aws-parameter('Description');
        has Str $.name is aws-parameter('Name');
        has Str $.owner-information is aws-parameter('OwnerInformation');
    ...
    class ListDocumentsRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has Str $.next-token is required is aws-parameter('NextToken');
        has DocumentFilterList $.document-filter-list is required is aws-parameter('DocumentFilterList');
    }

    class AssociationStatus:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class InternalServerError:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class DoesNotExistException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class ComplianceItemEntry:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.severity is required is aws-parameter('Severity');
    ...
    class CreateActivationRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class PutParameterResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    subset InstancePatchStateFilterValues of List[Str] where 1 <= *.elems <= 1;

    class TotalSizeLimitExceededException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidTypeNameException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    subset PatchFilterValueList of List[Str] where 1 <= *.elems <= 20;

    class AssociationDescription:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.association-name is required is aws-parameter('AssociationName');
    ...
    class DescribeMaintenanceWindowExecutionsResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has MaintenanceWindowExecutionList $.window-executions is required is aws-parameter('WindowExecutions');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class InvalidPluginName:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    subset ComplianceSummaryItemList of List[ComplianceSummaryItem];

    class DescribeInstancePatchStatesResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class DescribeActivationsFilter:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class DescribeParametersRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
    ...
    class UpdateMaintenanceWindowTaskResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.max-concurrency is required is aws-parameter('MaxConcurrency');
        has Str $.task-arn is required is aws-parameter('TaskArn');
        has Str $.window-task-id is required is aws-parameter('WindowTaskId');
        has Str $.description is required is aws-parameter('Description');
    ...
    class InstanceAssociationOutputLocation:ver<2014-11-06.0> does AWS::SDK::Shape {
        has S3OutputLocation $.s3-location is required is aws-parameter('S3Location');
    }

    class CreatePatchBaselineRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has PatchIdList $.approved-patches is aws-parameter('ApprovedPatches');
        has PatchIdList $.rejected-patches is aws-parameter('RejectedPatches');
        has Str $.client-token is aws-parameter('ClientToken');
        has Str $.description is aws-parameter('Description');
    ...
    class DescribeInstanceInformationResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
        has InstanceInformationList $.instance-information-list is required is aws-parameter('InstanceInformationList');
    }

    class InvalidItemContentException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.type-name is required is aws-parameter('TypeName');
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidActivationId:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class MaintenanceWindowAutomationParameters:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.document-version is required is aws-parameter('DocumentVersion');
        has AutomationParameterMap $.parameters is required is aws-parameter('Parameters');
    }
    ...
    class ItemSizeLimitExceededException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.type-name is required is aws-parameter('TypeName');
        has Str $.message is required is aws-parameter('Message');
    }
    ...
    class ComplianceStringFilter:ver<2014-11-06.0> does AWS::SDK::Shape {
        has ComplianceStringFilterValueList $.values is required is aws-parameter('Values');
        has Str $.type is required is aws-parameter('Type');
        has Str $.key is required is aws-parameter('Key');
    }

    class InvalidResourceId:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    class ListComplianceSummariesResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has ComplianceSummaryItemList $.compliance-summary-items is required is aws-parameter('ComplianceSummaryItems');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class LoggingInfo:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class ListAssociationsRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has Str $.next-token is required is aws-parameter('NextToken');
        has AssociationFilterList $.association-filter-list is required is aws-parameter('AssociationFilterList');
    }

    class DuplicateInstanceId:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    subset ComplianceItemDetails of Map[Str, Str];

    class DescribePatchGroupStateResult:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class CreateAssociationRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.association-name is aws-parameter('AssociationName');
        has InstanceAssociationOutputLocation $.output-location is aws-parameter('OutputLocation');
        has Str $.schedule-expression is aws-parameter('ScheduleExpression');
        has Str $.document-version is aws-parameter('DocumentVersion');
    ...
    class NonCompliantSummary:ver<2014-11-06.0> does AWS::SDK::Shape {
        has SeveritySummary $.severity-summary is required is aws-parameter('SeveritySummary');
    ...
    class ListDocumentsResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has DocumentIdentifierList $.document-identifiers is required is aws-parameter('DocumentIdentifiers');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class GetParameterRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Bool $.with-decryption is aws-parameter('WithDecryption');
        has Str $.name is required is aws-parameter('Name');
    }

    class GetParameterHistoryRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is aws-parameter('MaxResults');
        has Bool $.with-decryption is aws-parameter('WithDecryption');
        has Str $.name is required is aws-parameter('Name');
        has Str $.next-token is aws-parameter('NextToken');
    ...
    class DescribeMaintenanceWindowExecutionsRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is aws-parameter('MaxResults');
        has MaintenanceWindowFilterList $.filters is aws-parameter('Filters');
        has Str $.next-token is aws-parameter('NextToken');
        has Str $.window-id is required is aws-parameter('WindowId');
    ...
    class StartAutomationExecutionResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.automation-execution-id is required is aws-parameter('AutomationExecutionId');
    }

    class SubTypeCountLimitExceededException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    subset AutomationExecutionFilterValueList of List[Str] where 1 <= *.elems <= 10;

    class ModifyDocumentPermissionResponse:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    subset InstanceInformationList of List[InstanceInformation];

    class AssociationDoesNotExist:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class DeregisterPatchBaselineForPatchGroupResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.baseline-id is required is aws-parameter('BaselineId');
        has Str $.patch-group is required is aws-parameter('PatchGroup');
    }

    class ListResourceComplianceSummariesRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has ComplianceStringFilterList $.filters is required is aws-parameter('Filters');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class InvalidDocumentContent:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class DocumentParameter:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.description is required is aws-parameter('Description');
        has Str $.name is required is aws-parameter('Name');
        has Str $.type is required is aws-parameter('Type');
    ...
    class PatchOrchestratorFilter:ver<2014-11-06.0> does AWS::SDK::Shape {
        has PatchOrchestratorFilterValues $.values is required is aws-parameter('Values');
        has Str $.key is required is aws-parameter('Key');
    }

    class InvalidFilterKey:ver<2014-11-06.0> does AWS::SDK::Shape {
    }

    class ListAssociationVersionsRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Int $.max-results is aws-parameter('MaxResults');
        has Str $.association-id is required is aws-parameter('AssociationId');
        has Str $.next-token is aws-parameter('NextToken');
    }

    class ListTagsForResourceRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.resource-id is required is aws-parameter('ResourceId');
        has Str $.resource-type is required is aws-parameter('ResourceType');
    }
    ...
    class AssociationVersionInfo:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.association-name is required is aws-parameter('AssociationName');
        has InstanceAssociationOutputLocation $.output-location is required is aws-parameter('OutputLocation');
        has Str $.schedule-expression is required is aws-parameter('ScheduleExpression');
        has Str $.document-version is required is aws-parameter('DocumentVersion');
    ...
    class CustomSchemaCountLimitExceededException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class DescribeEffectiveInstanceAssociationsResult:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
        has InstanceAssociationList $.associations is required is aws-parameter('Associations');
    }

    class InvalidSchedule:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class DocumentLimitExceeded:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class ParametersFilter:ver<2014-11-06.0> does AWS::SDK::Shape {
        has ParametersFilterValueList $.values is required is aws-parameter('Values');
        has Str $.key is required is aws-parameter('Key');
    }

    class InvalidDocument:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidKeyId:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('message');
    }

    class ResourceComplianceSummaryItem:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.compliance-type is required is aws-parameter('ComplianceType');
    ...
    class ResourceDataSyncS3Destination:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class ComplianceSummaryItem:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.compliance-type is required is aws-parameter('ComplianceType');
        has CompliantSummary $.compliant-summary is required is aws-parameter('CompliantSummary');
        has NonCompliantSummary $.non-compliant-summary is required is aws-parameter('NonCompliantSummary');
    }
    ...
    class RemoveTagsFromResourceRequest:ver<2014-11-06.0> does AWS::SDK::Shape {
    ...
    class UnsupportedParameterType:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('message');
    }

    class UnsupportedInventoryItemContextException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.type-name is required is aws-parameter('TypeName');
        has Str $.message is required is aws-parameter('Message');
    }

    class UnsupportedInventorySchemaVersionException:ver<2014-11-06.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }
