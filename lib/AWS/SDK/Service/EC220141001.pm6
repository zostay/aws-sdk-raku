...
class AWS::SDK::Service::EC2:ver<2014-10-01.0> does AWS::SDK::Service {
    ...
    class DeleteVpnGatewayRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.vpn-gateway-id is required is aws-parameter('VpnGatewayId');
    }

    class AttachClassicLinkVpcResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.return is required is aws-parameter('Return');
    }

    subset AllocationIdList of List[Str];

    class CreateTagsRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class ModifyInstanceAttributeRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class Placement:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class ReservedInstanceLimitPrice:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Num $.amount is required is aws-parameter('Amount');
        has Str $.currency-code is required is aws-parameter('CurrencyCode');
    }

    class DeleteSpotDatafeedSubscriptionRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is required is aws-parameter('DryRun');
    }

    class CancelReservedInstancesListingRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.reserved-instances-listing-id is required is aws-parameter('ReservedInstancesListingId');
    }

    class NetworkInterfaceAssociation:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeAddressesResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has AddressList $.addresses is required is aws-parameter('Addresses');
    }

    class DetachVpnGatewayRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class RejectVpcPeeringConnectionResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.return is required is aws-parameter('Return');
    }

    class DescribeSnapshotsRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DetachClassicLinkVpcResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.return is required is aws-parameter('Return');
    }

    class MonitorInstancesResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has InstanceMonitoringList $.instance-monitorings is required is aws-parameter('InstanceMonitorings');
    }

    class DescribeReservedInstancesModificationsResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
    ...
    class DeleteNetworkAclEntryRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class ModifyReservedInstancesRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class CancelExportTaskRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.export-task-id is required is aws-parameter('ExportTaskId');
    }

    class CancelledSpotInstanceRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.spot-instance-request-id is required is aws-parameter('SpotInstanceRequestId');
        has Str $.state is required is aws-parameter('State');
    }

    class EbsInstanceBlockDeviceSpecification:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.volume-id is required is aws-parameter('VolumeId');
        has Bool $.delete-on-termination is required is aws-parameter('DeleteOnTermination');
    }

    class InstanceBlockDeviceMappingSpecification:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class CreateCustomerGatewayRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.public-ip is required is aws-parameter('PublicIp');
        has Bool $.dry-run is aws-parameter('DryRun');
    ...
    class InstanceNetworkInterfaceSpecification:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class Snapshot:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class RunInstancesMonitoringEnabled:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.enabled is required is aws-parameter('Enabled');
    }

    class ProductCode:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class TagDescription:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class AssociateRouteTableRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.route-table-id is required is aws-parameter('RouteTableId');
        has Str $.subnet-id is required is aws-parameter('SubnetId');
        has Bool $.dry-run is aws-parameter('DryRun');
    }

    class AcceptVpcPeeringConnectionRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has Str $.vpc-peering-connection-id is required is aws-parameter('VpcPeeringConnectionId');
    }

    class CreateNetworkAclResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has NetworkAcl $.network-acl is required is aws-parameter('NetworkAcl');
    }

    class InstanceMonitoring:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class PrivateIpAddressSpecification:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.primary is aws-parameter('Primary');
        has Str $.private-ip-address is required is aws-parameter('PrivateIpAddress');
    }

    class DescribeAvailabilityZonesRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class EnableVolumeIORequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.volume-id is required is aws-parameter('VolumeId');
    }

    class ModifySubnetAttributeRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.subnet-id is required is aws-parameter('SubnetId');
        has AttributeBooleanValue $.map-public-ip-on-launch is aws-parameter('MapPublicIpOnLaunch');
    }

    class PriceScheduleSpecification:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Num $.price is required is aws-parameter('Price');
    ...
    class AvailabilityZoneMessage:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class DisableVgwRoutePropagationRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.route-table-id is required is aws-parameter('RouteTableId');
        has Str $.gateway-id is required is aws-parameter('GatewayId');
    }

    class EbsBlockDevice:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Int $.volume-size is required is aws-parameter('VolumeSize');
        has Str $.snapshot-id is required is aws-parameter('SnapshotId');
    ...
    class InstancePrivateIpAddress:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class ModifySnapshotAttributeRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class BlobAttributeValue:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Blob $.value is required is aws-parameter('Value');
    }

    class DescribeRouteTablesRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has ValueStringList $.route-table-ids is required is aws-parameter('RouteTableIds');
    }

    class DescribeAvailabilityZonesResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has AvailabilityZoneList $.availability-zones is required is aws-parameter('AvailabilityZones');
    }

    class Instance:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeImagesResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has ImageList $.images is required is aws-parameter('Images');
    }

    class CreateVolumePermission:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.group is required is aws-parameter('Group');
        has Str $.user-id is required is aws-parameter('UserId');
    }

    class VpcPeeringConnectionVpcInfo:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class RouteTable:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.route-table-id is required is aws-parameter('RouteTableId');
        has Str $.vpc-id is required is aws-parameter('VpcId');
    ...
    class ImportKeyPairResult:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeSnapshotAttributeRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.snapshot-id is required is aws-parameter('SnapshotId');
        has Bool $.dry-run is aws-parameter('DryRun');
    ...
    class ResetImageAttributeRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.image-id is required is aws-parameter('ImageId');
        has Str $.attribute is required is aws-parameter('Attribute');
    }

    class AssociateRouteTableResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.association-id is required is aws-parameter('AssociationId');
    }

    class CopySnapshotRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class CreateVpcPeeringConnectionRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class TerminateInstancesRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has InstanceIdStringList $.instance-ids is required is aws-parameter('InstanceIds');
    }

    class SpotPrice:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class CancelReservedInstancesListingResult:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DeleteKeyPairRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.key-name is required is aws-parameter('KeyName');
    }

    class ImportInstanceLaunchSpecification:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Placement $.placement is required is aws-parameter('Placement');
        has Str $.subnet-id is required is aws-parameter('SubnetId');
    ...
    class ReservedInstancesModification:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class AttachClassicLinkVpcRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
    ...
    class DescribeVpcsRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has VpcIdStringList $.vpc-ids is required is aws-parameter('VpcIds');
    }

    class InstanceStatusEvent:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class NetworkAclEntry:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.cidr-block is required is aws-parameter('CidrBlock');
        has Bool $.egress is required is aws-parameter('Egress');
    ...
    class AuthorizeSecurityGroupIngressRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class ResetInstanceAttributeRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.attribute is required is aws-parameter('Attribute');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class DescribeInstanceStatusRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has Str $.next-token is required is aws-parameter('NextToken');
    ...
    class DescribeExportTasksRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class VpnGateway:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeVolumesRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class Filter:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class UserData:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.data is required is aws-parameter('Data');
    }

    subset AccountAttributeNameStringList of List[Str];

    class LaunchPermission:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.group is required is aws-parameter('Group');
        has Str $.user-id is required is aws-parameter('UserId');
    }

    class VpcPeeringConnectionStateReason:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.code is required is aws-parameter('Code');
        has Str $.message is required is aws-parameter('Message');
    }

    class VolumeStatusAction:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.description is required is aws-parameter('Description');
    ...
    class DeleteVpcPeeringConnectionRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.vpc-peering-connection-id is required is aws-parameter('VpcPeeringConnectionId');
    }

    class CreateRouteRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.route-table-id is required is aws-parameter('RouteTableId');
        has Bool $.dry-run is aws-parameter('DryRun');
    ...
    class DescribeVpnConnectionsResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has VpnConnectionList $.vpn-connections is required is aws-parameter('VpnConnections');
    }

    class RecurringCharge:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Num $.amount is required is aws-parameter('Amount');
        has Str $.frequency is required is aws-parameter('Frequency');
    }

    class VpnStaticRoute:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class ReplaceNetworkAclAssociationResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.new-association-id is required is aws-parameter('NewAssociationId');
    }

    class DescribeNetworkAclsRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has ValueStringList $.network-acl-ids is required is aws-parameter('NetworkAclIds');
    }

    class DescribeInstanceAttributeRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.attribute is required is aws-parameter('Attribute');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class AttachVolumeRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class PropagatingVgw:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.gateway-id is required is aws-parameter('GatewayId');
    }

    class ModifyReservedInstancesResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.reserved-instances-modification-id is required is aws-parameter('ReservedInstancesModificationId');
    }

    class DescribeKeyPairsRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has KeyNameStringList $.key-names is required is aws-parameter('KeyNames');
    }

    class DeregisterImageRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.image-id is required is aws-parameter('ImageId');
    }

    class BundleInstanceResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has BundleTask $.bundle-task is required is aws-parameter('BundleTask');
    }

    class EnableVpcClassicLinkResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.return is required is aws-parameter('Return');
    }

    subset SubnetList of List[Subnet];

    class StartInstancesResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has InstanceStateChangeList $.starting-instances is required is aws-parameter('StartingInstances');
    }

    class DescribeSubnetsResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has SubnetList $.subnets is required is aws-parameter('Subnets');
    }

    class CustomerGateway:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class VpcPeeringConnection:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeVpcClassicLinkRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has VpcClassicLinkIdList $.vpc-ids is required is aws-parameter('VpcIds');
    }

    class ImportKeyPairRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Blob $.public-key-material is required is aws-parameter('PublicKeyMaterial');
        has Str $.key-name is required is aws-parameter('KeyName');
    }

    class ImportVolumeRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class NewDhcpConfiguration:ver<2014-10-01.0> does AWS::SDK::Shape {
        has ValueStringList $.values is required is aws-parameter('Values');
        has Str $.key is required is aws-parameter('Key');
    }
    ...
    class DescribeNetworkInterfaceAttributeRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.network-interface-id is required is aws-parameter('NetworkInterfaceId');
        has Str $.attribute is aws-parameter('Attribute');
    }

    class CopyImageResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.image-id is required is aws-parameter('ImageId');
    }

    subset ImageIdStringList of List[Str];

    class ModifyVolumeAttributeRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has AttributeBooleanValue $.auto-enable-io is aws-parameter('AutoEnableIO');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.volume-id is required is aws-parameter('VolumeId');
    }

    class UserIdGroupPair:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.group-id is required is aws-parameter('GroupId');
        has Str $.user-id is required is aws-parameter('UserId');
        has Str $.group-name is required is aws-parameter('GroupName');
    }

    class DescribeSnapshotsResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
        has SnapshotList $.snapshots is required is aws-parameter('Snapshots');
    }

    class CreateRouteTableResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has RouteTable $.route-table is required is aws-parameter('RouteTable');
    }

    class CreateSecurityGroupResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.group-id is required is aws-parameter('GroupId');
    }

    class PlacementGroup:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeCustomerGatewaysResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has CustomerGatewayList $.customer-gateways is required is aws-parameter('CustomerGateways');
    }

    class ExportToS3TaskSpecification:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class RegisterImageResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.image-id is required is aws-parameter('ImageId');
    }
    ...
    class CreateInstanceExportTaskRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.description is aws-parameter('Description');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    ...
    class Route:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeSnapshotAttributeResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has CreateVolumePermissionList $.create-volume-permissions is required is aws-parameter('CreateVolumePermissions');
        has Str $.snapshot-id is required is aws-parameter('SnapshotId');
        has ProductCodeList $.product-codes is required is aws-parameter('ProductCodes');
    }

    class DescribeSecurityGroupsResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has SecurityGroupList $.security-groups is required is aws-parameter('SecurityGroups');
    }

    class CreatePlacementGroupRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.strategy is required is aws-parameter('Strategy');
        has Str $.group-name is required is aws-parameter('GroupName');
    }
    ...
    class CreateVolumePermissionModifications:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class InstanceStatusDetails:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class CreateSubnetRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.cidr-block is required is aws-parameter('CidrBlock');
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
    ...
    class NetworkInterfaceAttachment:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.instance-owner-id is required is aws-parameter('InstanceOwnerId');
        has Int $.device-index is required is aws-parameter('DeviceIndex');
        has DateTime $.attach-time is required is aws-parameter('AttachTime');
        has Str $.status is required is aws-parameter('Status');
    ...
    class AttachNetworkInterfaceRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Int $.device-index is required is aws-parameter('DeviceIndex');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.network-interface-id is required is aws-parameter('NetworkInterfaceId');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    ...
    class CreateNetworkAclRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
    }

    class GetConsoleOutputRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }
    ...
    class AttachVpnGatewayResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has VpcAttachment $.vpc-attachment is required is aws-parameter('VpcAttachment');
    }

    class DescribeNetworkInterfacesResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has NetworkInterfaceList $.network-interfaces is required is aws-parameter('NetworkInterfaces');
    }

    class BundleTaskError:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.code is required is aws-parameter('Code');
        has Str $.message is required is aws-parameter('Message');
    }

    class DetachVolumeRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class InstanceBlockDeviceMapping:ver<2014-10-01.0> does AWS::SDK::Shape {
        has EbsInstanceBlockDevice $.ebs is required is aws-parameter('Ebs');
        has Str $.device-name is required is aws-parameter('DeviceName');
    }

    class NetworkAcl:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class ReservedInstancesModificationResult:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeReservedInstancesRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DiskImageVolumeDescription:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class VolumeStatusInfo:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.status is required is aws-parameter('Status');
        has VolumeStatusDetailsList $.details is required is aws-parameter('Details');
    }

    class DescribeVpcAttributeResult:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeReservedInstancesOfferingsResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has ReservedInstancesOfferingList $.reserved-instances-offerings is required is aws-parameter('ReservedInstancesOfferings');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class DescribeAddressesRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class InstanceStateChange:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeVolumesResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has VolumeList $.volumes is required is aws-parameter('Volumes');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class DeleteRouteTableRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.route-table-id is required is aws-parameter('RouteTableId');
        has Bool $.dry-run is aws-parameter('DryRun');
    }

    class DeleteCustomerGatewayRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.customer-gateway-id is required is aws-parameter('CustomerGatewayId');
    }

    class ImportInstanceTaskDetails:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.description is aws-parameter('Description');
    ...
    class IpRange:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.cidr-ip is required is aws-parameter('CidrIp');
    }

    class NetworkInterfacePrivateIpAddress:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class VpcClassicLink:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has TagList $.tags is required is aws-parameter('Tags');
        has Bool $.classic-link-enabled is required is aws-parameter('ClassicLinkEnabled');
    }

    class RequestSpotInstancesRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class VpcAttachment:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Str $.state is required is aws-parameter('State');
    }

    class Reservation:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.owner-id is required is aws-parameter('OwnerId');
    ...
    class DescribeTagsRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has Str $.next-token is required is aws-parameter('NextToken');
    ...
    class DescribeInternetGatewaysRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class DeleteRouteRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.route-table-id is required is aws-parameter('RouteTableId');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.destination-cidr-block is required is aws-parameter('DestinationCidrBlock');
    }

    class AccountAttributeValue:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.attribute-value is required is aws-parameter('AttributeValue');
    }

    class DeleteDhcpOptionsRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.dhcp-options-id is required is aws-parameter('DhcpOptionsId');
        has Bool $.dry-run is aws-parameter('DryRun');
    }

    class DiskImage:ver<2014-10-01.0> does AWS::SDK::Shape {
        has DiskImageDetail $.image is required is aws-parameter('Image');
        has VolumeDetail $.volume is required is aws-parameter('Volume');
        has Str $.description is required is aws-parameter('Description');
    }
    ...
    class RevokeSecurityGroupIngressRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has IpPermissionList $.ip-permissions is required is aws-parameter('IpPermissions');
        has Str $.cidr-ip is required is aws-parameter('CidrIp');
        has Str $.source-security-group-owner-id is required is aws-parameter('SourceSecurityGroupOwnerId');
        has Str $.group-id is required is aws-parameter('GroupId');
    ...
    class DescribeImageAttributeRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.image-id is required is aws-parameter('ImageId');
        has Str $.attribute is required is aws-parameter('Attribute');
    }

    class DescribeDhcpOptionsResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has DhcpOptionsList $.dhcp-options is required is aws-parameter('DhcpOptions');
    }

    class DeleteNetworkInterfaceRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.network-interface-id is required is aws-parameter('NetworkInterfaceId');
    }

    class DescribeVpnGatewaysResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has VpnGatewayList $.vpn-gateways is required is aws-parameter('VpnGateways');
    }

    class GetPasswordDataResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has DateTime $.timestamp is required is aws-parameter('Timestamp');
        has Str $.password-data is required is aws-parameter('PasswordData');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class VolumeDetail:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Int $.size is required is aws-parameter('Size');
    }

    subset SecurityGroupStringList of List[Str];

    class ReservedInstancesId:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.reserved-instances-id is required is aws-parameter('ReservedInstancesId');
    }

    class DescribeSubnetsRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has SubnetIdStringList $.subnet-ids is required is aws-parameter('SubnetIds');
    }

    class DescribeRouteTablesResult:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class CreateVpnGatewayResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has VpnGateway $.vpn-gateway is required is aws-parameter('VpnGateway');
    }

    class DescribeReservedInstancesOfferingsRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has Str $.offering-type is required is aws-parameter('OfferingType');
        has Str $.product-description is required is aws-parameter('ProductDescription');
    ...
    class CreateVpnGatewayRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.availability-zone is aws-parameter('AvailabilityZone');
        has Str $.type is required is aws-parameter('Type');
    }

    class StopInstancesRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Bool $.force is aws-parameter('Force');
        has InstanceIdStringList $.instance-ids is required is aws-parameter('InstanceIds');
    }

    class DescribePlacementGroupsResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has PlacementGroupList $.placement-groups is required is aws-parameter('PlacementGroups');
    }

    class AttachInternetGatewayRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
    ...
    class InstanceAttribute:ver<2014-10-01.0> does AWS::SDK::Shape {
        has InstanceBlockDeviceMappingList $.block-device-mappings is required is aws-parameter('BlockDeviceMappings');
    ...
    class RevokeSecurityGroupEgressRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class ReportInstanceStatusRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class CreateDhcpOptionsRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class InternetGatewayAttachment:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Str $.state is required is aws-parameter('State');
    }

    class IpPermission:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Int $.from-port is required is aws-parameter('FromPort');
        has Str $.ip-protocol is required is aws-parameter('IpProtocol');
    ...
    class RejectVpcPeeringConnectionRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.vpc-peering-connection-id is required is aws-parameter('VpcPeeringConnectionId');
    }

    class DescribeKeyPairsResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has KeyPairList $.key-pairs is required is aws-parameter('KeyPairs');
    }

    class CreateSubnetResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Subnet $.subnet is required is aws-parameter('Subnet');
    }

    class CreateVpcResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Vpc $.vpc is required is aws-parameter('Vpc');
    }

    subset BundleTaskList of List[BundleTask];

    class EnableVgwRoutePropagationRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.route-table-id is required is aws-parameter('RouteTableId');
        has Str $.gateway-id is required is aws-parameter('GatewayId');
    }

    class ReservedInstances:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.offering-type is required is aws-parameter('OfferingType');
        has Str $.product-description is required is aws-parameter('ProductDescription');
    ...
    class DisassociateRouteTableRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.association-id is required is aws-parameter('AssociationId');
    }

    class ImportInstanceVolumeDetailItem:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class RunInstancesRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class ConfirmProductInstanceResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.owner-id is required is aws-parameter('OwnerId');
    }

    class PortRange:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Int $.to is required is aws-parameter('To');
        has Int $.from is required is aws-parameter('From');
    }

    class Region:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.endpoint is required is aws-parameter('Endpoint');
        has Str $.region-name is required is aws-parameter('RegionName');
    }

    class UnmonitorInstancesResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has InstanceMonitoringList $.instance-monitorings is required is aws-parameter('InstanceMonitorings');
    }

    class DescribeVpcAttributeRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.attribute is aws-parameter('Attribute');
    }

    class CreateNetworkInterfaceRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
    ...
    class CreateVpcRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.cidr-block is required is aws-parameter('CidrBlock');
        has Str $.instance-tenancy is aws-parameter('InstanceTenancy');
        has Bool $.dry-run is aws-parameter('DryRun');
    }

    class DhcpOptions:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.dhcp-options-id is required is aws-parameter('DhcpOptionsId');
    ...
    class CancelBundleTaskResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has BundleTask $.bundle-task is required is aws-parameter('BundleTask');
    }

    class AttachVpnGatewayRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.vpn-gateway-id is required is aws-parameter('VpnGatewayId');
    }
    ...
    class StateReason:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.code is required is aws-parameter('Code');
        has Str $.message is required is aws-parameter('Message');
    }

    class ReservedInstancesConfiguration:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.platform is required is aws-parameter('Platform');
        has Str $.instance-type is required is aws-parameter('InstanceType');
        has Str $.availability-zone is required is aws-parameter('AvailabilityZone');
        has Int $.instance-count is required is aws-parameter('InstanceCount');
    ...
    class DeleteVpcPeeringConnectionResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.return is required is aws-parameter('Return');
    }

    class CreateSnapshotRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.description is aws-parameter('Description');
        has Str $.volume-id is required is aws-parameter('VolumeId');
    }

    class DescribeClassicLinkInstancesResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has ClassicLinkInstanceList $.instances is required is aws-parameter('Instances');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class ModifyNetworkInterfaceAttributeRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has AttributeBooleanValue $.source-dest-check is aws-parameter('SourceDestCheck');
    ...
    class StartInstancesRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.additional-info is aws-parameter('AdditionalInfo');
        has InstanceIdStringList $.instance-ids is required is aws-parameter('InstanceIds');
    }
    ...
    class DescribeImagesRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class CancelConversionRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class AttachNetworkInterfaceResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.attachment-id is required is aws-parameter('AttachmentId');
    }
    ...
    class DescribeExportTasksResult:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class InternetGateway:ver<2014-10-01.0> does AWS::SDK::Shape {
        has TagList $.tags is required is aws-parameter('Tags');
    ...
    class UnassignPrivateIpAddressesRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has PrivateIpAddressStringList $.private-ip-addresses is required is aws-parameter('PrivateIpAddresses');
        has Str $.network-interface-id is required is aws-parameter('NetworkInterfaceId');
    }

    class ResetSnapshotAttributeRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.snapshot-id is required is aws-parameter('SnapshotId');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.attribute is required is aws-parameter('Attribute');
    }

    class BlockDeviceMapping:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class KeyPairInfo:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.key-fingerprint is required is aws-parameter('KeyFingerprint');
        has Str $.key-name is required is aws-parameter('KeyName');
    }
    ...
    class S3Storage:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeInstanceStatusResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has InstanceStatusList $.instance-statuses is required is aws-parameter('InstanceStatuses');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class DeleteVpcRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
    }

    class EbsInstanceBlockDevice:ver<2014-10-01.0> does AWS::SDK::Shape {
        has DateTime $.attach-time is required is aws-parameter('AttachTime');
        has Str $.status is required is aws-parameter('Status');
        has Str $.volume-id is required is aws-parameter('VolumeId');
        has Bool $.delete-on-termination is required is aws-parameter('DeleteOnTermination');
    ...
    class ImportVolumeTaskDetails:ver<2014-10-01.0> does AWS::SDK::Shape {
        has DiskImageDescription $.image is required is aws-parameter('Image');
        has DiskImageVolumeDescription $.volume is required is aws-parameter('Volume');
        has Str $.description is aws-parameter('Description');
        has Int $.bytes-converted is required is aws-parameter('BytesConverted');
    ...
    class ImportInstanceResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has ConversionTask $.conversion-task is required is aws-parameter('ConversionTask');
    }

    class InstanceCount:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.state is required is aws-parameter('State');
        has Int $.instance-count is required is aws-parameter('InstanceCount');
    }

    class UnmonitorInstancesRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has InstanceIdStringList $.instance-ids is required is aws-parameter('InstanceIds');
    }

    class CreateInstanceExportTaskResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has ExportTask $.export-task is required is aws-parameter('ExportTask');
    }

    class DescribeVpnConnectionsRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has VpnConnectionIdStringList $.vpn-connection-ids is required is aws-parameter('VpnConnectionIds');
    }

    class VolumeStatusItem:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DeleteSnapshotRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.snapshot-id is required is aws-parameter('SnapshotId');
        has Bool $.dry-run is aws-parameter('DryRun');
    }

    class NetworkAclAssociation:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.subnet-id is required is aws-parameter('SubnetId');
        has Str $.network-acl-id is required is aws-parameter('NetworkAclId');
        has Str $.network-acl-association-id is required is aws-parameter('NetworkAclAssociationId');
    }

    class DiskImageDescription:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class VgwTelemetry:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeTagsResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has TagDescriptionList $.tags is required is aws-parameter('Tags');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class DetachInternetGatewayRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.internet-gateway-id is required is aws-parameter('InternetGatewayId');
    }
    ...
    class IcmpTypeCode:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class RequestSpotLaunchSpecification:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class SpotDatafeedSubscription:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.bucket is required is aws-parameter('Bucket');
        has Str $.owner-id is required is aws-parameter('OwnerId');
    ...
    class ImageAttribute:ver<2014-10-01.0> does AWS::SDK::Shape {
        has BlockDeviceMappingList $.block-device-mappings is required is aws-parameter('BlockDeviceMappings');
    ...
    class ModifyImageAttributeRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has UserIdStringList $.user-ids is aws-parameter('UserIds');
        has Bool $.dry-run is aws-parameter('DryRun');
        has AttributeValue $.description is aws-parameter('Description');
    ...
    class DescribeVpcClassicLinkResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has VpcClassicLinkList $.vpcs is required is aws-parameter('Vpcs');
    }

    class DescribeBundleTasksRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has BundleIdStringList $.bundle-ids is required is aws-parameter('BundleIds');
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    }

    class ClassicLinkInstance:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has TagList $.tags is required is aws-parameter('Tags');
        has GroupIdentifierList $.groups is required is aws-parameter('Groups');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    ...
    class CreateVpnConnectionResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has VpnConnection $.vpn-connection is required is aws-parameter('VpnConnection');
    }

    class Tag:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.value is required is aws-parameter('Value');
        has Str $.key is required is aws-parameter('Key');
    }

    class ResetNetworkInterfaceAttributeRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.source-dest-check is aws-parameter('SourceDestCheck');
        has Str $.network-interface-id is required is aws-parameter('NetworkInterfaceId');
    }

    class DeleteSubnetRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.subnet-id is required is aws-parameter('SubnetId');
        has Bool $.dry-run is aws-parameter('DryRun');
    }

    class CreateReservedInstancesListingResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has ReservedInstancesListingList $.reserved-instances-listings is required is aws-parameter('ReservedInstancesListings');
    }

    subset InstanceIdStringList of List[Str];

    class NetworkInterface:ver<2014-10-01.0> does AWS::SDK::Shape {
        has NetworkInterfaceAssociation $.association is required is aws-parameter('Association');
        has Str $.owner-id is required is aws-parameter('OwnerId');
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Str $.subnet-id is required is aws-parameter('SubnetId');
    ...
    class DescribeVolumeStatusResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has VolumeStatusList $.volume-statuses is required is aws-parameter('VolumeStatuses');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class DescribeSpotInstanceRequestsResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has SpotInstanceRequestList $.spot-instance-requests is required is aws-parameter('SpotInstanceRequests');
    }

    class DescribePlacementGroupsRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has PlacementGroupStringList $.group-names is required is aws-parameter('GroupNames');
    }

    class DescribeNetworkInterfacesRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class DetachNetworkInterfaceRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Bool $.force is aws-parameter('Force');
        has Str $.attachment-id is required is aws-parameter('AttachmentId');
    }

    class CopySnapshotResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.snapshot-id is required is aws-parameter('SnapshotId');
    }

    subset LaunchPermissionList of List[LaunchPermission];

    class Volume:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.kms-key-id is required is aws-parameter('KmsKeyId');
        has Str $.snapshot-id is required is aws-parameter('SnapshotId');
        has Str $.volume-type is required is aws-parameter('VolumeType');
        has TagList $.tags is required is aws-parameter('Tags');
    ...
    class TerminateInstancesResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has InstanceStateChangeList $.terminating-instances is required is aws-parameter('TerminatingInstances');
    }

    class ReplaceNetworkAclAssociationRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.network-acl-id is required is aws-parameter('NetworkAclId');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.association-id is required is aws-parameter('AssociationId');
    }

    class DescribeSpotInstanceRequestsRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has SpotInstanceRequestIdList $.spot-instance-request-ids is required is aws-parameter('SpotInstanceRequestIds');
    }

    class AssociateAddressRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.public-ip is required is aws-parameter('PublicIp');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has Str $.network-interface-id is required is aws-parameter('NetworkInterfaceId');
    ...
    class PurchaseReservedInstancesOfferingRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
    ...
    class VpnConnection:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeVolumeAttributeRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.attribute is aws-parameter('Attribute');
        has Str $.volume-id is required is aws-parameter('VolumeId');
    }

    class CreateImageRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has BlockDeviceMappingRequestList $.block-device-mappings is aws-parameter('BlockDeviceMappings');
    ...
    class DisableVpcClassicLinkRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
    }
    ...
    class DeleteSecurityGroupRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.group-id is required is aws-parameter('GroupId');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has Str $.group-name is required is aws-parameter('GroupName');
    }

    class AcceptVpcPeeringConnectionResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has VpcPeeringConnection $.vpc-peering-connection is required is aws-parameter('VpcPeeringConnection');
    }

    class CreateVpnConnectionRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.vpn-gateway-id is required is aws-parameter('VpnGatewayId');
        has Str $.customer-gateway-id is required is aws-parameter('CustomerGatewayId');
    ...
    class MonitorInstancesRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has InstanceIdStringList $.instance-ids is required is aws-parameter('InstanceIds');
    }

    class Vpc:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.dhcp-options-id is required is aws-parameter('DhcpOptionsId');
        has Str $.cidr-block is required is aws-parameter('CidrBlock');
        has Bool $.is-default is required is aws-parameter('IsDefault');
        has Str $.instance-tenancy is required is aws-parameter('InstanceTenancy');
    ...
    class DescribeRegionsResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has RegionList $.regions is required is aws-parameter('Regions');
    }

    class DescribeInstancesRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has Str $.next-token is required is aws-parameter('NextToken');
    ...
    class AssociateAddressResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.association-id is required is aws-parameter('AssociationId');
    }

    class AllocateAddressRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.domain is required is aws-parameter('Domain');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    }

    class CancelSpotInstanceRequestsResult:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DisassociateAddressRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.public-ip is required is aws-parameter('PublicIp');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has Str $.association-id is required is aws-parameter('AssociationId');
    }
    ...
    class DescribeInternetGatewaysResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has InternetGatewayList $.internet-gateways is required is aws-parameter('InternetGateways');
    }

    class DeleteVpnConnectionRouteRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.destination-cidr-block is required is aws-parameter('DestinationCidrBlock');
        has Str $.vpn-connection-id is required is aws-parameter('VpnConnectionId');
    }

    class ConversionTask:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.conversion-task-id is required is aws-parameter('ConversionTaskId');
    ...
    class ExportToS3Task:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.container-format is required is aws-parameter('ContainerFormat');
    ...
    class DescribeVolumeStatusRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has VolumeIdStringList $.volume-ids is required is aws-parameter('VolumeIds');
    ...
    class DiskImageDetail:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.import-manifest-url is required is aws-parameter('ImportManifestUrl');
        has Str $.format is required is aws-parameter('Format');
    ...
    class DescribeSpotPriceHistoryResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
        has SpotPriceHistoryList $.spot-price-history is required is aws-parameter('SpotPriceHistory');
    }

    class InstanceState:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.name is required is aws-parameter('Name');
        has Int $.code is required is aws-parameter('Code');
    }

    class SpotPlacement:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.availability-zone is required is aws-parameter('AvailabilityZone');
        has Str $.group-name is required is aws-parameter('GroupName');
    }

    class DescribeNetworkAclsResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has NetworkAclList $.network-acls is required is aws-parameter('NetworkAcls');
    }

    class AttributeValue:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.value is required is aws-parameter('Value');
    }

    class CreateVpcPeeringConnectionResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has VpcPeeringConnection $.vpc-peering-connection is required is aws-parameter('VpcPeeringConnection');
    }

    subset InstanceCountList of List[InstanceCount];

    class DescribeReservedInstancesResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has ReservedInstancesList $.reserved-instances is required is aws-parameter('ReservedInstances');
    }

    class AccountAttribute:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeSecurityGroupsRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class SpotInstanceStateFault:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.code is required is aws-parameter('Code');
        has Str $.message is required is aws-parameter('Message');
    }
    ...
    class StopInstancesResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has InstanceStateChangeList $.stopping-instances is required is aws-parameter('StoppingInstances');
    }

    class ReleaseAddressRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.public-ip is required is aws-parameter('PublicIp');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has Str $.allocation-id is required is aws-parameter('AllocationId');
    }

    class AllocateAddressResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.domain is required is aws-parameter('Domain');
        has Str $.public-ip is required is aws-parameter('PublicIp');
        has Str $.allocation-id is required is aws-parameter('AllocationId');
    }

    class CreateSecurityGroupRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DisableVpcClassicLinkResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.return is required is aws-parameter('Return');
    }
    ...
    class DeleteTagsRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has ResourceIdList $.resources is required is aws-parameter('Resources');
        has Bool $.dry-run is aws-parameter('DryRun');
        has TagList $.tags is aws-parameter('Tags');
    }

    class CopyImageRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.source-region is required is aws-parameter('SourceRegion');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.client-token is aws-parameter('ClientToken');
        has Str $.description is aws-parameter('Description');
    ...
    class CreateInternetGatewayRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is required is aws-parameter('DryRun');
    }

    class EnableVpcClassicLinkRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
    }

    class Storage:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeSpotPriceHistoryRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has FilterList $.filters is required is aws-parameter('Filters');
    ...
    class VpnConnectionOptions:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.static-routes-only is required is aws-parameter('StaticRoutesOnly');
    }

    class CreateReservedInstancesListingRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.client-token is required is aws-parameter('ClientToken');
        has Str $.reserved-instances-id is required is aws-parameter('ReservedInstancesId');
    ...
    class LaunchSpecification:ver<2014-10-01.0> does AWS::SDK::Shape {
        has BlockDeviceMappingList $.block-device-mappings is required is aws-parameter('BlockDeviceMappings');
        has SpotPlacement $.placement is required is aws-parameter('Placement');
        has Str $.subnet-id is required is aws-parameter('SubnetId');
        has Str $.ramdisk-id is required is aws-parameter('RamdiskId');
    ...
    class ReplaceRouteTableAssociationResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.new-association-id is required is aws-parameter('NewAssociationId');
    }

    class DeleteVpnConnectionRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.vpn-connection-id is required is aws-parameter('VpnConnectionId');
    }

    class CancelSpotInstanceRequestsRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has SpotInstanceRequestIdList $.spot-instance-request-ids is required is aws-parameter('SpotInstanceRequestIds');
    }

    class CreateInternetGatewayResult:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class PurchaseReservedInstancesOfferingResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.reserved-instances-id is required is aws-parameter('ReservedInstancesId');
    }

    class DescribeSpotDatafeedSubscriptionRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is required is aws-parameter('DryRun');
    }

    subset BundleIdStringList of List[Str];

    class CreateNetworkInterfaceResult:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeVpcPeeringConnectionsRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class DescribeConversionTasksResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has DescribeConversionTaskList $.conversion-tasks is required is aws-parameter('ConversionTasks');
    }

    class CreateDhcpOptionsResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has DhcpOptions $.dhcp-options is required is aws-parameter('DhcpOptions');
    }

    subset IpRangeList of List[IpRange];

    class BundleInstanceRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Storage $.storage is required is aws-parameter('Storage');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class CreateNetworkAclEntryRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.cidr-block is required is aws-parameter('CidrBlock');
        has Bool $.egress is required is aws-parameter('Egress');
        has Str $.network-acl-id is required is aws-parameter('NetworkAclId');
        has Bool $.dry-run is aws-parameter('DryRun');
    ...
    class DescribeVpnGatewaysRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class VolumeAttachment:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.device is required is aws-parameter('Device');
        has DateTime $.attach-time is required is aws-parameter('AttachTime');
        has Str $.state is required is aws-parameter('State');
        has Str $.volume-id is required is aws-parameter('VolumeId');
    ...
    class ReservedInstancesOffering:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class ReplaceRouteRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.route-table-id is required is aws-parameter('RouteTableId');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.gateway-id is aws-parameter('GatewayId');
        has Str $.network-interface-id is aws-parameter('NetworkInterfaceId');
    ...
    class InstanceNetworkInterfaceAssociation:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.public-ip is required is aws-parameter('PublicIp');
        has Str $.ip-owner-id is required is aws-parameter('IpOwnerId');
        has Str $.public-dns-name is required is aws-parameter('PublicDnsName');
    }

    class CreateCustomerGatewayResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has CustomerGateway $.customer-gateway is required is aws-parameter('CustomerGateway');
    }

    class GetPasswordDataRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class Subnet:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class CreateVpnConnectionRouteRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.destination-cidr-block is required is aws-parameter('DestinationCidrBlock');
        has Str $.vpn-connection-id is required is aws-parameter('VpnConnectionId');
    }

    class ImportVolumeResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has ConversionTask $.conversion-task is required is aws-parameter('ConversionTask');
    }

    subset NetworkAclEntryList of List[NetworkAclEntry];

    class DescribeVolumeAttributeResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has AttributeBooleanValue $.auto-enable-io is required is aws-parameter('AutoEnableIO');
        has Str $.volume-id is required is aws-parameter('VolumeId');
        has ProductCodeList $.product-codes is required is aws-parameter('ProductCodes');
    }

    class DescribeSpotDatafeedSubscriptionResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has SpotDatafeedSubscription $.spot-datafeed-subscription is required is aws-parameter('SpotDatafeedSubscription');
    }

    class CreateSpotDatafeedSubscriptionResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has SpotDatafeedSubscription $.spot-datafeed-subscription is required is aws-parameter('SpotDatafeedSubscription');
    }

    class LaunchPermissionModifications:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class SpotInstanceRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.product-description is required is aws-parameter('ProductDescription');
    ...
    class DescribeReservedInstancesModificationsRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Str $.next-token is required is aws-parameter('NextToken');
    ...
    class DescribeConversionTasksRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has ConversionIdStringList $.conversion-task-ids is required is aws-parameter('ConversionTaskIds');
    }

    class ConfirmProductInstanceRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.product-code is required is aws-parameter('ProductCode');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class InstanceStatusSummary:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.status is required is aws-parameter('Status');
    ...
    class AuthorizeSecurityGroupEgressRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has IpPermissionList $.ip-permissions is aws-parameter('IpPermissions');
        has Str $.cidr-ip is aws-parameter('CidrIp');
        has Str $.source-security-group-owner-id is aws-parameter('SourceSecurityGroupOwnerId');
        has Str $.group-id is required is aws-parameter('GroupId');
    ...
    class InstanceStatus:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeRegionsRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has RegionNameStringList $.region-names is required is aws-parameter('RegionNames');
    }

    class IamInstanceProfile:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.arn is required is aws-parameter('Arn');
        has Str $.id is required is aws-parameter('Id');
    }

    class SecurityGroup:ver<2014-10-01.0> does AWS::SDK::Shape {
        has IpPermissionList $.ip-permissions is required is aws-parameter('IpPermissions');
        has Str $.group-id is required is aws-parameter('GroupId');
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Str $.owner-id is required is aws-parameter('OwnerId');
    ...
    class RegisterImageRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has BlockDeviceMappingRequestList $.block-device-mappings is aws-parameter('BlockDeviceMappings');
        has Bool $.dry-run is aws-parameter('DryRun');
    ...
    class DeleteNetworkAclRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.network-acl-id is required is aws-parameter('NetworkAclId');
        has Bool $.dry-run is aws-parameter('DryRun');
    }

    class VolumeStatusDetails:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.name is required is aws-parameter('Name');
        has Str $.status is required is aws-parameter('Status');
    }

    class DescribeAccountAttributesResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has AccountAttributeList $.account-attributes is required is aws-parameter('AccountAttributes');
    }

    class DescribeAccountAttributesRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has AccountAttributeNameStringList $.attribute-names is required is aws-parameter('AttributeNames');
    }

    class Address:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.domain is required is aws-parameter('Domain');
    ...
    class AssociateDhcpOptionsRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.dhcp-options-id is required is aws-parameter('DhcpOptionsId');
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
    }

    class CreateImageResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.image-id is required is aws-parameter('ImageId');
    }

    class CreateRouteTableRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
    }

    class DescribeVpcPeeringConnectionsResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has VpcPeeringConnectionList $.vpc-peering-connections is required is aws-parameter('VpcPeeringConnections');
    }

    class InstanceExportDetails:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.instance-id is required is aws-parameter('InstanceId');
    ...
    class ReservedInstancesListing:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.client-token is required is aws-parameter('ClientToken');
    ...
    class ReplaceNetworkAclEntryRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.cidr-block is required is aws-parameter('CidrBlock');
        has Bool $.egress is required is aws-parameter('Egress');
        has Str $.network-acl-id is required is aws-parameter('NetworkAclId');
        has Bool $.dry-run is aws-parameter('DryRun');
    ...
    class DescribeDhcpOptionsRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has DhcpOptionsIdStringList $.dhcp-options-ids is required is aws-parameter('DhcpOptionsIds');
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    }

    class CreateSpotDatafeedSubscriptionRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.bucket is required is aws-parameter('Bucket');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.prefix is aws-parameter('Prefix');
    }

    class RebootInstancesRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has InstanceIdStringList $.instance-ids is required is aws-parameter('InstanceIds');
    }
    ...
    class DescribeInstancesResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
        has ReservationList $.reservations is required is aws-parameter('Reservations');
    }

    class BundleTask:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Storage $.storage is required is aws-parameter('Storage');
    ...
    class AssignPrivateIpAddressesRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Int $.secondary-private-ip-address-count is aws-parameter('SecondaryPrivateIpAddressCount');
    ...
    class ImportInstanceRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeClassicLinkInstancesRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Int $.max-results is required is aws-parameter('MaxResults');
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
        has Str $.next-token is required is aws-parameter('NextToken');
    ...
    class DeleteVolumeRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.volume-id is required is aws-parameter('VolumeId');
    }

    class DeletePlacementGroupRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.group-name is required is aws-parameter('GroupName');
    }

    class VpnConnectionOptionsSpecification:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.static-routes-only is required is aws-parameter('StaticRoutesOnly');
    }

    class AvailabilityZone:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class ExportTask:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DescribeCustomerGatewaysRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Bool $.dry-run is required is aws-parameter('DryRun');
    ...
    class Image:ver<2014-10-01.0> does AWS::SDK::Shape {
        has BlockDeviceMappingList $.block-device-mappings is required is aws-parameter('BlockDeviceMappings');
        has Str $.root-device-type is required is aws-parameter('RootDeviceType');
    ...
    class KeyPair:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.key-material is required is aws-parameter('KeyMaterial');
        has Str $.key-fingerprint is required is aws-parameter('KeyFingerprint');
        has Str $.key-name is required is aws-parameter('KeyName');
    }

    class VolumeStatusEvent:ver<2014-10-01.0> does AWS::SDK::Shape {
        has DateTime $.not-after is required is aws-parameter('NotAfter');
        has Str $.description is required is aws-parameter('Description');
        has DateTime $.not-before is required is aws-parameter('NotBefore');
        has Str $.event-id is required is aws-parameter('EventId');
    ...
    class SpotInstanceStatus:ver<2014-10-01.0> does AWS::SDK::Shape {
        has DateTime $.update-time is required is aws-parameter('UpdateTime');
        has Str $.code is required is aws-parameter('Code');
        has Str $.message is required is aws-parameter('Message');
    }
    ...
    class DescribeNetworkInterfaceAttributeResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has AttributeBooleanValue $.source-dest-check is required is aws-parameter('SourceDestCheck');
        has AttributeValue $.description is required is aws-parameter('Description');
        has NetworkInterfaceAttachment $.attachment is required is aws-parameter('Attachment');
        has GroupIdentifierList $.groups is required is aws-parameter('Groups');
    ...
    class GetConsoleOutputResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.output is required is aws-parameter('Output');
        has DateTime $.timestamp is required is aws-parameter('Timestamp');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }

    class DescribeVpcsResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has VpcList $.vpcs is required is aws-parameter('Vpcs');
    }

    class GroupIdentifier:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.group-id is required is aws-parameter('GroupId');
        has Str $.group-name is required is aws-parameter('GroupName');
    }

    class IamInstanceProfileSpecification:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.arn is required is aws-parameter('Arn');
        has Str $.name is required is aws-parameter('Name');
    }

    class InstanceNetworkInterface:ver<2014-10-01.0> does AWS::SDK::Shape {
        has InstanceNetworkInterfaceAssociation $.association is required is aws-parameter('Association');
        has Str $.owner-id is required is aws-parameter('OwnerId');
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Str $.subnet-id is required is aws-parameter('SubnetId');
    ...
    class PriceSchedule:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Num $.price is required is aws-parameter('Price');
    ...
    class DescribeReservedInstancesListingsResult:ver<2014-10-01.0> does AWS::SDK::Shape {
        has ReservedInstancesListingList $.reserved-instances-listings is required is aws-parameter('ReservedInstancesListings');
    }

    class AttributeBooleanValue:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class DetachClassicLinkVpcRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.instance-id is required is aws-parameter('InstanceId');
    }
    ...
    class ReplaceRouteTableAssociationRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.route-table-id is required is aws-parameter('RouteTableId');
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.association-id is required is aws-parameter('AssociationId');
    }

    class DescribeReservedInstancesListingsRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has FilterList $.filters is required is aws-parameter('Filters');
        has Str $.reserved-instances-listing-id is required is aws-parameter('ReservedInstancesListingId');
        has Str $.reserved-instances-id is required is aws-parameter('ReservedInstancesId');
    }
    ...
    class RouteTableAssociation:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.route-table-id is required is aws-parameter('RouteTableId');
        has Str $.subnet-id is required is aws-parameter('SubnetId');
    ...
    class CreateVolumeRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class ModifyVpcAttributeRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
    ...
    class Monitoring:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Str $.state is required is aws-parameter('State');
    }

    class CancelBundleTaskRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.bundle-id is required is aws-parameter('BundleId');
    }

    class CreateKeyPairRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.key-name is required is aws-parameter('KeyName');
    }

    class DeleteInternetGatewayRequest:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.dry-run is aws-parameter('DryRun');
        has Str $.internet-gateway-id is required is aws-parameter('InternetGatewayId');
    }

    class NetworkInterfaceAttachmentChanges:ver<2014-10-01.0> does AWS::SDK::Shape {
        has Bool $.delete-on-termination is required is aws-parameter('DeleteOnTermination');
        has Str $.attachment-id is required is aws-parameter('AttachmentId');
    }
