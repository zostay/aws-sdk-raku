...
class AWS::SDK::Service::Route53Domains:ver<2014-05-15.0> does AWS::SDK::Service {
    ...
    class ResendContactReachabilityEmailRequest:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('domainName');
    }

    class RegisterDomainRequest:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('DomainName');
    ...
    class GetOperationDetailResponse:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('DomainName');
    ...
    class OperationSummary:ver<2014-05-15.0> does AWS::SDK::Shape {
        has DateTime $.submitted-date is required is aws-parameter('SubmittedDate');
        has Str $.operation-id is required is aws-parameter('OperationId');
        has Str $.type is required is aws-parameter('Type');
        has Str $.status is required is aws-parameter('Status');
    ...
    class DisableDomainAutoRenewRequest:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('DomainName');
    }

    class UpdateTagsForDomainResponse:ver<2014-05-15.0> does AWS::SDK::Shape {
    }

    class ListOperationsResponse:ver<2014-05-15.0> does AWS::SDK::Shape {
    ...
    class ContactDetail:ver<2014-05-15.0> does AWS::SDK::Shape {
    ...
    class EnableDomainTransferLockRequest:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('DomainName');
    }

    class UpdateDomainContactResponse:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.operation-id is required is aws-parameter('OperationId');
    }

    class Nameserver:ver<2014-05-15.0> does AWS::SDK::Shape {
    ...
    class DeleteTagsForDomainRequest:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('DomainName');
        has TagKeyList $.tags-to-delete is required is aws-parameter('TagsToDelete');
    }

    class DisableDomainAutoRenewResponse:ver<2014-05-15.0> does AWS::SDK::Shape {
    }

    class DomainLimitExceeded:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('message');
    }

    class GetContactReachabilityStatusRequest:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('domainName');
    }

    subset TagList of List[Tag];

    class ListDomainsResponse:ver<2014-05-15.0> does AWS::SDK::Shape {
        has DomainSummaryList $.domains is required is aws-parameter('Domains');
        has Str $.next-page-marker is aws-parameter('NextPageMarker');
    }

    class GetDomainSuggestionsRequest:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('DomainName');
    ...
    class DomainSummary:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('DomainName');
    ...
    class TransferDomainRequest:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('DomainName');
        has ContactDetail $.registrant-contact is required is aws-parameter('RegistrantContact');
        has ContactDetail $.admin-contact is required is aws-parameter('AdminContact');
        has Bool $.auto-renew is aws-parameter('AutoRenew');
    ...
    class RegisterDomainResponse:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.operation-id is required is aws-parameter('OperationId');
    }

    class OperationLimitExceeded:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('message');
    }

    class ExtraParam:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.name is required is aws-parameter('Name');
        has Str $.value is required is aws-parameter('Value');
    }

    class GetDomainDetailRequest:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('DomainName');
    }

    class UnsupportedTLD:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('message');
    }

    class TLDRulesViolation:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('message');
    }

    class GetOperationDetailRequest:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.operation-id is required is aws-parameter('OperationId');
    }

    class DisableDomainTransferLockRequest:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('DomainName');
    }

    class EnableDomainAutoRenewRequest:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('DomainName');
    }

    class UpdateDomainNameserversRequest:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('DomainName');
        has NameserverList $.nameservers is required is aws-parameter('Nameservers');
        has Str $.fi-auth-key is aws-parameter('FIAuthKey');
    }

    class ResendContactReachabilityEmailResponse:ver<2014-05-15.0> does AWS::SDK::Shape {
    ...
    class RenewDomainResponse:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.operation-id is required is aws-parameter('OperationId');
    }

    class DuplicateRequest:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('message');
    }

    class EnableDomainTransferLockResponse:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.operation-id is required is aws-parameter('OperationId');
    }

    class UpdateTagsForDomainRequest:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('DomainName');
        has TagList $.tags-to-update is aws-parameter('TagsToUpdate');
    }

    class BillingRecord:ver<2014-05-15.0> does AWS::SDK::Shape {
    ...
    class RetrieveDomainAuthCodeRequest:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('DomainName');
    }

    class UpdateDomainContactPrivacyRequest:ver<2014-05-15.0> does AWS::SDK::Shape {
    ...
    class RenewDomainRequest:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('DomainName');
    ...
    class ListOperationsRequest:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Int $.max-items is required is aws-parameter('MaxItems');
        has Str $.marker is required is aws-parameter('Marker');
    }

    class ListDomainsRequest:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Int $.max-items is required is aws-parameter('MaxItems');
        has Str $.marker is required is aws-parameter('Marker');
    }

    class CheckDomainAvailabilityResponse:ver<2014-05-15.0> does AWS::SDK::Shape {
    ...
    class ViewBillingRequest:ver<2014-05-15.0> does AWS::SDK::Shape {
    ...
    class RetrieveDomainAuthCodeResponse:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.auth-code is required is aws-parameter('AuthCode');
    }

    subset OperationSummaryList of List[OperationSummary];

    class ListTagsForDomainResponse:ver<2014-05-15.0> does AWS::SDK::Shape {
        has TagList $.tag-list is required is aws-parameter('TagList');
    }

    class GetDomainDetailResponse:ver<2014-05-15.0> does AWS::SDK::Shape {
    ...
    class CheckDomainAvailabilityRequest:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('DomainName');
        has Str $.idn-lang-code is aws-parameter('IdnLangCode');
    }

    class DomainSuggestion:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('DomainName');
        has Str $.availability is required is aws-parameter('Availability');
    }

    class EnableDomainAutoRenewResponse:ver<2014-05-15.0> does AWS::SDK::Shape {
    }

    class GetContactReachabilityStatusResponse:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.status is required is aws-parameter('status');
        has Str $.domain-name is required is aws-parameter('domainName');
    }

    class UpdateDomainNameserversResponse:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.operation-id is required is aws-parameter('OperationId');
    }

    class TransferDomainResponse:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.operation-id is required is aws-parameter('OperationId');
    }

    class GetDomainSuggestionsResponse:ver<2014-05-15.0> does AWS::SDK::Shape {
    ...
    class UpdateDomainContactRequest:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('DomainName');
    ...
    class ListTagsForDomainRequest:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('DomainName');
    }

    class DeleteTagsForDomainResponse:ver<2014-05-15.0> does AWS::SDK::Shape {
    }

    class DisableDomainTransferLockResponse:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.operation-id is required is aws-parameter('OperationId');
    }

    class ViewBillingResponse:ver<2014-05-15.0> does AWS::SDK::Shape {
    ...
    class UpdateDomainContactPrivacyResponse:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.operation-id is required is aws-parameter('OperationId');
    }

    class Tag:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.value is required is aws-parameter('Value');
    ...
    class InvalidInput:ver<2014-05-15.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('message');
    }
