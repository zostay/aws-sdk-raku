...
class AWS::SDK::Service::SES:ver<2010-12-01.0> does AWS::SDK::Service {
    ...
    class GetIdentityPoliciesRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class S3Action:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class DescribeReceiptRuleSetResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class ListIdentitiesResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
        has IdentityList $.identities is required is aws-parameter('Identities');
        has Str $.next-token is aws-parameter('NextToken');
    }

    class SetActiveReceiptRuleSetRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.rule-set-name is required is aws-parameter('RuleSetName');
    }

    class DeleteReceiptFilterResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class CreateReceiptFilterResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class ConfigurationSetDoesNotExistException:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.configuration-set-name is required is aws-parameter('ConfigurationSetName');
    }

    class MailFromDomainNotVerifiedException:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class SNSDestination:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.topic-arn is required is aws-parameter('TopicARN');
    }

    class GetIdentityMailFromDomainAttributesResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
        has MailFromDomainAttributes $.mail-from-domain-attributes is required is aws-parameter('MailFromDomainAttributes');
    }

    class CannotDeleteException:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.name is required is aws-parameter('Name');
    }

    class ListVerifiedEmailAddressesResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
        has AddressList $.verified-email-addresses is required is aws-parameter('VerifiedEmailAddresses');
    }

    class ReorderReceiptRuleSetResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class LambdaAction:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class BounceAction:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class DeleteIdentityRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.identity is required is aws-parameter('Identity');
    }

    class DeleteConfigurationSetEventDestinationRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.configuration-set-name is required is aws-parameter('ConfigurationSetName');
        has Str $.event-destination-name is required is aws-parameter('EventDestinationName');
    }

    class InvalidCloudWatchDestinationException:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.configuration-set-name is required is aws-parameter('ConfigurationSetName');
        has Str $.event-destination-name is required is aws-parameter('EventDestinationName');
    }

    class SetIdentityFeedbackForwardingEnabledRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.identity is required is aws-parameter('Identity');
    ...
    class CreateReceiptRuleResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class CreateReceiptRuleRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.rule-set-name is required is aws-parameter('RuleSetName');
        has Str $.after is aws-parameter('After');
        has ReceiptRule $.rule is required is aws-parameter('Rule');
    }

    class SendRawEmailRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class SetIdentityMailFromDomainRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.identity is required is aws-parameter('Identity');
    ...
    class InvalidFirehoseDestinationException:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.configuration-set-name is required is aws-parameter('ConfigurationSetName');
        has Str $.event-destination-name is required is aws-parameter('EventDestinationName');
    }

    class PutIdentityPolicyRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.identity is required is aws-parameter('Identity');
        has Str $.policy-name is required is aws-parameter('PolicyName');
        has Str $.policy is required is aws-parameter('Policy');
    }

    class DeleteVerifiedEmailAddressRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.email-address is required is aws-parameter('EmailAddress');
    }

    class DeleteReceiptRuleSetResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class SendDataPoint:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class UpdateReceiptRuleResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class ListReceiptRuleSetsResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
        has ReceiptRuleSetsLists $.rule-sets is required is aws-parameter('RuleSets');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class UpdateConfigurationSetTrackingOptionsResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class UpdateReceiptRuleRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.rule-set-name is required is aws-parameter('RuleSetName');
        has ReceiptRule $.rule is required is aws-parameter('Rule');
    }

    class DeleteReceiptRuleSetRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.rule-set-name is required is aws-parameter('RuleSetName');
    }

    class TrackingOptionsAlreadyExistsException:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.configuration-set-name is required is aws-parameter('ConfigurationSetName');
    }

    class GetIdentityMailFromDomainAttributesRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has IdentityList $.identities is required is aws-parameter('Identities');
    }

    class DeleteConfigurationSetTrackingOptionsRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.configuration-set-name is required is aws-parameter('ConfigurationSetName');
    }

    class ListIdentityPoliciesRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.identity is required is aws-parameter('Identity');
    }

    class VerifyEmailAddressRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.email-address is required is aws-parameter('EmailAddress');
    }

    class ListReceiptFiltersRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class RuleSetDoesNotExistException:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.name is required is aws-parameter('Name');
    }

    class LimitExceededException:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class SetIdentityHeadersInNotificationsEnabledRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.identity is required is aws-parameter('Identity');
    ...
    class CreateReceiptFilterRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class Content:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.data is required is aws-parameter('Data');
        has Str $.charset is aws-parameter('Charset');
    }

    class VerifyDomainDkimRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.domain is required is aws-parameter('Domain');
    }

    class VerifyDomainDkimResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
        has VerificationTokenList $.dkim-tokens is required is aws-parameter('DkimTokens');
    }

    class AddHeaderAction:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.header-name is required is aws-parameter('HeaderName');
        has Str $.header-value is required is aws-parameter('HeaderValue');
    }

    class AlreadyExistsException:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.name is required is aws-parameter('Name');
    }

    class CloneReceiptRuleSetResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class SetIdentityFeedbackForwardingEnabledResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    subset VerificationTokenList of List[Str];

    class IdentityDkimAttributes:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class ListReceiptFiltersResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class ListIdentityPoliciesResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
        has PolicyNameList $.policy-names is required is aws-parameter('PolicyNames');
    }

    class GetSendQuotaResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class DescribeReceiptRuleResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
        has ReceiptRule $.rule is required is aws-parameter('Rule');
    }

    class CloudWatchDimensionConfiguration:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class VerifyDomainIdentityRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.domain is required is aws-parameter('Domain');
    }

    class GetIdentityVerificationAttributesResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
        has VerificationAttributes $.verification-attributes is required is aws-parameter('VerificationAttributes');
    }

    class CreateConfigurationSetTrackingOptionsResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class IdentityNotificationAttributes:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class MessageDsn:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class SetActiveReceiptRuleSetResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class CloudWatchDestination:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class CreateReceiptRuleSetRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.rule-set-name is required is aws-parameter('RuleSetName');
    }

    class MessageRejected:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class UpdateConfigurationSetEventDestinationRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has EventDestination $.event-destination is required is aws-parameter('EventDestination');
        has Str $.configuration-set-name is required is aws-parameter('ConfigurationSetName');
    }

    class KinesisFirehoseDestination:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class GetIdentityDkimAttributesResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
        has DkimAttributes $.dkim-attributes is required is aws-parameter('DkimAttributes');
    }

    class DeleteConfigurationSetEventDestinationResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    subset EventDestinations of List[EventDestination];

    class EventDestination:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class StopAction:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.scope is required is aws-parameter('Scope');
        has Str $.topic-arn is aws-parameter('TopicArn');
    }

    class DescribeActiveReceiptRuleSetRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class ListConfigurationSetsRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Int $.max-items is required is aws-parameter('MaxItems');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class ReceiptFilter:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.name is required is aws-parameter('Name');
    ...
    class SetIdentityMailFromDomainResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class GetIdentityVerificationAttributesRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has IdentityList $.identities is required is aws-parameter('Identities');
    }

    class CreateConfigurationSetTrackingOptionsRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has TrackingOptions $.tracking-options is required is aws-parameter('TrackingOptions');
        has Str $.configuration-set-name is required is aws-parameter('ConfigurationSetName');
    }

    class CreateConfigurationSetRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has ConfigurationSet $.configuration-set is required is aws-parameter('ConfigurationSet');
    }

    class SetIdentityDkimEnabledResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class GetIdentityNotificationAttributesRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has IdentityList $.identities is required is aws-parameter('Identities');
    }

    class DescribeReceiptRuleRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.rule-set-name is required is aws-parameter('RuleSetName');
        has Str $.rule-name is required is aws-parameter('RuleName');
    }

    class InvalidConfigurationSetException:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class SendBounceResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.message-id is required is aws-parameter('MessageId');
    }

    class EventDestinationAlreadyExistsException:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.configuration-set-name is required is aws-parameter('ConfigurationSetName');
        has Str $.event-destination-name is required is aws-parameter('EventDestinationName');
    }

    class DescribeReceiptRuleSetRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.rule-set-name is required is aws-parameter('RuleSetName');
    }

    class InvalidTrackingOptionsException:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class RuleDoesNotExistException:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.name is required is aws-parameter('Name');
    }

    subset ExtensionFieldList of List[ExtensionField];

    class DeleteReceiptRuleResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class DeleteReceiptRuleRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.rule-set-name is required is aws-parameter('RuleSetName');
        has Str $.rule-name is required is aws-parameter('RuleName');
    }

    class DeleteIdentityPolicyResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class VerifyEmailIdentityResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class IdentityMailFromDomainAttributes:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class BouncedRecipientInfo:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class ReceiptAction:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class DeleteConfigurationSetTrackingOptionsResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    subset BouncedRecipientInfoList of List[BouncedRecipientInfo];

    class RecipientDsnFields:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class VerifyEmailIdentityRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.email-address is required is aws-parameter('EmailAddress');
    }

    class SetReceiptRulePositionRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.rule-set-name is required is aws-parameter('RuleSetName');
        has Str $.after is aws-parameter('After');
        has Str $.rule-name is required is aws-parameter('RuleName');
    }

    class InvalidSNSDestinationException:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.configuration-set-name is required is aws-parameter('ConfigurationSetName');
        has Str $.event-destination-name is required is aws-parameter('EventDestinationName');
    }

    class SendRawEmailResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.message-id is required is aws-parameter('MessageId');
    }

    class SetIdentityDkimEnabledRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.identity is required is aws-parameter('Identity');
        has Bool $.dkim-enabled is required is aws-parameter('DkimEnabled');
    }

    class SetIdentityHeadersInNotificationsEnabledResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    subset ReceiptRulesList of List[ReceiptRule];

    class GetSendStatisticsResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
        has SendDataPointList $.send-data-points is required is aws-parameter('SendDataPoints');
    }

    class CreateReceiptRuleSetResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class IdentityVerificationAttributes:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class ListIdentitiesRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Int $.max-items is required is aws-parameter('MaxItems');
        has Str $.next-token is required is aws-parameter('NextToken');
        has Str $.identity-type is required is aws-parameter('IdentityType');
    }

    class ReceiptIpFilter:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.cidr is required is aws-parameter('Cidr');
        has Str $.policy is required is aws-parameter('Policy');
    }

    class SetIdentityNotificationTopicResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class GetIdentityNotificationAttributesResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
        has NotificationAttributes $.notification-attributes is required is aws-parameter('NotificationAttributes');
    }

    class Body:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class UpdateConfigurationSetEventDestinationResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class VerifyDomainIdentityResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.verification-token is required is aws-parameter('VerificationToken');
    }

    class ExtensionField:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.name is required is aws-parameter('Name');
        has Str $.value is required is aws-parameter('Value');
    }

    class DescribeConfigurationSetResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
        has EventDestinations $.event-destinations is required is aws-parameter('EventDestinations');
        has TrackingOptions $.tracking-options is required is aws-parameter('TrackingOptions');
        has ConfigurationSet $.configuration-set is required is aws-parameter('ConfigurationSet');
    }

    class DescribeActiveReceiptRuleSetResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
        has ReceiptRuleSetMetadata $.metadata is required is aws-parameter('Metadata');
        has ReceiptRulesList $.rules is required is aws-parameter('Rules');
    }

    class DeleteConfigurationSetRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.configuration-set-name is required is aws-parameter('ConfigurationSetName');
    }

    class SendEmailResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.message-id is required is aws-parameter('MessageId');
    }

    class Destination:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class ConfigurationSet:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.name is required is aws-parameter('Name');
    }

    class SendBounceRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class TrackingOptions:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class DeleteIdentityResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class CloneReceiptRuleSetRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.rule-set-name is required is aws-parameter('RuleSetName');
        has Str $.original-rule-set-name is required is aws-parameter('OriginalRuleSetName');
    }

    class InvalidLambdaFunctionException:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.function-arn is required is aws-parameter('FunctionArn');
    }

    subset PolicyNameList of List[Str];

    class PutIdentityPolicyResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class DeleteConfigurationSetResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class InvalidS3ConfigurationException:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.bucket is required is aws-parameter('Bucket');
    }

    class SendEmailRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.return-path-arn is aws-parameter('ReturnPathArn');
    ...
    class UpdateConfigurationSetTrackingOptionsRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has TrackingOptions $.tracking-options is required is aws-parameter('TrackingOptions');
        has Str $.configuration-set-name is required is aws-parameter('ConfigurationSetName');
    }

    class GetIdentityDkimAttributesRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has IdentityList $.identities is required is aws-parameter('Identities');
    }

    class GetIdentityPoliciesResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
        has PolicyMap $.policies is required is aws-parameter('Policies');
    }

    subset EventTypes of List[Str];

    class DescribeConfigurationSetRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.configuration-set-name is required is aws-parameter('ConfigurationSetName');
        has ConfigurationSetAttributeList $.configuration-set-attribute-names is aws-parameter('ConfigurationSetAttributeNames');
    }

    class ConfigurationSetAlreadyExistsException:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.configuration-set-name is required is aws-parameter('ConfigurationSetName');
    }

    class CreateConfigurationSetResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class ListConfigurationSetsResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
        has ConfigurationSets $.configuration-sets is required is aws-parameter('ConfigurationSets');
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    class ListReceiptRuleSetsRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.next-token is required is aws-parameter('NextToken');
    }

    subset RecipientsList of List[Str];

    class SetReceiptRulePositionResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class EventDestinationDoesNotExistException:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.configuration-set-name is required is aws-parameter('ConfigurationSetName');
        has Str $.event-destination-name is required is aws-parameter('EventDestinationName');
    }
    ...
    class CreateConfigurationSetEventDestinationRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has EventDestination $.event-destination is required is aws-parameter('EventDestination');
        has Str $.configuration-set-name is required is aws-parameter('ConfigurationSetName');
    }

    class CreateConfigurationSetEventDestinationResponse:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class InvalidSnsTopicException:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.topic is required is aws-parameter('Topic');
    }

    class DeleteIdentityPolicyRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.identity is required is aws-parameter('Identity');
        has Str $.policy-name is required is aws-parameter('PolicyName');
    }
    ...
    class ReceiptRuleSetMetadata:ver<2010-12-01.0> does AWS::SDK::Shape {
        has DateTime $.created-timestamp is required is aws-parameter('CreatedTimestamp');
        has Str $.name is required is aws-parameter('Name');
    }

    class ReorderReceiptRuleSetRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has ReceiptRuleNamesList $.rule-names is required is aws-parameter('RuleNames');
        has Str $.rule-set-name is required is aws-parameter('RuleSetName');
    }

    class SetIdentityNotificationTopicRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.sns-topic is aws-parameter('SnsTopic');
        has Str $.identity is required is aws-parameter('Identity');
        has Str $.notification-type is required is aws-parameter('NotificationType');
    }

    class InvalidPolicyException:ver<2010-12-01.0> does AWS::SDK::Shape {
    }

    class WorkmailAction:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.topic-arn is aws-parameter('TopicArn');
        has Str $.organization-arn is required is aws-parameter('OrganizationArn');
    }

    class RawMessage:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Blob $.data is required is aws-parameter('Data');
    }

    class ReceiptRule:ver<2010-12-01.0> does AWS::SDK::Shape {
    ...
    class TrackingOptionsDoesNotExistException:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.configuration-set-name is required is aws-parameter('ConfigurationSetName');
    }

    class DeleteReceiptFilterRequest:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.filter-name is required is aws-parameter('FilterName');
    }

    class SNSAction:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.encoding is aws-parameter('Encoding');
        has Str $.topic-arn is required is aws-parameter('TopicArn');
    }

    class Message:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Body $.body is required is aws-parameter('Body');
        has Content $.subject is required is aws-parameter('Subject');
    }

    class MessageTag:ver<2010-12-01.0> does AWS::SDK::Shape {
        has Str $.name is required is aws-parameter('Name');
        has Str $.value is required is aws-parameter('Value');
    }
