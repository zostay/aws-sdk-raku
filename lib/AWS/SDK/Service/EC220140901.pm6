...
class AWS::SDK::Service::EC220140901 does AWS::SDK::Service {
    ...
    subset ImageAttributeName of Str where $_ eq any('description', 'kernel', 'ramdisk', 'launchPermission', 'productCodes', 'blockDeviceMapping');
    ...
    subset ImageState of Str where $_ eq any('available', 'deregistered');

    subset VolumeAttachmentState of Str where $_ eq any('attaching', 'attached', 'detaching', 'detached');

    subset OfferingTypeValues of Str where $_ eq any('Heavy Utilization', 'Medium Utilization', 'Light Utilization');
    ...
    subset MonitoringState of Str where $_ eq any('disabled', 'enabled', 'pending');
