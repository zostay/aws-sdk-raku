...
class AWS::SDK::Service::CloudFront:ver<2014-05-31.0> does AWS::SDK::Service {
    ...
    class UpdateCloudFrontOriginAccessIdentityResult:ver<2014-05-31.0> does AWS::SDK::Shape {
    ...
    class DeleteStreamingDistributionRequest:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.if-match is aws-parameter('IfMatch');
        has Str $.id is required is aws-parameter('Id');
    }

    class CookieNames:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
        has CookieNameList $.items is aws-parameter('Items');
    }

    class CloudFrontOriginAccessIdentityList:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
    ...
    class GetInvalidationRequest:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.distribution-id is required is aws-parameter('DistributionId');
        has Str $.id is required is aws-parameter('Id');
    }

    class MissingBody:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class TooManyCertificates:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidDefaultRootObject:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidationBatch:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.caller-reference is required is aws-parameter('CallerReference');
        has Paths $.paths is required is aws-parameter('Paths');
    }

    class UpdateCloudFrontOriginAccessIdentityRequest:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.if-match is aws-parameter('IfMatch');
        has Str $.id is required is aws-parameter('Id');
    ...
    class TooManyOrigins:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class TooManyCloudFrontOriginAccessIdentities:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class ListStreamingDistributionsRequest:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.max-items is required is aws-parameter('MaxItems');
        has Str $.marker is required is aws-parameter('Marker');
    }

    class Signer:ver<2014-05-31.0> does AWS::SDK::Shape {
    ...
    class DistributionNotDisabled:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class DeleteDistributionRequest:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.if-match is aws-parameter('IfMatch');
        has Str $.id is required is aws-parameter('Id');
    }

    class InvalidForwardCookies:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    subset InvalidationSummaryList of List[InvalidationSummary];

    class ListDistributionsRequest:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.max-items is required is aws-parameter('MaxItems');
        has Str $.marker is required is aws-parameter('Marker');
    }
    ...
    class StreamingDistributionNotDisabled:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class GetStreamingDistributionRequest:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.id is required is aws-parameter('Id');
    }

    class InvalidErrorCode:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidIfMatchVersion:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class StreamingLoggingConfig:ver<2014-05-31.0> does AWS::SDK::Shape {
    ...
    class GetCloudFrontOriginAccessIdentityConfigResult:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.e-tag is required is aws-parameter('ETag');
        has CloudFrontOriginAccessIdentityConfig $.cloud-front-origin-access-identity-config is required is aws-parameter('CloudFrontOriginAccessIdentityConfig');
    }

    class CustomOriginConfig:ver<2014-05-31.0> does AWS::SDK::Shape {
    ...
    class CloudFrontOriginAccessIdentityInUse:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class NoSuchInvalidation:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class S3OriginConfig:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.origin-access-identity is required is aws-parameter('OriginAccessIdentity');
    }

    class UpdateStreamingDistributionResult:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.e-tag is required is aws-parameter('ETag');
        has StreamingDistribution $.streaming-distribution is required is aws-parameter('StreamingDistribution');
    }

    class Distribution:ver<2014-05-31.0> does AWS::SDK::Shape {
    ...
    class CreateDistributionResult:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.e-tag is required is aws-parameter('ETag');
    ...
    class CloudFrontOriginAccessIdentitySummary:ver<2014-05-31.0> does AWS::SDK::Shape {
    ...
    class InvalidRelativePath:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidationList:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
    ...
    class StreamingDistributionList:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
    ...
    class DistributionAlreadyExists:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    subset CloudFrontOriginAccessIdentitySummaryList of List[CloudFrontOriginAccessIdentitySummary];

    class ActiveTrustedSigners:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
        has Bool $.enabled is required is aws-parameter('Enabled');
        has SignerList $.items is aws-parameter('Items');
    }

    class StreamingDistributionSummary:ver<2014-05-31.0> does AWS::SDK::Shape {
    ...
    class UpdateDistributionRequest:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.if-match is aws-parameter('IfMatch');
        has Str $.id is required is aws-parameter('Id');
        has DistributionConfig $.distribution-config is required is aws-parameter('DistributionConfig');
    }

    class DistributionSummary:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Aliases $.aliases is required is aws-parameter('Aliases');
        has Str $.domain-name is required is aws-parameter('DomainName');
    ...
    class InvalidArgument:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class StreamingDistributionConfig:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Aliases $.aliases is required is aws-parameter('Aliases');
        has Str $.comment is required is aws-parameter('Comment');
        has Str $.caller-reference is required is aws-parameter('CallerReference');
        has Bool $.enabled is required is aws-parameter('Enabled');
    ...
    class GetCloudFrontOriginAccessIdentityRequest:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.id is required is aws-parameter('Id');
    }

    class CloudFrontOriginAccessIdentityAlreadyExists:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class Headers:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
        has HeaderList $.items is aws-parameter('Items');
    }

    class StreamingDistributionAlreadyExists:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class TooManyInvalidationsInProgress:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class GeoRestriction:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.restriction-type is required is aws-parameter('RestrictionType');
        has Int $.quantity is required is aws-parameter('Quantity');
        has LocationList $.items is aws-parameter('Items');
    }

    class DefaultCacheBehavior:ver<2014-05-31.0> does AWS::SDK::Shape {
    ...
    class CreateCloudFrontOriginAccessIdentityRequest:ver<2014-05-31.0> does AWS::SDK::Shape {
        has CloudFrontOriginAccessIdentityConfig $.cloud-front-origin-access-identity-config is required is aws-parameter('CloudFrontOriginAccessIdentityConfig');
    }

    class BatchTooLarge:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidHeadersForS3Origin:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class LoggingConfig:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.bucket is required is aws-parameter('Bucket');
    ...
    class TooManyCookieNamesInWhiteList:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class CreateCloudFrontOriginAccessIdentityResult:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.e-tag is required is aws-parameter('ETag');
        has Str $.location is required is aws-parameter('Location');
        has CloudFrontOriginAccessIdentity $.cloud-front-origin-access-identity is required is aws-parameter('CloudFrontOriginAccessIdentity');
    }

    class TooManyStreamingDistributionCNAMEs:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class GetDistributionConfigRequest:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.id is required is aws-parameter('Id');
    }

    class CreateStreamingDistributionRequest:ver<2014-05-31.0> does AWS::SDK::Shape {
        has StreamingDistributionConfig $.streaming-distribution-config is required is aws-parameter('StreamingDistributionConfig');
    }

    class CacheBehaviors:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
        has CacheBehaviorList $.items is aws-parameter('Items');
    }

    class GetDistributionRequest:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.id is required is aws-parameter('Id');
    }

    class CreateDistributionRequest:ver<2014-05-31.0> does AWS::SDK::Shape {
        has DistributionConfig $.distribution-config is required is aws-parameter('DistributionConfig');
    }

    class CloudFrontOriginAccessIdentity:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.s3-canonical-user-id is required is aws-parameter('S3CanonicalUserId');
        has Str $.id is required is aws-parameter('Id');
    ...
    class CNAMEAlreadyExists:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidRequiredProtocol:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class ForwardedValues:ver<2014-05-31.0> does AWS::SDK::Shape {
    ...
    class CookiePreference:ver<2014-05-31.0> does AWS::SDK::Shape {
        has CookieNames $.whitelisted-names is aws-parameter('WhitelistedNames');
        has Str $.forward is required is aws-parameter('Forward');
    }

    class GetInvalidationResult:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Invalidation $.invalidation is required is aws-parameter('Invalidation');
    }

    subset KeyPairIdList of List[Str];

    class AllowedMethods:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
        has AllowedMethodsList $.items is aws-parameter('Items');
    }

    class GetStreamingDistributionResult:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.e-tag is required is aws-parameter('ETag');
        has StreamingDistribution $.streaming-distribution is required is aws-parameter('StreamingDistribution');
    }
    ...
    class UpdateStreamingDistributionRequest:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.if-match is aws-parameter('IfMatch');
        has StreamingDistributionConfig $.streaming-distribution-config is required is aws-parameter('StreamingDistributionConfig');
        has Str $.id is required is aws-parameter('Id');
    }

    class GetDistributionResult:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.e-tag is required is aws-parameter('ETag');
        has Distribution $.distribution is required is aws-parameter('Distribution');
    }

    class ListDistributionsResult:ver<2014-05-31.0> does AWS::SDK::Shape {
        has DistributionList $.distribution-list is required is aws-parameter('DistributionList');
    }

    class NoSuchCloudFrontOriginAccessIdentity:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class CacheBehavior:ver<2014-05-31.0> does AWS::SDK::Shape {
        has ForwardedValues $.forwarded-values is required is aws-parameter('ForwardedValues');
        has AllowedMethods $.allowed-methods is aws-parameter('AllowedMethods');
    ...
    class GetStreamingDistributionConfigResult:ver<2014-05-31.0> does AWS::SDK::Shape {
        has StreamingDistributionConfig $.streaming-distribution-config is required is aws-parameter('StreamingDistributionConfig');
        has Str $.e-tag is required is aws-parameter('ETag');
    }

    class TrustedSigners:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
        has Bool $.enabled is required is aws-parameter('Enabled');
        has AwsAccountNumberList $.items is aws-parameter('Items');
    }

    class GetCloudFrontOriginAccessIdentityConfigRequest:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.id is required is aws-parameter('Id');
    }

    class CustomErrorResponse:ver<2014-05-31.0> does AWS::SDK::Shape {
    ...
    class InvalidLocationCode:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class ListInvalidationsResult:ver<2014-05-31.0> does AWS::SDK::Shape {
        has InvalidationList $.invalidation-list is required is aws-parameter('InvalidationList');
    }

    class S3Origin:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('DomainName');
        has Str $.origin-access-identity is required is aws-parameter('OriginAccessIdentity');
    }

    class TooManyTrustedSigners:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class GetCloudFrontOriginAccessIdentityResult:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.e-tag is required is aws-parameter('ETag');
        has CloudFrontOriginAccessIdentity $.cloud-front-origin-access-identity is required is aws-parameter('CloudFrontOriginAccessIdentity');
    }
    ...
    class Invalidation:ver<2014-05-31.0> does AWS::SDK::Shape {
    ...
    class NoSuchOrigin:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class TooManyDistributionCNAMEs:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class CustomErrorResponses:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
        has CustomErrorResponseList $.items is aws-parameter('Items');
    }

    class CreateStreamingDistributionResult:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.e-tag is required is aws-parameter('ETag');
        has Str $.location is required is aws-parameter('Location');
        has StreamingDistribution $.streaming-distribution is required is aws-parameter('StreamingDistribution');
    }

    class IllegalUpdate:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }
    ...
    class AccessDenied:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class ListCloudFrontOriginAccessIdentitiesRequest:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.max-items is required is aws-parameter('MaxItems');
        has Str $.marker is required is aws-parameter('Marker');
    }

    class Origin:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('DomainName');
        has Str $.id is required is aws-parameter('Id');
    ...
    class UpdateDistributionResult:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.e-tag is required is aws-parameter('ETag');
        has Distribution $.distribution is required is aws-parameter('Distribution');
    }

    class TooManyDistributions:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class Aliases:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
        has AliasList $.items is aws-parameter('Items');
    }

    class InconsistentQuantities:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidViewerCertificate:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class KeyPairIds:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
        has KeyPairIdList $.items is aws-parameter('Items');
    }

    class NoSuchDistribution:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class NoSuchStreamingDistribution:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class TrustedSignerDoesNotExist:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class DistributionList:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
    ...
    class ListStreamingDistributionsResult:ver<2014-05-31.0> does AWS::SDK::Shape {
        has StreamingDistributionList $.streaming-distribution-list is required is aws-parameter('StreamingDistributionList');
    }

    class CreateInvalidationResult:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.location is required is aws-parameter('Location');
        has Invalidation $.invalidation is required is aws-parameter('Invalidation');
    }
    ...
    class GetDistributionConfigResult:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.e-tag is required is aws-parameter('ETag');
        has DistributionConfig $.distribution-config is required is aws-parameter('DistributionConfig');
    }

    class InvalidGeoRestrictionParameter:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidOrigin:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class DeleteCloudFrontOriginAccessIdentityRequest:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.if-match is aws-parameter('IfMatch');
        has Str $.id is required is aws-parameter('Id');
    }
    ...
    class TooManyStreamingDistributions:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class TooManyCacheBehaviors:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class DistributionConfig:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Aliases $.aliases is required is aws-parameter('Aliases');
        has DefaultCacheBehavior $.default-cache-behavior is required is aws-parameter('DefaultCacheBehavior');
        has Str $.comment is required is aws-parameter('Comment');
        has Str $.caller-reference is required is aws-parameter('CallerReference');
    ...
    class CreateInvalidationRequest:ver<2014-05-31.0> does AWS::SDK::Shape {
        has InvalidationBatch $.invalidation-batch is required is aws-parameter('InvalidationBatch');
        has Str $.distribution-id is required is aws-parameter('DistributionId');
    }

    class GetStreamingDistributionConfigRequest:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.id is required is aws-parameter('Id');
    }

    subset HeaderList of List[Str];

    class InvalidResponseCode:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidationSummary:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.id is required is aws-parameter('Id');
        has Str $.status is required is aws-parameter('Status');
        has DateTime $.create-time is required is aws-parameter('CreateTime');
    }

    class ListInvalidationsRequest:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.distribution-id is required is aws-parameter('DistributionId');
        has Str $.max-items is aws-parameter('MaxItems');
        has Str $.marker is aws-parameter('Marker');
    }

    class Origins:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
        has OriginList $.items is aws-parameter('Items');
    }

    class PreconditionFailed:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class Restrictions:ver<2014-05-31.0> does AWS::SDK::Shape {
        has GeoRestriction $.geo-restriction is required is aws-parameter('GeoRestriction');
    }

    class StreamingDistribution:ver<2014-05-31.0> does AWS::SDK::Shape {
        has StreamingDistributionConfig $.streaming-distribution-config is required is aws-parameter('StreamingDistributionConfig');
        has Str $.domain-name is required is aws-parameter('DomainName');
        has Str $.id is required is aws-parameter('Id');
        has Str $.status is required is aws-parameter('Status');
    ...
    class ViewerCertificate:ver<2014-05-31.0> does AWS::SDK::Shape {
    ...
    class TooManyHeadersInForwardedValues:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidOriginAccessIdentity:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class ListCloudFrontOriginAccessIdentitiesResult:ver<2014-05-31.0> does AWS::SDK::Shape {
    ...
    class CloudFrontOriginAccessIdentityConfig:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Str $.comment is required is aws-parameter('Comment');
        has Str $.caller-reference is required is aws-parameter('CallerReference');
    }

    class Paths:ver<2014-05-31.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
