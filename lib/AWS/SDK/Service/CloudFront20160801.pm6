...
class AWS::SDK::Service::CloudFront:ver<2016-08-01.0> does AWS::SDK::Service {

    method api-version() { '2016-08-01' }
    ...
    class UpdateCloudFrontOriginAccessIdentityResult:ver<2016-08-01.0> does AWS::SDK::Shape {
    ...
    class MissingBody:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class CookieNames:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
        has CookieNameList $.items is aws-parameter('Items');
    }

    class CloudFrontOriginAccessIdentityList:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
    ...
    class DeleteStreamingDistributionRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
    ...
    class GetInvalidationRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.distribution-id is required is aws-parameter('DistributionId');
        has Str $.id is required is aws-parameter('Id');
    }

    class TooManyCertificates:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidDefaultRootObject:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidationBatch:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.caller-reference is required is aws-parameter('CallerReference');
        has Paths $.paths is required is aws-parameter('Paths');
    }

    class UpdateCloudFrontOriginAccessIdentityRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.if-match is aws-parameter('IfMatch');
        has Str $.id is required is aws-parameter('Id');
    ...
    class TooManyOrigins:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class TooManyCloudFrontOriginAccessIdentities:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class Signer:ver<2016-08-01.0> does AWS::SDK::Shape {
    ...
    class ListStreamingDistributionsRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.max-items is required is aws-parameter('MaxItems');
        has Str $.marker is required is aws-parameter('Marker');
    }

    class StreamingDistributionNotDisabled:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }
    ...
    class ListDistributionsRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.max-items is required is aws-parameter('MaxItems');
        has Str $.marker is required is aws-parameter('Marker');
    }

    class DeleteDistributionRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.if-match is aws-parameter('IfMatch');
        has Str $.id is required is aws-parameter('Id');
    }

    class DistributionNotDisabled:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidForwardCookies:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    subset InvalidationSummaryList of List[InvalidationSummary];

    class ListDistributionsByWebACLIdRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
    ...
    class TagKeys:ver<2016-08-01.0> does AWS::SDK::Shape {
        has TagKeyList $.items is required is aws-parameter('Items');
    }

    class ListTagsForResourceResult:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Tags $.tags is required is aws-parameter('Tags');
    }

    class GetStreamingDistributionRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.id is required is aws-parameter('Id');
    }

    class InvalidErrorCode:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidIfMatchVersion:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidTTLOrder:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidTagging:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class ListDistributionsByWebACLIdResult:ver<2016-08-01.0> does AWS::SDK::Shape {
        has DistributionList $.distribution-list is required is aws-parameter('DistributionList');
    }

    class StreamingLoggingConfig:ver<2016-08-01.0> does AWS::SDK::Shape {
    ...
    class S3OriginConfig:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.origin-access-identity is required is aws-parameter('OriginAccessIdentity');
    }

    class NoSuchInvalidation:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class CloudFrontOriginAccessIdentityInUse:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class CustomOriginConfig:ver<2016-08-01.0> does AWS::SDK::Shape {
    ...
    class GetCloudFrontOriginAccessIdentityConfigResult:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.e-tag is required is aws-parameter('ETag');
        has CloudFrontOriginAccessIdentityConfig $.cloud-front-origin-access-identity-config is required is aws-parameter('CloudFrontOriginAccessIdentityConfig');
    }

    class UpdateStreamingDistributionResult:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.e-tag is required is aws-parameter('ETag');
        has StreamingDistribution $.streaming-distribution is required is aws-parameter('StreamingDistribution');
    }

    class StreamingDistributionList:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
    ...
    class CreateDistributionResult:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.e-tag is required is aws-parameter('ETag');
    ...
    class CloudFrontOriginAccessIdentitySummary:ver<2016-08-01.0> does AWS::SDK::Shape {
    ...
    class Distribution:ver<2016-08-01.0> does AWS::SDK::Shape {
    ...
    class InvalidRelativePath:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidationList:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
    ...
    class StreamingDistributionSummary:ver<2016-08-01.0> does AWS::SDK::Shape {
    ...
    class OriginSslProtocols:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
    ...
    class ActiveTrustedSigners:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
        has Bool $.enabled is required is aws-parameter('Enabled');
        has SignerList $.items is aws-parameter('Items');
    }

    class DistributionAlreadyExists:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class UpdateDistributionRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.if-match is aws-parameter('IfMatch');
        has Str $.id is required is aws-parameter('Id');
        has DistributionConfig $.distribution-config is required is aws-parameter('DistributionConfig');
    }
    ...
    class StreamingDistributionConfig:ver<2016-08-01.0> does AWS::SDK::Shape {
    ...
    class DistributionSummary:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.web-acl-id is required is aws-parameter('WebACLId');
        has Aliases $.aliases is required is aws-parameter('Aliases');
        has Str $.domain-name is required is aws-parameter('DomainName');
    ...
    class InvalidArgument:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class StreamingDistributionAlreadyExists:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class CloudFrontOriginAccessIdentityAlreadyExists:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class GetCloudFrontOriginAccessIdentityRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.id is required is aws-parameter('Id');
    }

    class Headers:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
        has HeaderList $.items is aws-parameter('Items');
    }

    class TooManyInvalidationsInProgress:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class CreateDistributionWithTagsRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
        has DistributionConfigWithTags $.distribution-config-with-tags is required is aws-parameter('DistributionConfigWithTags');
    }

    class CreateCloudFrontOriginAccessIdentityRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
        has CloudFrontOriginAccessIdentityConfig $.cloud-front-origin-access-identity-config is required is aws-parameter('CloudFrontOriginAccessIdentityConfig');
    }

    class BatchTooLarge:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class DefaultCacheBehavior:ver<2016-08-01.0> does AWS::SDK::Shape {
    ...
    class GeoRestriction:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.restriction-type is required is aws-parameter('RestrictionType');
        has Int $.quantity is required is aws-parameter('Quantity');
        has LocationList $.items is aws-parameter('Items');
    }

    class InvalidHeadersForS3Origin:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class LoggingConfig:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.bucket is required is aws-parameter('Bucket');
    ...
    class TooManyCookieNamesInWhiteList:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class Tags:ver<2016-08-01.0> does AWS::SDK::Shape {
        has TagList $.items is required is aws-parameter('Items');
    }

    class CreateCloudFrontOriginAccessIdentityResult:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.e-tag is required is aws-parameter('ETag');
        has Str $.location is required is aws-parameter('Location');
        has CloudFrontOriginAccessIdentity $.cloud-front-origin-access-identity is required is aws-parameter('CloudFrontOriginAccessIdentity');
    }

    class TooManyStreamingDistributionCNAMEs:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class CreateStreamingDistributionRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
        has StreamingDistributionConfig $.streaming-distribution-config is required is aws-parameter('StreamingDistributionConfig');
    }

    class CacheBehaviors:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
        has CacheBehaviorList $.items is aws-parameter('Items');
    }

    class GetDistributionConfigRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.id is required is aws-parameter('Id');
    }

    class GetDistributionRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.id is required is aws-parameter('Id');
    }

    class CreateDistributionRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
        has DistributionConfig $.distribution-config is required is aws-parameter('DistributionConfig');
    }

    class CloudFrontOriginAccessIdentity:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.s3-canonical-user-id is required is aws-parameter('S3CanonicalUserId');
        has Str $.id is required is aws-parameter('Id');
    ...
    class CNAMEAlreadyExists:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidRequiredProtocol:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class Tag:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.value is aws-parameter('Value');
        has Str $.key is required is aws-parameter('Key');
    }

    class UntagResourceRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
        has TagKeys $.tag-keys is required is aws-parameter('TagKeys');
        has Str $.resource is required is aws-parameter('Resource');
    }

    class CreateStreamingDistributionWithTagsResult:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.e-tag is required is aws-parameter('ETag');
        has Str $.location is required is aws-parameter('Location');
        has StreamingDistribution $.streaming-distribution is required is aws-parameter('StreamingDistribution');
    }

    class CookiePreference:ver<2016-08-01.0> does AWS::SDK::Shape {
        has CookieNames $.whitelisted-names is aws-parameter('WhitelistedNames');
        has Str $.forward is required is aws-parameter('Forward');
    }

    class ForwardedValues:ver<2016-08-01.0> does AWS::SDK::Shape {
    ...
    class GetInvalidationResult:ver<2016-08-01.0> does AWS::SDK::Shape {
    ...
    class AllowedMethods:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
        has MethodsList $.items is required is aws-parameter('Items');
        has CachedMethods $.cached-methods is aws-parameter('CachedMethods');
    }

    class GetStreamingDistributionResult:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.e-tag is required is aws-parameter('ETag');
        has StreamingDistribution $.streaming-distribution is required is aws-parameter('StreamingDistribution');
    }

    class UpdateStreamingDistributionRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.if-match is aws-parameter('IfMatch');
        has StreamingDistributionConfig $.streaming-distribution-config is required is aws-parameter('StreamingDistributionConfig');
        has Str $.id is required is aws-parameter('Id');
    }

    class NoSuchCloudFrontOriginAccessIdentity:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class ListDistributionsResult:ver<2016-08-01.0> does AWS::SDK::Shape {
        has DistributionList $.distribution-list is required is aws-parameter('DistributionList');
    }

    class GetDistributionResult:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.e-tag is required is aws-parameter('ETag');
        has Distribution $.distribution is required is aws-parameter('Distribution');
    }

    class CacheBehavior:ver<2016-08-01.0> does AWS::SDK::Shape {
        has ForwardedValues $.forwarded-values is required is aws-parameter('ForwardedValues');
        has AllowedMethods $.allowed-methods is aws-parameter('AllowedMethods');
    ...
    class GetStreamingDistributionConfigResult:ver<2016-08-01.0> does AWS::SDK::Shape {
        has StreamingDistributionConfig $.streaming-distribution-config is required is aws-parameter('StreamingDistributionConfig');
        has Str $.e-tag is required is aws-parameter('ETag');
    }

    class TrustedSigners:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
        has Bool $.enabled is required is aws-parameter('Enabled');
        has AwsAccountNumberList $.items is aws-parameter('Items');
    }

    class S3Origin:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('DomainName');
        has Str $.origin-access-identity is required is aws-parameter('OriginAccessIdentity');
    }

    class ListInvalidationsResult:ver<2016-08-01.0> does AWS::SDK::Shape {
        has InvalidationList $.invalidation-list is required is aws-parameter('InvalidationList');
    }

    class CustomErrorResponse:ver<2016-08-01.0> does AWS::SDK::Shape {
    ...
    class GetCloudFrontOriginAccessIdentityConfigRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.id is required is aws-parameter('Id');
    }

    class InvalidLocationCode:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class TooManyTrustedSigners:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    subset TagKeyList of List[Str];

    class NoSuchOrigin:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    subset CustomErrorResponseList of List[CustomErrorResponse];

    class GetCloudFrontOriginAccessIdentityResult:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.e-tag is required is aws-parameter('ETag');
        has CloudFrontOriginAccessIdentity $.cloud-front-origin-access-identity is required is aws-parameter('CloudFrontOriginAccessIdentity');
    }

    class InvalidMinimumProtocolVersion:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidProtocolSettings:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class Invalidation:ver<2016-08-01.0> does AWS::SDK::Shape {
    ...
    class TooManyDistributionCNAMEs:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    subset OriginList of List[Origin] where 1 <= *.elems;

    class ListTagsForResourceRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.resource is required is aws-parameter('Resource');
    }

    class CustomHeaders:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
        has OriginCustomHeadersList $.items is aws-parameter('Items');
    }

    class CustomErrorResponses:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
        has CustomErrorResponseList $.items is aws-parameter('Items');
    }

    class CreateStreamingDistributionResult:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.e-tag is required is aws-parameter('ETag');
        has Str $.location is required is aws-parameter('Location');
        has StreamingDistribution $.streaming-distribution is required is aws-parameter('StreamingDistribution');
    }

    class IllegalUpdate:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class Origin:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.domain-name is required is aws-parameter('DomainName');
        has Str $.id is required is aws-parameter('Id');
    ...
    class CreateStreamingDistributionWithTagsRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
    ...
    class AccessDenied:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class ListCloudFrontOriginAccessIdentitiesRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.max-items is required is aws-parameter('MaxItems');
        has Str $.marker is required is aws-parameter('Marker');
    }

    class UpdateDistributionResult:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.e-tag is required is aws-parameter('ETag');
        has Distribution $.distribution is required is aws-parameter('Distribution');
    }

    class TooManyDistributions:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class StreamingDistributionConfigWithTags:ver<2016-08-01.0> does AWS::SDK::Shape {
        has StreamingDistributionConfig $.streaming-distribution-config is required is aws-parameter('StreamingDistributionConfig');
        has Tags $.tags is required is aws-parameter('Tags');
    }

    class NoSuchStreamingDistribution:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class NoSuchDistribution:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class Aliases:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
        has AliasList $.items is aws-parameter('Items');
    }

    class InconsistentQuantities:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidViewerCertificate:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class KeyPairIds:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
        has KeyPairIdList $.items is aws-parameter('Items');
    }

    class TrustedSignerDoesNotExist:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    subset OriginCustomHeadersList of List[OriginCustomHeader];

    class ListStreamingDistributionsResult:ver<2016-08-01.0> does AWS::SDK::Shape {
        has StreamingDistributionList $.streaming-distribution-list is required is aws-parameter('StreamingDistributionList');
    }

    class DistributionList:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
    ...
    class TooManyOriginCustomHeaders:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class NoSuchResource:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class CreateInvalidationResult:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.location is required is aws-parameter('Location');
        has Invalidation $.invalidation is required is aws-parameter('Invalidation');
    }
    ...
    class DistributionConfigWithTags:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Tags $.tags is required is aws-parameter('Tags');
        has DistributionConfig $.distribution-config is required is aws-parameter('DistributionConfig');
    }

    class GetDistributionConfigResult:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.e-tag is required is aws-parameter('ETag');
        has DistributionConfig $.distribution-config is required is aws-parameter('DistributionConfig');
    }

    class InvalidGeoRestrictionParameter:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidOrigin:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidWebACLId:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class TagResourceRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Tags $.tags is required is aws-parameter('Tags');
        has Str $.resource is required is aws-parameter('Resource');
    }

    class DeleteCloudFrontOriginAccessIdentityRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.if-match is aws-parameter('IfMatch');
        has Str $.id is required is aws-parameter('Id');
    }

    class TooManyStreamingDistributions:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class TooManyCacheBehaviors:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class StreamingDistribution:ver<2016-08-01.0> does AWS::SDK::Shape {
        has StreamingDistributionConfig $.streaming-distribution-config is required is aws-parameter('StreamingDistributionConfig');
        has Str $.domain-name is required is aws-parameter('DomainName');
        has Str $.arn is required is aws-parameter('ARN');
        has Str $.id is required is aws-parameter('Id');
    ...
    class Restrictions:ver<2016-08-01.0> does AWS::SDK::Shape {
        has GeoRestriction $.geo-restriction is required is aws-parameter('GeoRestriction');
    }

    class PreconditionFailed:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class Origins:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
        has OriginList $.items is aws-parameter('Items');
    }

    class ListInvalidationsRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.distribution-id is required is aws-parameter('DistributionId');
        has Str $.max-items is aws-parameter('MaxItems');
        has Str $.marker is aws-parameter('Marker');
    }

    class CreateInvalidationRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
        has InvalidationBatch $.invalidation-batch is required is aws-parameter('InvalidationBatch');
        has Str $.distribution-id is required is aws-parameter('DistributionId');
    }

    class CreateDistributionWithTagsResult:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.e-tag is required is aws-parameter('ETag');
        has Str $.location is required is aws-parameter('Location');
        has Distribution $.distribution is required is aws-parameter('Distribution');
    }

    class DistributionConfig:ver<2016-08-01.0> does AWS::SDK::Shape {
    ...
    class GetStreamingDistributionConfigRequest:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.id is required is aws-parameter('Id');
    }

    subset HeaderList of List[Str];

    class InvalidResponseCode:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class InvalidationSummary:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.id is required is aws-parameter('Id');
        has Str $.status is required is aws-parameter('Status');
        has DateTime $.create-time is required is aws-parameter('CreateTime');
    }

    class ViewerCertificate:ver<2016-08-01.0> does AWS::SDK::Shape {
    ...
    class TooManyHeadersInForwardedValues:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class OriginCustomHeader:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.header-name is required is aws-parameter('HeaderName');
        has Str $.header-value is required is aws-parameter('HeaderValue');
    }

    class CachedMethods:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
        has MethodsList $.items is required is aws-parameter('Items');
    }

    class InvalidOriginAccessIdentity:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.message is required is aws-parameter('Message');
    }

    class ListCloudFrontOriginAccessIdentitiesResult:ver<2016-08-01.0> does AWS::SDK::Shape {
    ...
    class Paths:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Int $.quantity is required is aws-parameter('Quantity');
    ...
    class CloudFrontOriginAccessIdentityConfig:ver<2016-08-01.0> does AWS::SDK::Shape {
        has Str $.comment is required is aws-parameter('Comment');
        has Str $.caller-reference is required is aws-parameter('CallerReference');
    }
