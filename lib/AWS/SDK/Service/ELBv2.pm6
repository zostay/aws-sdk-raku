...
class AWS::SDK::Service::ELBv2:ver<2015-12-01.0> does AWS::SDK::Service {
    ...
    class TargetDescription:ver<2015-12-01.0> does AWS::SDK::Shape {
    ...
    class ModifyTargetGroupAttributesInput:ver<2015-12-01.0> does AWS::SDK::Shape {
    ...
    class SetIpAddressTypeInput:ver<2015-12-01.0> does AWS::SDK::Shape {
    ...
    class TargetHealth:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.description is required is aws-parameter('Description');
        has Str $.state is required is aws-parameter('State');
        has Str $.reason is required is aws-parameter('Reason');
    }

    class TooManyTargetGroupsException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class InvalidConfigurationRequestException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    subset TagKeys of List[Str];

    class TooManyRulesException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class DescribeLoadBalancerAttributesOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has LoadBalancerAttributes $.attributes is required is aws-parameter('Attributes');
    }

    class TargetGroupNotFoundException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class ListenerNotFoundException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class InvalidSchemeException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class DescribeTagsInput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has ResourceArns $.resource-arns is required is aws-parameter('ResourceArns');
    }

    class OperationNotPermittedException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class LoadBalancerNotFoundException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    subset TargetGroupArns of List[Str];

    class TargetHealthDescription:ver<2015-12-01.0> does AWS::SDK::Shape {
    ...
    class DescribeTargetGroupAttributesOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has TargetGroupAttributes $.attributes is required is aws-parameter('Attributes');
    }
    ...
    class HealthUnavailableException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class ModifyRuleOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Rules $.rules is required is aws-parameter('Rules');
    }

    class TagDescription:ver<2015-12-01.0> does AWS::SDK::Shape {
    ...
    class DescribeTargetGroupAttributesInput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.target-group-arn is required is aws-parameter('TargetGroupArn');
    }

    class RegisterTargetsInput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.target-group-arn is required is aws-parameter('TargetGroupArn');
        has TargetDescriptions $.targets is required is aws-parameter('Targets');
    }

    class SubnetMapping:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.subnet-id is required is aws-parameter('SubnetId');
        has Str $.allocation-id is required is aws-parameter('AllocationId');
    }

    class DescribeAccountLimitsOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Limits $.limits is required is aws-parameter('Limits');
        has Str $.next-marker is required is aws-parameter('NextMarker');
    }

    class CreateLoadBalancerOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has LoadBalancers $.load-balancers is required is aws-parameter('LoadBalancers');
    }

    class CreateRuleInput:ver<2015-12-01.0> does AWS::SDK::Shape {
    ...
    class RemoveTagsOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class Tag:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.value is aws-parameter('Value');
        has Str $.key is required is aws-parameter('Key');
    }

    class TargetGroup:ver<2015-12-01.0> does AWS::SDK::Shape {
    ...
    class SetRulePrioritiesOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Rules $.rules is required is aws-parameter('Rules');
    }

    class UnsupportedProtocolException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class DuplicateTagKeysException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }
    ...
    class DescribeTargetGroupsOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has TargetGroups $.target-groups is required is aws-parameter('TargetGroups');
        has Str $.next-marker is required is aws-parameter('NextMarker');
    }

    class DeleteLoadBalancerInput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.load-balancer-arn is required is aws-parameter('LoadBalancerArn');
    }

    class RemoveTagsInput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has ResourceArns $.resource-arns is required is aws-parameter('ResourceArns');
    ...
    class InvalidSecurityGroupException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class TooManyListenersException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class Listener:ver<2015-12-01.0> does AWS::SDK::Shape {
    ...
    class DescribeRulesOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Rules $.rules is required is aws-parameter('Rules');
        has Str $.next-marker is required is aws-parameter('NextMarker');
    }

    class SetSecurityGroupsInput:ver<2015-12-01.0> does AWS::SDK::Shape {
    ...
    class DuplicateTargetGroupNameException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class DuplicateLoadBalancerNameException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class DescribeTargetHealthOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has TargetHealthDescriptions $.target-health-descriptions is required is aws-parameter('TargetHealthDescriptions');
    }

    class ModifyTargetGroupAttributesOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has TargetGroupAttributes $.attributes is required is aws-parameter('Attributes');
    }

    class SSLPolicyNotFoundException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class CertificateNotFoundException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class SetSecurityGroupsOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
    ...
    class RegisterTargetsOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class ModifyListenerOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Listeners $.listeners is required is aws-parameter('Listeners');
    }

    class SetIpAddressTypeOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.ip-address-type is required is aws-parameter('IpAddressType');
    }

    class DeleteListenerOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class ModifyTargetGroupOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has TargetGroups $.target-groups is required is aws-parameter('TargetGroups');
    }

    class TooManyTagsException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class DeleteRuleOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class Rule:ver<2015-12-01.0> does AWS::SDK::Shape {
    ...
    class LoadBalancer:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.vpc-id is required is aws-parameter('VpcId');
    ...
    class ModifyLoadBalancerAttributesInput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.load-balancer-arn is required is aws-parameter('LoadBalancerArn');
        has LoadBalancerAttributes $.attributes is required is aws-parameter('Attributes');
    }

    class IncompatibleProtocolsException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class DescribeLoadBalancersOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has LoadBalancers $.load-balancers is required is aws-parameter('LoadBalancers');
        has Str $.next-marker is required is aws-parameter('NextMarker');
    }

    class Limit:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.max is required is aws-parameter('Max');
        has Str $.name is required is aws-parameter('Name');
    }

    class DescribeTargetHealthInput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.target-group-arn is required is aws-parameter('TargetGroupArn');
        has TargetDescriptions $.targets is aws-parameter('Targets');
    }

    class DescribeTagsOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has TagDescriptions $.tag-descriptions is required is aws-parameter('TagDescriptions');
    }

    class AvailabilityZoneNotSupportedException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class SetSubnetsOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has AvailabilityZones $.availability-zones is required is aws-parameter('AvailabilityZones');
    }

    class DescribeSSLPoliciesInput:ver<2015-12-01.0> does AWS::SDK::Shape {
    ...
    class CreateListenerOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Listeners $.listeners is required is aws-parameter('Listeners');
    }

    class DeleteTargetGroupOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    subset TagList of List[Tag] where 1 <= *.elems;

    class PriorityInUseException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    subset Rules of List[Rule];

    class CreateTargetGroupOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has TargetGroups $.target-groups is required is aws-parameter('TargetGroups');
    }

    class CreateListenerInput:ver<2015-12-01.0> does AWS::SDK::Shape {
    ...
    class CreateRuleOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Rules $.rules is required is aws-parameter('Rules');
    }

    class ModifyRuleInput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has RuleConditionList $.conditions is aws-parameter('Conditions');
        has Actions $.actions is aws-parameter('Actions');
        has Str $.rule-arn is required is aws-parameter('RuleArn');
    }

    class DuplicateListenerException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class ModifyLoadBalancerAttributesOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has LoadBalancerAttributes $.attributes is required is aws-parameter('Attributes');
    }

    subset TargetGroupAttributes of List[TargetGroupAttribute];

    class InvalidTargetException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class TargetGroupAssociationLimitException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class TargetGroupAttribute:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.value is required is aws-parameter('Value');
        has Str $.key is required is aws-parameter('Key');
    }

    class TooManyCertificatesException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class LoadBalancerAttribute:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.value is required is aws-parameter('Value');
        has Str $.key is required is aws-parameter('Key');
    }
    ...
    class AddTagsInput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has ResourceArns $.resource-arns is required is aws-parameter('ResourceArns');
        has TagList $.tags is required is aws-parameter('Tags');
    }
    ...
    class RuleCondition:ver<2015-12-01.0> does AWS::SDK::Shape {
    ...
    class DescribeRulesInput:ver<2015-12-01.0> does AWS::SDK::Shape {
    ...
    class DescribeLoadBalancerAttributesInput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.load-balancer-arn is required is aws-parameter('LoadBalancerArn');
    }

    class AllocationIdNotFoundException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class Certificate:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.certificate-arn is required is aws-parameter('CertificateArn');
    }

    class TooManyLoadBalancersException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class DeregisterTargetsInput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.target-group-arn is required is aws-parameter('TargetGroupArn');
        has TargetDescriptions $.targets is required is aws-parameter('Targets');
    }

    class SubnetNotFoundException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class SslPolicy:ver<2015-12-01.0> does AWS::SDK::Shape {
    ...
    class DeleteTargetGroupInput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.target-group-arn is required is aws-parameter('TargetGroupArn');
    }

    class CreateTargetGroupInput:ver<2015-12-01.0> does AWS::SDK::Shape {
    ...
    class LoadBalancerState:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.reason is required is aws-parameter('Reason');
        has Str $.code is required is aws-parameter('Code');
    }

    class Matcher:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.http-code is required is aws-parameter('HttpCode');
    }

    class DescribeLoadBalancersInput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has LoadBalancerArns $.load-balancer-arns is required is aws-parameter('LoadBalancerArns');
    ...
    class DeleteRuleInput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.rule-arn is required is aws-parameter('RuleArn');
    }

    class RulePriorityPair:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.rule-arn is required is aws-parameter('RuleArn');
        has Int $.priority is required is aws-parameter('Priority');
    }

    class DescribeListenersOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Listeners $.listeners is required is aws-parameter('Listeners');
        has Str $.next-marker is required is aws-parameter('NextMarker');
    }
    ...
    class SetSubnetsInput:ver<2015-12-01.0> does AWS::SDK::Shape {
    ...
    class Action:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.type is required is aws-parameter('Type');
        has Str $.target-group-arn is required is aws-parameter('TargetGroupArn');
    }

    class TooManyTargetsException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class AvailabilityZone:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.subnet-id is required is aws-parameter('SubnetId');
    ...
    class DescribeListenersInput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.load-balancer-arn is required is aws-parameter('LoadBalancerArn');
    ...
    class Cipher:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.name is required is aws-parameter('Name');
        has Int $.priority is required is aws-parameter('Priority');
    }

    class InvalidSubnetException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class DeleteLoadBalancerOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class ResourceInUseException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    subset TargetGroupNames of List[Str];

    class DeleteListenerInput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.listener-arn is required is aws-parameter('ListenerArn');
    }
    ...
    class DescribeSSLPoliciesOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has SslPolicies $.ssl-policies is required is aws-parameter('SslPolicies');
        has Str $.next-marker is required is aws-parameter('NextMarker');
    }

    class AddTagsOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class ModifyTargetGroupInput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Matcher $.matcher is aws-parameter('Matcher');
        has Str $.health-check-path is aws-parameter('HealthCheckPath');
        has Str $.health-check-protocol is aws-parameter('HealthCheckProtocol');
        has Int $.unhealthy-threshold-count is aws-parameter('UnhealthyThresholdCount');
    ...
    class SetRulePrioritiesInput:ver<2015-12-01.0> does AWS::SDK::Shape {
    ...
    class TooManyRegistrationsForTargetIdException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class LoadBalancerAddress:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Str $.ip-address is required is aws-parameter('IpAddress');
        has Str $.allocation-id is required is aws-parameter('AllocationId');
    }

    class ModifyListenerInput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has CertificateList $.certificates is aws-parameter('Certificates');
    ...
    class CreateLoadBalancerInput:ver<2015-12-01.0> does AWS::SDK::Shape {
    ...
    class DescribeAccountLimitsInput:ver<2015-12-01.0> does AWS::SDK::Shape {
        has Int $.page-size is required is aws-parameter('PageSize');
        has Str $.marker is required is aws-parameter('Marker');
    }

    class RuleNotFoundException:ver<2015-12-01.0> does AWS::SDK::Shape {
    }

    class DescribeTargetGroupsInput:ver<2015-12-01.0> does AWS::SDK::Shape {
    ...
    class DeregisterTargetsOutput:ver<2015-12-01.0> does AWS::SDK::Shape {
    }
